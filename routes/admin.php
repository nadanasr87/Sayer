...
//        });
        Route::get('order/syncWithNaql', 'OrderController@syncWithNaql')->name('order.syncWithNaql');
...
//        });
        ...
        Route::group(['prefix' => 'business-settings', 'as' => 'business-settings.', 'middleware' => ['module:settings', 'actch']], function () {
            ...
            Route::post('update-tawseel-setup', 'BusinessSettingsController@business_tawseel_setup')->name('update-tawseel-setup');
...
//            });
        ...
        Route::group(['prefix' => 'transactions', 'as' => 'transactions.'], function () {
            ...
            Route::get('export-deliveryman-earnings', 'ProvideDMEarningController@dm_earning_list_export')->name('export-deliveryman-earning');
            Route::post('deliveryman-earnings-search', 'ProvideDMEarningController@search_deliveryman_earning')->name('search-deliveryman-earning');
            Route::get('deliveryman-earnings', 'ProvideDMEarningController@earningList')->name('earningList');
            Route::post('stc-deliveryman-earnings', 'ProvideDMEarningController@payoutPaymentsEarningList')->name('payoutPaymentsEarningList');
            Route::post('payouts-inquery', 'ProvideDMEarningController@stcPayoutsInquery')->name('payouts-inquery');

            Route::get('stc-deliveryman-payouts', 'ProvideDMEarningController@stcPayouts')->name('stcDeliverymanPayouts');

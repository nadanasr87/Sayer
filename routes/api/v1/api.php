...
Route::group(['namespace' => 'Api\V1', 'middleware'=>'localization'], function () {
    ...
    Route::group(['prefix' => 'auth', 'namespace' => 'Auth'], function () {
        ...
        Route::post('send_otp', 'CustomerAuthController@send_otp');
        ...
        Route::group(['prefix' => 'delivery-man'], function () {
            ...
            Route::post('send_otp', 'DeliveryManLoginController@send_otp');
    ...
    Route::group(['prefix' => 'delivery-man'], function () {
        ...
        Route::group(['middleware'=>['dm.api']], function () {
            ...
            Route::get('stc-payments', 'DeliverymanController@get_stc_payments');
            ...
            Route::post('confirm-stc-payment', 'DeliverymanController@make_confirm_payment')->name('make_confirm_payment');
            Route::post('request-withdraw', 'DeliverymanController@request_withdraw')->name('request_withdraw');
    ...
    Route::group(['middleware'=>['module-check']], function(){
        Route::group(['prefix' => 'customer', 'middleware' => 'auth:api'], function () {
            ...
            Route::group(['prefix' => 'cards'], function () {
                Route::get('list', 'CustomerController@card_list');
                // Route::post('add', 'CustomerController@add_new_address');
                // Route::put('update/{id}', 'CustomerController@update_address');
                // Route::delete('delete', 'CustomerController@delete_address');
            });
            ...
            Route::group(['prefix'=>'wallet'], function() {
                ...
                Route::get('getTelrPaymentStatus/{ref}/{id}/{type}', 'WalletController@getTelrPaymentStatus');
            });

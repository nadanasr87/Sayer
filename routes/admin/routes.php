...
use App\Enums\ViewPaths\Admin\City;
...
Route::group(['namespace' => 'Admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin', 'current-module']], function () {
        ...
        Route::group(['prefix' => 'business-settings', 'as' => 'business-settings.'], function () {
            ...
            Route::group(['prefix' => 'city', 'as' => 'city.', 'middleware' => ['module:city']], function () {
                // cities
                Route::get(City::INDEX[URI], [ZoneController::class, 'index_cities'])->name('home');
                Route::post(City::ADD[URI], [ZoneController::class, 'import_cities'])->name('city_store');
        ...
        Route::group(['prefix' => 'users', 'as' => 'users.'], function () {
            ...
            Route::group(['prefix' => 'delivery-man', 'as' => 'delivery-man.'], function () {
                ...
                Route::group(['middleware' => ['module:deliveryman']], function () {
                    ...
                    Route::get(DeliveryMan::EARNINGLIST[URI], [DeliveryManController::class, 'earningList'])->name('list');
                    Route::post(DeliveryMan::PAYMENTSEARNINGLIST[URI], [DeliveryManController::class, 'storePaymentsEarningList'])->name('storePaymentsEarningList');
                    ...
                    Route::get(DeliveryMan::UPDATE_VEHICLE[URI].'/{id}/{vehicle}', [DeliveryManController::class, 'updateApplication'])->name('set-vehicle');

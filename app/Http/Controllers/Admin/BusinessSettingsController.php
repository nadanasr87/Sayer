...
class BusinessSettingsController extends Controller
{
    ...
    {
        $Tawseeldata = RemoteAPiController::getContactInfo();
        ...
        if ($tab == 'business') {
            ...
            return view('admin-views.business-settings.business-index', compact('Tawseeldata'));
    ...
    public function business_tawseel_setup(Request $request)
    {

        $data = RemoteAPiController::updateContactInfo(
            $request->responsibleName,
            $request->responsibleEmail,
            $request->responsibleMobileNumber,
            $request->technicalName,
            $request->technicalEmail,
            $request->technicalMobileNumber,
        );
        if ($data)
            Toastr::success(translate('successfully_update_app data in Tawseel platform'));
        else
            Toastr::error(translate('faild successfully_update_app data in Tawseel platform'));

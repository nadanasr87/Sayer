...
class DashboardController extends Controller
{
    ...
    public function transaction_dashboard(Request $request)
    {
        $data = [
            "person"=> [
                "phone"=> "+966566048293",
                "identityId"=> 1114774431,
                "cityId"=> 2,
                "gender"=> "true"
            ],
            "identityCardInfo"=> [
                "nameEn"=> "ALGHAMDI , MESHAL MOHAMMED Y",
                "nameAr"=> "مشعل بن محمد بن يعن الله الفقيه الغامدي",
                "versionNumber"=> null,
                "number"=> "1114774431 1114774439",
                "DOB"=> "19/01/2001",
                "DOE"=> "05/01/2027",
                "expiryDateAr"=> "1448/07/27",
                "birthDateAr"=> "1431/10/24",
                "placeOfBirth"=> "جده"
            ],
            "drivingLicenseInfo"=> [
                "nameEn"=> "MESHAL MOHAMMED YAAN ALLAH ALGHAMDI",
                "nameAr"=> "مشعل بن محمد بن يعن الله الغامدي",
                "issueDateAr"=> "1440/07/28",
                "version"=> "2 VER",
                "idAr"=> "null",
                "nationality"=> "سعودي",
                "bloodType"=> "0+ B - G",
                "restrictions"=> "0 RESTR",
                "type"=> "خاصة",
                "category"=> "PRIVATE",
                "national"=> "SAUDI",
                ...
                "expiryDateAr"=> "15/07/2",
                "dateOfBirthAr"=> "1421/10/24",
                "id"=> 1114774431
            ],
            "transportLicenseInfo"=> [
                "owner"=> " مشعل محمد يعن الله الغامدي",
                "user"=> null,
                "ownerID"=> 1114774431,
                "userID"=> null,
                "chassisNumber"=> "JTDBV42E9DJ043195",
                "plateNumber"=> "ح ب ه ب ه 7404 7404 H B",
                "registrationType"=> "خاص",
                "vehicleModel"=> "كورولا",
                "vehicleBrand"=> "تويوتا",
                "vehicleWeight"=> 1635,
                "vehicleLoad"=> 5,
                "color"=> " رصاصي 944895210",
                "manufacturingYear"=> 2013,
                "serialNumber"=>654
            ]
        ];
        info($data['identityCardInfo']['nameAr']);
        $full_name = explode(' ',trim($data['identityCardInfo']['nameAr']));

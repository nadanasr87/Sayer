...
class OrderController extends Controller
{
    ...
    public function place_order(Request $request)
    {
        ...
        try {
            DB::beginTransaction();
            // $orderTawseelModel = [];
            // $city = City::whereId($request->cityId)->first();

            // $orderTawseelModel['orderNumber'] = $order->id;
            // $orderTawseelModel['authorityId'] = "J4DRtp+fYEM=";
            // $orderTawseelModel['deliveryTime'] = Carbon::now()->format('Y-m-d H:i:s');
            // $orderTawseelModel['regionId'] = $city->regionId;
            // $orderTawseelModel['cityId'] = $request->cityId;
            // $orderTawseelModel['coordinates'] = new Point($request->latitude, $request->longitude, POINT_SRID);
            // $orderTawseelModel['storetName'] = 'personal';
            // $orderTawseelModel['storeLocation'] = $request->latitude . $request->longitude;
            // $orderTawseelModel['categoryId'] = "A/VaSUhyG28=";
            // $orderTawseelModel['orderDate'] = Carbon::now()->format('Y-m-d H:i:s');
            // $orderTawseelModel['recipientMobileNumber'] = $request->MobileNumber;

            // $data = RemoteAPiController::CreateOrder(
            //     $orderTawseelModel['orderNumber'],
            //     $orderTawseelModel['authorityId'],
            //     $orderTawseelModel['deliveryTime'],
            //     $orderTawseelModel['regionId'],
            //     $orderTawseelModel['cityId'],
            //     $orderTawseelModel['coordinates'],
            //     $orderTawseelModel['storetName'],
            //     $orderTawseelModel['storeLocation'],
            //     $orderTawseelModel['categoryId'],
            //     $orderTawseelModel['orderDate'],
            //     $orderTawseelModel['recipientMobileNumber']
            // );

            // TwaseelData::create([
            //     'type' => 'CreateOrder',
            //     'reference_table' => 'orders',
            //     'reference' => $orderTawseelModel['orderNumber'],
            //     'data' => $orderTawseelModel,
            //     'status' => $data['status']
            // ]);
            $order->referenceCode = $data['referenceCode']??'5454';
            info('iam here');

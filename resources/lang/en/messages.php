<?php return array (
  ...
  'Ex: https://epulsecart.com/' => 'Ex: https://epulsecart.com/',
  'instructions' => 'Instructions',
  ...
  'get_your_zip_file_from_the_purchased_theme_and_upload_it_and_activate_theme_with_your_epulsecart_username_and_purchase_code' => 'Get your zip file from the purchased theme and upload it and activate theme with your epulsecart username and purchase code',
  ...
  'epulsecart_username' => 'epulsecart username',
  ...
  'epulsecart_usename' => 'epulsecart usename',
  ...
  'get_your_zip_file_from_the_purchased_addon_and_upload_it_and_activate_addon_with_your_epulsecart_username_and_purchase_code' => 'Get your zip file from the purchased addon and upload it and activate addon with your epulsecart username and purchase code',
  ...
  'Withdraw_Able_Balance' => 'Withdraw Able Balance',
  'Withdraw_Able_Balance_stc' => 'Withdraw Able Balance STC',
  'payout_all_balance' => 'Payout all balance',
  'refresh_payouts_data_from_bank' => 'refresh payouts data from bank',
  'CustomerReference' => 'stc bulk Customer Reference',
  'PaymentReference' => 'stc bulk Payment Reference',
  ...
  'After purchasing the Payment & SMS Module from epulsecart, you will find a file download option.' => 'After purchasing the Payment & SMS Module from epulsecart  you will find a file download option.',
  ...
  'no records of withdraw able balance' => 'No records of withdraw able balance',
  'payouts' => 'Payouts',
  'cURL error 6: name lookup timed out (see https://curl.haxx.se/libcurl/c/libcurl-errors.html) for https://sandbox.b2b.stcpay.com.sa/B2B.MerchantTransactionsWebApi/MerchantTransactions/v3/PaymentOrderPay' => 'CURL error 6: name lookup timed out (see https://curl.haxx.se/libcurl/c/libcurl-errors.html) for https://sandbox.b2b.stcpay.com.sa/B2B.MerchantTransactionsWebApi/MerchantTransactions/v3/PaymentOrderPay',
  'cURL error 6: Couldn\'t resolve host \'sandbox.b2b.stcpay.com.sa\' (see https://curl.haxx.se/libcurl/c/libcurl-errors.html) for https://sandbox.b2b.stcpay.com.sa/B2B.MerchantTransactionsWebApi/MerchantTransactions/v3/PaymentOrderPay' => 'CURL error 6: Couldn t resolve host  sandbox.b2b.stcpay.com.sa  (see https://curl.haxx.se/libcurl/c/libcurl-errors.html) for https://sandbox.b2b.stcpay.com.sa/B2B.MerchantTransactionsWebApi/MerchantTransactions/v3/PaymentOrderPay',
  'Company Information in tawseel' => 'Company Information in tawseel',
  'successfully_update_app data in Tawseel platform' => 'Successfully update app data in Tawseel platform',
  'addresses' => 'Addresses',
  ...
  'module abdullah' => 'Module abdullah',
  ...
  'This value is the miximum distance for a vehicle in this category to serve an order.
                                                                                                                                                                                            ' => 'This value is the miximum distance for a vehicle in this category to serve an order.
                                                                                                                                                                                            ',
  'This value is the parcel category.
                                                                                                                                                                                            ' => 'This value is the parcel category.
                                                                                                                                                                                            ',

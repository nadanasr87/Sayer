                ...
                <form action="{{ route('admin.users.customer.wallet.bonus.update', [$bonus['id']]) }}" method="post">
                    ...
                    <div class="row g-3">
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="description[]" id="default_description"
                                                    ...
                                                    value="{{ $bonus?->getRawOriginal('description') }}">
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="description[]"
                                                        ...
                                                        placeholder="{{ translate('messages.description') }}"
                                                        value="{{ $translate[$lang]['description'] ?? '' }}">
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div id="default-form">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title[]" class="form-control"
                                            placeholder="{{ translate('messages.title') }}" value="{{ $bonus['title'] }}"
                                            maxlength="100">
                                    </div>
                                    <input type="hidden" name="lang[]" value="default">
                                </div>
                        ...
                        <div class="col-md-4 col-lg-4 col-sm-6">
                            <div class="form-group m-0">
                                ...
                                <select name="bonus_type" id="bonus_type" class="form-control">
                                    <option value="amount" {{ $bonus['bonus_type'] == 'amount' ? 'selected' : '' }}>
                        ...
                        <div class="col-md-4 col-lg-4 col-sm-6">
                            <div class="form-group m-0">
                                <label class="input-label" for="bonus_amount">{{ translate('messages.Bonus_Amount') }}
                                    <span class="{{ $bonus['bonus_type'] == 'amount' ? '' : 'd-none' }}"
                                        id='cuttency_symbol'>({{ \App\CentralLogics\Helpers::currency_symbol() }})
                                    </span>
                                    <span class="{{ $bonus['bonus_type'] == 'percentage' ? '' : 'd-none' }}"
                                        id="percentage">(%)</span>
                                ...
                                <input type="number" id="bonus_amount" min="1" max="999999999999.99"
                                    step="0.01" value="{{ $bonus['bonus_amount'] }}" name="bonus_amount"
                        ...
                        <div class="col-md-4 col-lg-4 col-sm-6">
                            <div class="form-group m-0">
                                <label class="input-label"
                                    for="minimum_add_amount">{{ translate('messages.Minimum_Add_Money_Amount') }}
                                ...
                                <input type="number" id="minimum_add_amount" min="1" max="999999999999.99"
                                    step="0.01" value="{{ $bonus['minimum_add_amount'] }}" name="minimum_add_amount"
                                    class="form-control" required>
                            </div>
                        </div>
                        <div class="col-md-4 col-lg-4 col-sm-6">
                            <div class="form-group m-0">
                                ...
                                <input type="number" min="0" max="999999999999.99" step="0.01"
                                    ...
                                    {{ $bonus['bonus_type'] == 'amount' ? 'readonly="readonly"' : '' }}>
                            </div>
                        </div>
                        <div class="col-md-4 col-lg-4 col-sm-6">
                            <div class="form-group m-0">
                                ...
                                <input type="date" name="start_date" class="form-control" id="date_from"
                                    ...
                                    max="{{ date('Y-m-d', strtotime($bonus['end_date'])) }}"
                                    value="{{ date('Y-m-d', strtotime($bonus['start_date'])) }}"
                        ...
                        <div class="col-md-4 col-lg-4 col-sm-6">
                            <div class="form-group m-0">
                                ...
                                <input type="date" name="end_date" class="form-control"
                                    placeholder="{{ translate('messages.select_date') }}"
                                    min="{{ date('Y-m-d', strtotime($bonus['start_date'])) }}" id="date_to"
                                    value="{{ date('Y-m-d', strtotime($bonus['end_date'])) }}"
                                    data-hs-flatpickr-options='{
                                     "dateFormat": "Y-m-d"
                                   }'>
                            </div>

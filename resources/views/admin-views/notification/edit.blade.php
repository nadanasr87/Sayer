                                ...
                                <div class="col-12">
                                    <div class="form-group mb-0">
                                        ...
                                        <select name="zone" id="zone" class="form-control js-select2-custom">
                                            <option value="all" {{ isset($notification->zone_id) ? '' : 'selected' }}>
                                                {{ translate('messages.all_zone') }}</option>
                                            @foreach ($zones as $zone)
                                                <option value="{{ $zone['id'] }}"
                                                    {{ $notification->zone_id == $zone['id'] ? 'selected' : '' }}>
                                                    {{ $zone['name'] }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                            ...
                            <div class="h-100 d-flex flex-column">
                                ...
                                <div class="text-center py-3 my-auto">
                                    <img class="img--vertical onerror-image" id="viewer"
                                        src="{{ \App\CentralLogics\Helpers::onerror_image_helper($notification['image'], asset('storage/notification/') . '/' . $notification['image'], asset('assets/admin/img/900x400/img1.jpg'), 'notification/') }}"

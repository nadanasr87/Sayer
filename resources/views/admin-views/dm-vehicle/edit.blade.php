                                    ...
                                    @else
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="type" class="form-control h--45px"
                                                ...
                                                maxlength="191" value="{{ $vehicle['type'] }}">
                                        </div>
                                        <input type="hidden" name="lang[]" value="default">
                                    @endif
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="0.001"id="extra_charges" class="form-control h--45px"
                                            value="{{ $vehicle->extra_charges }}" min="0" required
                                            name="extra_charges">
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="form-group">
                                        <label class="input-label text-capitalize"
                                            ...
                                            ({{ translate('messages.km') }})<span class="input-label-secondary"
                                                ...
                                                data-original-title="{{ translate('messages.minimum_coverage_area_hint') }}"><img
                                                    src="{{ asset('assets/admin/img/info-circle.svg') }}"
                                                    alt="public/img"></span></label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="input-label text-capitalize"
                                            ...
                                            ({{ translate('messages.km') }})<span class="input-label-secondary"
                                                data-toggle="tooltip" data-placement="right"
                                                data-original-title="{{ translate('messages.maximum_coverage_area_hint') }}"><img
                                                    src="{{ asset('assets/admin/img/info-circle.svg') }}"
                                                    alt="public/img"></span></label>
                            ...
                            <select name="parcel_category_id" class="form-control js-select2-custom">
                                @foreach (\App\Models\ParcelCategory::get() as $ParcelCategory)
                                    <option value="{{ $ParcelCategory->id }}"
                                        @if ($vehicle->parcel_category_id === $ParcelCategory->id) selected @endif>
                                        {{ $ParcelCategory->name }}
                                    </option>
                                @endforeach
                            </select>

                                ...
                                <div class="col-md-6">
                                    ...
                                    @else
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="type" class="form-control h--45px"
                                                placeholder="{{ translate('messages.ex_:_bike') }}" required
                                                maxlength="191">
                                        </div>
                                        <input type="hidden" name="lang[]" value="default">
                                    @endif
                        ...
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="input-label text-capitalize"
                                            for="title">{{ translate('messages.minimum_coverage_area') }}
                                            ({{ translate('messages.km') }}) <span class="input-label-secondary"
                                                data-toggle="tooltip" data-placement="right"
                                                data-original-title="{{ translate('This value is the minimum distance for a vehicle in this category to serve an order.') }}"><img
                                                    src="{{ asset('assets/admin/img/info-circle.svg') }}"
                                                    alt="public/img"></span></label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="input-label text-capitalize"
                                            ...
                                            ({{ translate('messages.km') }}) <span class="input-label-secondary"
                                                data-toggle="tooltip" data-placement="right"
                                                data-original-title="{{ translate('This value is the miximum distance for a vehicle in this category to serve an order.
                                                                                                                                                                                                                                            ') }}"><img
                                                    src="{{ asset('assets/admin/img/info-circle.svg') }}"
                                                    alt="public/img"></span></label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="input-label text-capitalize"
                                            for="title">{{ translate('messages.parcel_category') }}
                                            <span class="input-label-secondary" data-toggle="tooltip"
                                                data-placement="right"
                                                data-original-title="{{ translate('This value is the parcel category.
                                                                                                                                                                                                                                            ') }}"><img
                                                    src="{{ asset('assets/admin/img/info-circle.svg') }}"
                                                    alt="public/img"></span></label>
                                        <select name="parcel_category_id" class="form-control js-select2-custom">
                                            @foreach (\App\Models\ParcelCategory::get() as $ParcelCategory)
            ...
            $.post({
                ...
                success: function(data) {
                    if (data.errors) {
                        ...
                        setTimeout(function() {
                            location.href =
                                '{{ route('admin.users.delivery-man.vehicle.list') }}';
                        }, 1000);
                    }
                }
            });

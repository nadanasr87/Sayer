    ...
    <div class="content container-fluid">
        ...
        <form action="{{ route('admin.business-settings.login_url_update') }}" method="post">
            ...
            <h5 class="card-title mb-3 pt-3">
                ...
                <span>{{ translate('Admin_login_page') }}</span>
            </h5>
            <div class="card">
                <div class="card-body">
                    <div class="row g-3">
                            ...
                            <div class="__bg-F8F9FC-card">
                                <div class="form-group">
                                    ...
                                    <div class="input-group-prepend">
                                        ...
                                        <input type="text" placeholder="{{ translate('messages.admin_login_url') }}"
                                            class="form-control h--45px" name="admin_login_url" required
                                            value="{{ $data['admin_login_url'] ?? null }}">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="btn--container justify-content-end mt-3">
                        <button type="{{ env('APP_MODE') != 'demo' ? 'submit' : 'button' }}"
                            class="btn btn--primary mb-2 call-demo">{{ translate('messages.submit') }}</button>
                    </div>
                </div>
            </div>
        </form>
        <form action="{{ route('admin.business-settings.login_url_update') }}" method="post">
            ...
            <h5 class="card-title mb-3 pt-3">
                <span class="card-header-icon mr-2"><i class="tio-settings-outlined"></i></span>
                <span>{{ translate('admin_employee_login_page') }}</span>
            </h5>
            <div class="card">
                <div class="card-body">
                    <div class="row g-3">
                            ...
                            <div class="__bg-F8F9FC-card">
                                <div class="form-group">
                                    ...
                                    <div class="input-group-prepend">
                                        <div class="input-group-text">{{ url('/') }}/login/</div>
                                        <input type="text"
                                            placeholder="{{ translate('messages.admin_employee_login_url') }}"
                                            class="form-control h--45px" name="admin_employee_login_url" required
                                            value="{{ $data['admin_employee_login_url'] ?? null }}">
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <form action="{{ route('admin.business-settings.login_url_update') }}" method="post">
            ...
            <h5 class="card-title mb-3 pt-3">
                <span class="card-header-icon mr-2"><i class="tio-settings-outlined"></i></span>
                <span>{{ translate('store_login_page') }}</span>
            </h5>
            <div class="card">
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-md-12">
                            ...
                            <div class="__bg-F8F9FC-card">
                                <div class="form-group">
                                    ...
                                    <div class="input-group-prepend">
                                        <div class="input-group-text">{{ url('/') }}/login/</div>
                                        <input type="text" placeholder="{{ translate('messages.store_login_url') }}"
                                            class="form-control h--45px" name="store_login_url" required
                                            value="{{ $data['store_login_url'] ?? null }}">
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <form action="{{ route('admin.business-settings.login_url_update') }}" method="post">
            ...
            <h5 class="card-title mb-3 pt-3">
                <span class="card-header-icon mr-2"><i class="tio-settings-outlined"></i></span>
                <span>{{ translate('store_employee_login_page') }}</span>
            </h5>
            <div class="card">
                <div class="card-body">
                    <div class="row g-3">
                            ...
                            <div class="__bg-F8F9FC-card">
                                <div class="form-group">
                                    ...
                                    <div class="input-group-prepend">
                                        <div class="input-group-text">{{ url('/') }}/login/</div>
                                        <input type="text"
                                            placeholder="{{ translate('messages.store_employee_login_url') }}"
                                            class="form-control h--45px" name="store_employee_login_url" required
                                            value="{{ $data['store_employee_login_url'] ?? null }}">
                                    </div>
                                </div>
                            </div>
                        </div>

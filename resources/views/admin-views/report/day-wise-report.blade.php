                        ...
                        <tbody id="set-rows">
                            @foreach ($order_transactions as $k => $ot)
                                <tr scope="row">
                                    ...
                                    <td class="white-space-nowrap">
                                        {{ \App\CentralLogics\Helpers::number_format_short($ot->order['coupon_discount_amount'] + $ot->order['store_discount_amount'] + $ot->order['flash_store_discount_amount'] + $ot->order['flash_admin_discount_amount']) }}
                                    </td>
                                    <td class="white-space-nowrap">
                                    ...
                                    <td class="white-space-nowrap">
                                        {{ \App\CentralLogics\Helpers::format_currency($ot->discount_amount_by_store + $ot->order['flash_store_discount_amount']) }}
                                    </td>
                                    <td class="white-space-nowrap">

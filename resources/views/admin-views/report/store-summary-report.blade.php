                ...
                <div class="statistics-btn-grp">
                    <label>
                        <input type="radio" name="filter" value="all_time"
                            {{ isset($filter) && $filter == 'all_time' ? 'checked' : '' }} data-url="{{ url()->full() }}"
                            data-filter="filter" class="set-filter" hidden>
                        <span>{{ translate('All Time') }}</span>
                    </label>
                    <label>
                        <input type="radio" name="filter" value="this_year"
                            {{ isset($filter) && $filter == 'this_year' ? 'checked' : '' }} data-url="{{ url()->full() }}"
                            data-filter="filter" class="set-filter" hidden>
                    ...
                    <label>
                        <input type="radio" name="filter" value="previous_year"
                            ...
                            data-url="{{ url()->full() }}" data-filter="filter" class="set-filter" hidden>
                    ...
                    <label>
                        <input type="radio" name="filter" value="this_week"
                            {{ isset($filter) && $filter == 'this_week' ? 'checked' : '' }} data-url="{{ url()->full() }}"
                            data-filter="filter" class="set-filter" hidden>
...
@push('script_2')
    ...
    <script>
        ...
        let options = {
            ...
            labels: [
                '{{ translate('Cash Payments') }} ({{ count($order_payment_methods) > 0 ? (isset($order_payment_methods[0]) ? $order_payment_methods[0]->total_order_amount : 0) : 0 }})',

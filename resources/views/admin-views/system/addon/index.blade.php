...
@section('content')
    <div class="content container-fluid">
        ...
        <div class="page-header d-flex justify-content-between">
            ...
            <div class="cursor-pointer text-primary d-flex align-items-center gap-3 font-weight-bolder" data-toggle="modal"
                            ...
                            <div class="item">
                                <div class="mb-20">
                                    <div class="">
                                        ...
                                        <ol>
                                            <li>{{ translate('After purchasing the Payment & SMS Module from epulsecart, you will find a file download option.') }}
                                            </li>
                                            <li>{{ translate('Download the file. It will be downloaded as Zip format Filename.Zip.') }}
                                            </li>
                                            <li>{{ translate('Extract the file and you will get another file name payment.zip.') }}
                                            </li>
                                            <li>{{ translate('Upload the file here and your Addon uploading is complete !') }}
                                            </li>
                                            <li>{{ translate('Then active the Addon and setup all the options. you are good to go !') }}
                                            </li>
                                        </ol>
                    ...
                    <div class="row g-3">
                            ...
                            <div class="uploadDnD">
                                <div class="form-group inputDnD">
                                    <input type="file" name="file_upload"
                                        class="form-control-file text--primary font-weight-bold read-file" id="inputFile"
                                        accept=".zip" data-title="Drag & drop file or Browse file">
                                </div>
                            </div>
                            ...
                            <div class="pl-sm-5">
                                ...
                                <ul class="pl-3 d-flex flex-column gap-2 instructions-list">
                                    <li>
                                        ...
                                        "upload_max_filesize" {{ translate('value_is_grater_or_equal_to_20MB') }}.
                                        {{ translate('current_value_is') }}
                        ...
                        <div class="col-12">
                            <div class="d-flex justify-content-end mt-3">
                                <button type="button" class="btn btn--primary px-4 zip-upload"
                            ...
                            <div class="d-flex gap-2 gap-sm-3 align-items-center">
                                @if ($data['is_published'] == 0)
                                    <button class="text-danger bg-transparent p-0 border-0 mr-2" data-toggle="modal"
                                        data-target="#deleteThemeModal_{{ $key }}"><img
                                            src="{{ asset('assets/admin/img/delete.svg') }}" class="svg"
                                            alt=""></button>
                                    <!-- Delete Theme Modal -->
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body px-4 px-sm-5 text-center">
                                                    <div class="mb-3 text-center">
                                                        <img width="75"
                                                            src="{{ asset('assets/admin/img/delete.png') }}"
                                                            alt="">
                                                    </div>
                                                    ...
                                                    <div class="btn--container justify-content-center mb-3">
                                                        ...
                                                        <button type="submit"
                                                            ...
                                                            data-dismiss="modal"
                                                            data-path="{{ $addon }}">{{ translate('delete') }}</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <button
                                    ...
                                    data-toggle="modal" data-target="#shiftThemeModal_{{ $key }}"><img
                                        src="{{ asset('assets/admin/img/check.svg') }}" class="svg"
                                        alt=""></button>
                                    ...
                                    <div class="modal-dialog status-warning-modal">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body px-4 pt-0 px-sm-5 text-center">
                                                <div class="mb-3 text-center">
                                                    <img width="75" src="{{ asset('assets/admin/img/shift.png') }}"
                                                        alt="">
                                                </div>
                                                ...
                                                @if ($data['is_published'])
                                                    <p class="mb-5">
                                                        {{ translate('want_to_disabled_this_' . ' ' . $data['name']) }}</p>
                                                @else
                                                    <p class="mb-5">
                                                        {{ translate('want_to_activate_this_' . ' ' . $data['name']) }}</p>
                                                @endif
                                                <div class="btn--container justify-content-center mb-3">
                                                    <button type="button" class="fs-16 btn btn-secondary px-sm-5"
                                ...
                                <form action="" method="post">
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="username" value="" class="form-control"
                                            placeholder="{{ translate('epulsecart_username') }}">
                                    </div>
                                    <div class="form-group">
                                        <input type="text" name="purchase_code" value="" class="form-control"
                                            placeholder="{{ translate('purchase_code') }}">

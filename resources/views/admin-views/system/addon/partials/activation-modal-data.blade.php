...
<div class="modal-body px-4 px-sm-5">
    <div class="mb-4 text-center">
        ...
        <img width="200"
            src="{{ \App\CentralLogics\Helpers::onerror_image_helper(
                ...
                asset('assets/admin/img/img1.jpg'),
                'restaurant/',
            ) }}"
            alt="image" class="dark-support onerror-image"
            data-onerror-image="{{ asset('assets/admin/img/img1.jpg') }}" />
    </div>
    ...
    <form action="{{ route('admin.business-settings.system-addon.activation') }}" method="post"
        ...
        <div class="form-group mb-4">
            <label for="username">{{ translate('epulsecart_usename') }}</label>

                    ...
                    <tr>
                        <td>
                            <div class="left">
                                ...
                                <div class="date">
                                    {{ \App\CentralLogics\Helpers::time_date_format(date('Y-m-d h:i:s', time())) }}</div>
                            </div>
                        </td>
                            ...
                            <div class="right text-right">
                                <div class="logo">
                                    <img style="width: 160px;object-fit: contain;object-position: right center"
                                        src="{{ asset('storage/business/' . $logo ?? '') }}" alt="logo">
                                </div>
                                <div>{{ $address }}</div>
                            </div>
                        </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div>
                                    ...
                                    <div>{{ \App\CentralLogics\Helpers::time_date_format($disbursement->created_at) }}
                                    </div>
                                </div>
                            </td>
                            <td class="text-right">
                                <div class="ml-auto text-right">
                                    ...
                                    <div style="font-size: 16px;margin: 0;color: #1455AC;">
                    ...
                    <tbody>
                        @foreach ($disbursements as $key => $disb)
                            <tr>
                                ...
                                <td>
                                    <div class="name mt-10px">
                                        {{ $disb->delivery_man->f_name . ' ' . $disb->delivery_man->l_name }}</div>
                                </td>
                                <td>

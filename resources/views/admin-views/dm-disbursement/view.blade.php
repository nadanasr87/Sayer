                ...
                <div class="search--button-wrapper">
                    <h2 class="card-title">
                        {{ translate('Total_Disbursements') }} <span class="badge badge-soft-secondary ml-2"
                            id="countItems">{{ $disbursement_delivery_mans->total() }}</span>
                    </h2>
                    <form class="search-form">
                        <!-- Search -->
                        <div class="input--group input-group input-group-merge input-group-flush">
                            <input class="form-control" value="{{ request()?->search ?? null }}"
                                placeholder="{{ translate('search_by_delivery_man_info') }}" name="search">
                    ...
                    <div class="hs-unfold ml-3">
                        ...
                        <div id="usersExportDropdown"
                            ...
                            <a id="export-excel" class="dropdown-item"
                                href="{{ route('admin.transactions.dm-disbursement.export', ['id' => $disbursement->id, 'type' => 'excel', request()->getQueryString()]) }}">
                                <img class="avatar avatar-xss avatar-4by3 mr-2"
                                    src="{{ asset('assets/admin') }}/svg/components/excel.svg" alt="Image Description">
                                {{ translate('messages.excel') }}
                            </a>
                            <a id="export-csv" class="dropdown-item"
                                href="{{ route('admin.transactions.dm-disbursement.export', ['id' => $disbursement->id, 'type' => 'csv', request()->getQueryString()]) }}">
                                <img class="avatar avatar-xss avatar-4by3 mr-2"
                            ...
                            <a id="export-pdf" class="dropdown-item"
                                href="{{ route('admin.transactions.dm-disbursement.export', ['id' => $disbursement->id, 'type' => 'pdf', request()->getQueryString()]) }}">
                                <img class="avatar avatar-xss avatar-4by3 mr-2"
                        ...
                        <tbody>
                            @foreach ($disbursement_delivery_mans as $key => $dm)
                                <tr>
                                    <td>
                                        <label class="form-check form--check mb-14">
                                            <input type="checkbox" name="dm_ids[]" class="form-check-input rest-check"
                                                value="{{ $dm->delivery_man_id }}">
                                        </label>
                                    </td>
                                    <td>
                                        <span
                                            class="font-weight-bold">{{ $key + $disbursement_delivery_mans->firstItem() }}</span>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="btn--container justify-content-center">
                                            <a class="btn btn-sm btn--primary btn-outline-primary action-btn"
                                                data-toggle="modal" data-target="#payment-info-{{ $dm->id }}"
                                                title="View Details">
                                                <i class="tio-visible"></i>
                                            </a>
                                            @if ($dm->status == 'completed')
                                                <a class="btn btn-sm btn--danger btn-outline-danger action-btn action-btn-section"
                                                    href="{{ route('admin.transactions.dm-disbursement.change-status', ['id' => $dm->id, 'status' => 'pending']) }}"
                                                    data-toggle="tooltip" title="{{ translate('revert') }}">
                                                    <i class="tio-restore"></i>
                                                </a>
                                            @else
                                                @if ($dm->status != 'canceled')
                                                    <a class="btn btn-sm btn--danger btn-outline-danger action-btn action-btn-section"
                                                        href="{{ route('admin.transactions.dm-disbursement.change-status', ['id' => $dm->id, 'status' => 'canceled']) }}"
                                                ...
                                                <a class="btn btn-sm btn--primary btn-outline-primary action-btn action-btn-section"
                                                    href="{{ route('admin.transactions.dm-disbursement.change-status', ['id' => $dm->id, 'status' => 'completed']) }}"

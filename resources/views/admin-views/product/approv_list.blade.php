            ...
            <div class="row align-items-center g-2">
                <div class="col-md-9 col-12">
                    <h1 class="page-header-title">
                        ...
                        <span>
                            {{ translate('messages.New_Item_requests') }} <span class="badge badge-soft-dark ml-2"
                    ...
                    <div class="hs-unfold mr-2">
                        ...
                        <div id="usersExportDropdown"
                            ...
                            <a id="export-excel" class="dropdown-item"
                                href="{{ route('admin.item.export', ['type' => 'excel', 'table' => 'TempProduct', request()->getQueryString()]) }}">
                                <img class="avatar avatar-xss avatar-4by3 mr-2"
                                    src="{{ asset('assets/admin') }}/svg/components/excel.svg" alt="Image Description">
                                {{ translate('messages.excel') }}
                            </a>
                            <a id="export-csv" class="dropdown-item"
                                href="{{ route('admin.item.export', ['type' => 'csv', 'table' => 'TempProduct', request()->getQueryString()]) }}">
                                <img class="avatar avatar-xss avatar-4by3 mr-2"
                    ...
                    <tbody id="set-rows">
                        @foreach ($items as $key => $item)
                            <tr>
                                ...
                                <td>
                                    @if ($item->store)
                                        <a href="{{ route('admin.store.view', $item->store->id) }}"
                                ...
                                <td>
                                    <div class="btn--container justify-content-center">
                                        ...
                                        <a class="btn action-btn btn--primary btn-outline-primary request_alert"
                                            ...
                                            data-url="{{ route('admin.item.approved', ['id' => $item['id']]) }}"
                                        ...
                                        @if ($item->is_rejected == 0)
                                            <a class="btn action-btn btn--danger btn-outline-danger cancelled_status"
                                                data-toggle="tooltip" data-placement="top"
                                        ...
                                        <a class="btn action-btn btn--primary btn-outline-primary"
                                            href="{{ route('admin.item.edit', [$item['id'], 'temp_product' => true]) }}"

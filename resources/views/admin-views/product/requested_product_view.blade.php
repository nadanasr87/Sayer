                            ...
                            <tr>
                                <td class="px-4 max-w--220px">
                                    ...
                                    <span class="d-block mb-1">
                                        ...
                                        <strong>{{ Str::limit($product?->category?->name ?? translate('messages.uncategorize'), 20, '...') }}</strong>
                                    </span>
                                ...
                                <td class="px-4">
                                    ...
                                    <span class="d-block mb-1">
                                        ...
                                        <strong> {{ $product?->store?->tax . '%' }}
                                            ({{ $tax_included == 1 ? translate('included') : translate('excluded') }})</strong>
                                    </span>

                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="w-0 flex-grow pl-3">
                                ...
                                <p class="page-header-text m-0">
                                    {{ translate('Hello,_here_you_can_manage_your_users_by_zone.') }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="__user-dashboard-card">
                        <div class="__user-dashboard-card-thumbs">
                            ...
                            @foreach ($customers as $key => $customer)
                                <img src="{{ \App\CentralLogics\Helpers::onerror_image_helper($customer['image'], asset('storage/profile/') . '/' . $customer['image'], asset('assets/admin/img/160x160/img2.jpg'), 'profile/') }}"
                                    class="onerror-image"
                    ...
                    <div class="__user-dashboard-card" style="--theme-clr:#006AB4">
                        <div class="__user-dashboard-card-thumbs">
                            ...
                            @foreach ($delivery_man as $key => $dm)
                                <img src="{{ \App\CentralLogics\Helpers::onerror_image_helper($dm['image'], asset('storage/delivery-man/') . '/' . $dm['image'], asset('assets/admin/img/160x160/img2.jpg'), 'delivery-man/') }}"
                                    class="onerror-image"
                                    data-onerror-image="{{ asset('assets/admin/img/160x160/img2.jpg') }}" alt="new-img">
                            @endforeach
                        </div>
                    ...
                    <div class="__user-dashboard-card" style="--theme-clr:#FFA800">
                        <div class="__user-dashboard-card-thumbs">
                            ...
                            @foreach ($employees as $key => $item)
                                ...
                                @break
                            @endif
                            <img src="{{ \App\CentralLogics\Helpers::onerror_image_helper($item['image'], asset('storage/delivery-man/') . '/' . $item['image'], asset('assets/admin/img/160x160/img2.jpg'), 'delivery-man/') }}"
                                class="onerror-image"
                                data-onerror-image="{{ asset('assets/admin/img/160x160/img2.jpg') }}" alt="new-img">
                        @endforeach
                    </div>
...
<script>
    ...
    let options = {
        ...
        xaxis: {
            //   type: 'datetime',
            categories: ["{{ translate('Jan') }}", "{{ translate('Feb') }}", "{{ translate('Mar') }}",

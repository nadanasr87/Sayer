        ...
        <form action="{{ route('admin.business-settings.zone.module-update', $zone->id) }}" method="post" id="zone_form"
            ...
            <div class="row g-2">
                <div class="col-12">
                    ...
                    <span
                        class="badge badge-soft-danger mt-2">{{ translate('NB:_MUST_select_at_least_‘one’_payment_method.') }}</span>
                    <div class="check--item-wrapper mb-1">
                        ...
                        @if ($offline_payment && $offline_payment == 1)
                            <div class="check-item">
                                <div class="form-group form-check form--check">
                                    <input type="checkbox" name="offline_payment" value="offline_payment"
                                        class="form-check-input" id="offline_payment"
                                        {{ $zone->offline_payment == 1 ? 'checked' : '' }}>
                                    <label class="form-check-label qcont text-dark"
                                        for="offline_payment">{{ translate('messages.offline payment') }}</label>
                                </div>
                            </div>
                        @endif
                    </div>
                    ...
                    <div class="form-group mb-0">
                        <label class="input-label"
                            for="exampleFormControlSelect1">{{ translate('Choose_Business_Module') }}<span
                ...
                <div class="col-md-12">
                    <div class="delivery_charge_options" id="delivery_charge_options">
                        <div class="row gy-1" id="mod-label">
                            ...
                            <div class="col-sm-2">
                                <label for="">{{ translate('messages.Maximum delivery charge') }}

        ...
        <div class="card mb-3 mb-lg-5 mt-2">
            <div class="card-header py-2 border-0 gap-2">
                <div class="search--button-wrapper">
                    ...
                    <div class="min--260">
                        <input type="date" class="form-control set-filter" placeholder="{{ translate('mm/dd/yyyy') }}"
                            data-url="{{ route('admin.users.delivery-man.preview', ['id' => $deliveryMan->id, 'tab' => 'transaction']) }}"
                            data-filter="date" value="{{ $date }}">
                    </div>
                </div>
                <!-- Unfold -->
            ...
            <div class="card-body p-0">
                <div class="table-responsive">
                    <table id="datatable"
                        ...
                        <tbody>
                            @php(
    $digital_transaction = \App\Models\OrderTransaction::where('delivery_man_id', $deliveryMan->id)->when($date, function ($query) use ($date) {

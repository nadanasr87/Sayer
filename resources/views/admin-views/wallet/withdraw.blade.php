    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <h1 class="page-header-title mr-3 mb-md-0">
                ...
                <span>
                    {{ translate('messages.store_withdraw_transaction') }} <span class="badge badge-soft-dark ml-2"
            ...
            <div class="card-header py-2 border-0">
                <div class="search--button-wrapper justify-content-end">
                    ...
                    <div class="max-sm-flex-1">
                        <select name="withdraw_status_filter" class="custom-select h--40px py-0 status-filter">
                            <option value="all"

                ...
                <form action="{{ route('admin.flash-sale.update', [$flash_sale['id']]) }}" method="post">
                    ...
                    @if ($language)
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="lang_form" id="default-form">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title[]" maxlength="100" id="default_title"
                                            class="form-control"
                                            placeholder="{{ translate('messages.updated_flash_sale') }}"
                                            value="{{ $flash_sale?->getRawOriginal('title') }}">
                                    </div>
                                ...
                                <div class="row g-3 __bg-F8F9FC-card">
                                    <div class="col-sm-6">
                                        ...
                                        <input type="number" min=".01" step="0.001" max="100"
                                            ...
                                            value="{{ $flash_sale->admin_discount_percentage }}" class="form-control"
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input type="number" min=".01" step="0.001" max="100"
                                            ...
                                            value="{{ $flash_sale->vendor_discount_percentage }}" class="form-control"
                                            placeholder="{{ translate('Ex_:_50') }}" required>
                                    </div>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    <label class="input-label" for="default_title">{{ translate('messages.validity') }}
                                    </label>
                                </div>
                                <div class="row g-3 __bg-F8F9FC-card">
                                    <div class="col-6">
                                        <div>
                                            ...
                                            <input type="datetime-local" id="from" class="form-control" required=""
                                                name="start_date" value="{{ $flash_sale->start_date }}">
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div>
                                            ...
                                            <input type="datetime-local" id="to" class="form-control" required=""
                                                name="end_date" value="{{ $flash_sale->end_date }}">
                                        </div>
                                    </div>
                                </div>
                            </div>

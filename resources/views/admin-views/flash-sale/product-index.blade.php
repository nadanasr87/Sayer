                                ...
                                <div class="col-sm-4 col-6">
                                    <div class="form-group mb-0">
                                        ...
                                        <input type="number" placeholder="{{ translate('messages.Ex:_10') }}"
                                            class="form-control" name="stock" min="0" id="quantity">
                                    </div>
                                </div>
                                <div class="col-sm-4 col-6">
                                    <div class="form-group mb-0">
                                ...
                                <div class="col-sm-4 col-6">
                                    <div class="form-group mb-0">
                                        ...
                                        <input type="number" min="0" max="9999999999999999999999" value="0"
                                            step="0.001" name="discount" class="form-control" id="discount_amount"
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a class="media align-items-center"
                                                ...
                                                <img class="avatar avatar-lg mr-3 onerror-image"
                                                    src="{{ \App\CentralLogics\Helpers::onerror_image_helper($item->item['image'], asset('storage/product/') . '/' . $item->item['image'], asset('assets/admin/img/160x160/img2.jpg'), 'product/') }}"
                                        ...
                                        <td class="text-center">
                                            <label class="toggle-switch toggle-switch-sm"
                                                for="publishCheckbox{{ $item->id }}">
                                                <input type="checkbox"
                                                    data-url="{{ route('admin.flash-sale.status-product', [$item['id'], $item->status ? 0 : 1]) }}"
                                        ...
                                        <td class="text-center">
                                            <div class="btn--container justify-content-center">
                                                <a class="btn action-btn btn--danger btn-outline-danger form-control form-alert"
                                                    href="javascript:" data-id="item-{{ $item['id'] }}"
                                                    data-message="{{ translate('Want to delete this item ?') }}"
                                                    title="{{ translate('messages.delete') }}"><i
                                                        class="tio-delete-outlined"></i>
                                                </a>
                                                <form
                                                    action="{{ route('admin.flash-sale.delete-product', [$item['id']]) }}"

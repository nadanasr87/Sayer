                    ...
                    <div class="col-sm mb-2 mb-sm-0">
                        <div class="d-flex align-items-center">
                            <img class="onerror-image"
                                data-onerror-image="{{ asset('/assets/admin/img/eshop.svg') }}"src="{{ \App\CentralLogics\Helpers::onerror_image_helper($mod->icon, asset('storage/module/') . '/' . $mod->icon, asset('assets/admin/img/eshop.svg'), 'module/') }}"
                                width="38" alt="img">
                    ...
                    <div class="d-flex flex-wrap align-items-center justify-content-end">
                        <div class="status-filter-wrap">
                            <div class="statistics-btn-grp">
                                <label>
                                    <input type="radio" name="statistics" class="order_stats_update" value="this_year"
                                        {{ $params['statistics_type'] == 'this_year' ? 'checked' : '' }} hidden>
                                    <span>{{ translate('This_Year') }}</span>
                                </label>
                                <label>
                                    <input type="radio" name="statistics" class="order_stats_update" value="this_month"
                                        {{ $params['statistics_type'] == 'this_month' ? 'checked' : '' }} hidden>
                                    <span>{{ translate('This_Month') }}</span>
                                </label>
                                <label>
                                    <input type="radio" name="statistics" class="order_stats_update" value="this_week"

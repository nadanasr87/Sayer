            ...
            <div class="card-body">
                <form action="{{ route('admin.business-settings.module.update', [$module['id']]) }}" method="post"
                        ...
                        <div class="lang_form" id="default-form">
                            <div class="form-group">
                                <label class="input-label"
                                    for="exampleFormControlInput1">{{ translate('messages.Business_Module_name') }}
                                    ({{ translate('messages.default') }})</label>
                                <input type="text" name="module_name[]" class="form-control" maxlength="191"
                                    value="{{ $module?->getRawOriginal('module_name') }}">
                            </div>
                            <div class="form-group">
                                <label class="input-label d-flex" for="module_type">{{ translate('messages.description') }}
                                    ({{ translate('messages.default') }})<span
                                        class="form-label-secondary text-danger d-flex" data-toggle="tooltip"
                        ...
                        @foreach ($language as $lang)
                            ...
                            <div class="d-none lang_form" id="{{ $lang }}-form">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="module_name[]" class="form-control" maxlength="191"
                                        value="{{ $translate[$lang]['module_name'] ?? '' }}">
                                </div>
                                <div class="form-group">
                                    <label class="input-label d-flex"
                                        for="module_type">{{ translate('messages.description') }}
                                        ({{ strtoupper($lang) }})<span class="form-label-secondary text-danger d-flex"
                    ...
                    @else
                        <div class="form-group">
                            <label class="input-label"
                                for="exampleFormControlInput1">{{ translate('messages.Business_Module_name') }}</label>
                    ...
                    <div class="row mt-2">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label class="input-label"
                                    for="module_type">{{ translate('messages.business_module_type') }}</label>
                                <select name="module_type" id="module_type" class="form-control text-capitalize" disabled>
                                    @foreach (config('module.module_type') as $key)
                                        <option value="{{ $key }}"
                                            {{ $key == $module->module_type ? 'selected' : '' }}>{{ translate($key) }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="row h-100">
                                <div class="col-sm-6">
                                    <div class="form-group m-0 h-100 d-flex flex-column justify-content-center">
                                        ...
                                        <div class="text-center my-auto py-3">
                                            <img class="initial--15 onerror-image" id="viewer"
                                                data-onerror-image="{{ asset('assets/admin/img/400x400/img2.jpg') }}"
                                                src="{{ \App\CentralLogics\Helpers::onerror_image_helper($module['icon'], asset('storage/module/') . '/' . $module['icon'], asset('assets/admin/img/400x400/img2.jpg'), 'module/') }}"
                                                alt="image" />
                                        </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group m-0 h-100 d-flex flex-column justify-content-center">
                                        ...
                                        <div class="text-center my-auto py-3">
                                            <img class="initial--15 onerror-image" id="viewer2"
                                                data-onerror-image="{{ asset('assets/admin/img/400x400/img2.jpg') }}"
                                                src="{{ \App\CentralLogics\Helpers::onerror_image_helper($module['thumbnail'], asset('storage/module/') . '/' . $module['thumbnail'], asset('assets/admin/img/400x400/img2.jpg'), 'module/') }}"
                                                alt="image" />
                                        </div>
                                        <div class="custom-file">

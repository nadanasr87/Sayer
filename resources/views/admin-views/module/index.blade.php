                                    ...
                                    <td>
                                        <label class="toggle-switch toggle-switch-sm" for="status-{{ $module->id }}">
                                            <input type="checkbox" class="toggle-switch-input dynamic-checkbox"
                                                ...
                                                data-text-off="" class="toggle-switch-input"
                                    ...
                                    <td>
                                        <div class="btn--container justify-content-center">
                                            <a class="btn action-btn btn--primary btn-outline-primary"
                                                ...
                                                title="{{ translate('messages.edit_Business_Module') }}"><i
                                                    class="tio-edit"></i>
                                            </a>
                                        </div>
                                    </td>
                ...
                <div class="modal-body">
                    ...
                    <div class="mt-3 d-flex flex-wrap align-items-center justify-content-end">
                        <div class="btn--container justify-content-end">
                            <button type="button" data-dismiss="modal" data-toggle="modal" data-target="#warning-modal"
                                class="btn btn--primary">{{ translate('next') }}</button>
                        </div>
                    </div>
                </div>
            </div>

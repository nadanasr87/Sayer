                                ...
                                @if ($order->order_attachment)
                                                ...
                                                <div>
                                                    <button class="btn w-100 px-0" data-toggle="modal"
                                                        ...
                                                        <div class="gallary-card ml-auto">
                                                            <img src="{{ asset('storage/' . 'public/order/' . $item) }}"
                                    ...
                                    @else
                                        ...
                                        <button class="btn w-100 px-0" data-toggle="modal" data-target="#imagemodal"
                                            title="{{ translate('messages.order_attachment') }}">
                                            <div class="gallary-card ml-auto">
                                                <img src="{{ asset('storage/' . 'public/order/' . $order->order_attachment) }}"
                                                    alt="{{ translate('messages.prescription') }}"
                                                    class="initial--22 object-cover">
                                            </div>
                                        </button>
                                ...
                                <div class="media align-items-center cart--media pb-2">
                                    <div class="avatar avatar-xl mr-3"
                                        ...
                                        <img class="img-fluid onerror-image"
                                            src="{{ \App\CentralLogics\Helpers::onerror_image_helper($order->parcel_category ? $order->parcel_category->image : '', asset('storage/parcel_category') . '/' . ($order->parcel_category ? $order->parcel_category->image : ''), asset('assets/admin/img/160x160/img2.jpg'), 'parcel_category/') }}"
                                                            ...
                                                            @if ($editing)
                                                                <div class="avatar avatar-xl mr-3 cursor-pointer quick-view-cart-item"
                                                                    ...
                                                                    <img class="img-fluid rounded aspect-ratio-1 onerror-image"
                                                                        src="{{ \App\CentralLogics\Helpers::onerror_image_helper($detail->item['image'], asset('storage/product/') . '/' . $detail->item['image'], asset('assets/admin/img/160x160/img2.jpg'), 'product/') }}"
                                                                        data-onerror-image="{{ asset('assets/admin/img/160x160/img2.jpg') }}"
                                                            ...
                                                            @if ($editing)
                                                                <div class="avatar avatar-xl mr-3  cursor-pointer quick-view-cart-item"
                                                                    ...
                                                                    <img class="img-fluid rounded onerror-image"
                                                                        src="{{ \App\CentralLogics\Helpers::onerror_image_helper($detail->campaign['image'], asset('storage/campaign/') . '/' . $detail->campaign['image'], asset('assets/admin/img/160x160/img2.jpg'), 'campaign/') }}"
                                                                        data-onerror-image="{{ asset('assets/admin/img/160x160/img2.jpg') }}"
                                                                        alt="Image Description">
                                                                </div>
                                                            @else
                                        ...
                                        @foreach ($data as $key => $img)
                                            <div class="col-3">
                                                <img class="img__aspect-1 rounded border w-100 onerror-image"
                                                    ...
                                                    data-onerror-image="{{ asset('assets/admin/img/160x160/img2.jpg') }}"
                                                    src="{{ \App\CentralLogics\Helpers::onerror_image_helper($img, asset('storage/refund/') . '/' . $img, asset('assets/admin/img/160x160/img2.jpg'), 'refund/') }}">
                                            </div>
                                            <div class="modal fade" id="imagemodal{{ $key }}" tabindex="-1"
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <img src="{{ asset('storage/' . 'public/refund/' . $img) }}"
                                                                class="initial--22 w-100">
                                                        </div>
                                                        <div class="modal-footer">
                                                            <a class="btn btn-primary"
                                ...
                                <a class="media align-items-center deco-none customer--information-single"
                                    ...
                                    <div class="avatar avatar-circle">
                                        <img class="avatar-img onerror-image"
                                            ...
                                            src="{{ \App\CentralLogics\Helpers::onerror_image_helper($order->delivery_man->image, asset('storage/delivery-man/') . '/' . $order->delivery_man->image, asset('assets/admin/img/160x160/img1.jpg'), 'delivery-man/') }}"
                                            alt="Image Description">
                                    </div>
                                    <div class="media-body">
                                        <span
                        ...
                        @if ($order->customer && $order->is_guest == 0)
                            ...
                            <a class="media align-items-center deco-none customer--information-single"
                                ...
                                <div class="avatar avatar-circle">
                                    <img class="avatar-img onerror-image"
                                        data-onerror-image="{{ asset('assets/admin/img/160x160/img1.jpg') }}"
                                        src="{{ \App\CentralLogics\Helpers::onerror_image_helper($order->customer->image, asset('storage/profile/') . '/' . $order->customer->image, asset('assets/admin/img/160x160/img1.jpg'), 'profile/') }}"
                                        alt="Image Description">
                                </div>
                                <div class="media-body">
                                ...
                                @foreach ($data as $key => $img)
                                    <div class="col-3">
                                        <img class="img__aspect-1 rounded border w-100 onerror-image" data-toggle="modal"
                                            data-target="#imagemodal{{ $key }}"
                                            data-onerror-image="{{ asset('assets/admin/img/160x160/img2.jpg') }}"
                                            src="{{ \App\CentralLogics\Helpers::onerror_image_helper($img, asset('storage/order/') . '/' . $img, asset('assets/admin/img/160x160/img2.jpg'), 'order/') }}">
                                    </div>
                                    <div class="modal fade" id="imagemodal{{ $key }}" tabindex="-1"
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <img src="{{ asset('storage/' . 'public/order/' . $img) }}"
                                                        class="initial--22 w-100">
                                                </div>
                                                <div class="modal-footer">
                                                    <a class="btn btn-primary"
                            ...
                            <a class="media align-items-center deco-none resturant--information-single"
                                ...
                                <div class="avatar avatar-circle">
                                    <img class="avatar-img w-75px onerror-image"
                                        ...
                                        src="{{ \App\CentralLogics\Helpers::onerror_image_helper($order->store->logo, asset('storage/store/') . '/' . $order->store->logo, asset('assets/admin/img/100x100/1.png'), 'store/') }}"
                                        alt="Image Description">
                                </div>
                                <div class="media-body">
                                    <span class="fz--14px text--title font-semibold text-hover-primary d-block">
                                ...
                                @if ($proof)
                                    ...
                                    @foreach ($proof as $key => $photo)
                                        <div class="spartan_item_wrapper min-w-100px max-w-100px">
                                            <img class="img--square" src="{{ asset("storage/order/$photo") }}"
                                                alt="order image">

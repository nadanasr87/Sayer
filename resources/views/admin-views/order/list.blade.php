    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row align-items-center">
                ...
                <div class="col-xl-2 col-md-3 col-sm-4 text-right">
                    <button class="btn btn-primary" onclick="goToNamedRoute()">مزامنة</button>
                </div>
            ...
            <script>
                function goToNamedRoute() {
                    var url = "{{ route('admin.order.syncWithNaql') }}";
        ...
        <div id="datatableFilterSidebar"
            ...
            <div class="card card-lg sidebar-card sidebar-footer-fixed">
                <div class="card-header">
                    ...
                    <!-- Toggle Button -->
                    <a class="js-hs-unfold-invoker_ btn btn-icon btn-xs btn-ghost-dark ml-2 filter-button-hide"
                        href="javascript:;">

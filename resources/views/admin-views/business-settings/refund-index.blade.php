                            ...
                            @foreach (json_decode($language) as $lang)
                                <div class="col-md-10 d-none lang_form1" id="{{ $lang }}-form1">
                                    ...
                                    <input id="reason{{ $lang }}" type="text" class="form-control h--45px"
                                        name="reason[]" placeholder="{{ translate('Ex:_Item_is_Broken') }}">
                                        ...
                                        <td>
                                            <div class="btn--container justify-content-center">
                                                ...
                                                <a class="btn btn-sm btn--danger btn-outline-danger action-btn form-alert"
                                                    href="javascript:" data-id="refund_reason-{{ $reason['id'] }}"
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel">
                                                        {{ translate('messages.Refund_Reason_Update') }}</label></h5>
                                                ...
                                                <form action="{{ route('admin.refund.reason_edit') }}" method="post">
                                                    <div class="modal-body">
                                                        ...
                                                        @php(
    $reason = \App\Models\RefundReason::withoutGlobalScope('translate')->with('translations')->find($reason->id),
)
                                                        @php($language = \App\Models\BusinessSetting::where('key', 'language')->first())
                                                        @php($language = $language->value ?? null)
                                                        @php($defaultLang = str_replace('_', '-', app()->getLocale()))

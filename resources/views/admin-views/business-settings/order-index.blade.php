                                    ...
                                    <div class="col-sm-6 col-lg-4">
                                        ...
                                        <div class="form-group mb-0">
                                            ...
                                            <label
                                                ...
                                                <input type="checkbox" data-id="prescription_order_status"
                                                    data-type="toggle"
                                                    ...
                                                    class="status toggle-switch-input dynamic-checkbox-toggle"
                                                    value="1" name="prescription_order_status"
                                                    id="prescription_order_status"
                                    ...
                                    <div class="col-sm-6 col-lg-4">
                                        ...
                                        <div class="form-group mb-0">
                                            <label
                                                ...
                                                <input type="checkbox" data-id="take_away" data-type="toggle"
                                                    ...
                                                    class="status toggle-switch-input dynamic-checkbox-toggle"
                                                    name="takeaway_status" value="1" id="take_away"
                                                    {{ $takeaway_status == 1 ? 'checked' : '' }}>
                                                <span class="toggle-switch-label text">
                                                    <span class="toggle-switch-indicator"></span>
                                                </span>
                                            </label>
                                        ...
                                        <div class="form-group mb-0">
                                            <label
                                                ...
                                                <input type="checkbox" data-id="schedule_order" data-type="toggle"
                                                    ...
                                                    class="status toggle-switch-input dynamic-checkbox-toggle"
                                                    value="1" name="schedule_order" id="schedule_order"
                                        ...
                                        <div class="form-group mb-0">
                                            ...
                                            <div class="d-flex">
                                                <input type="number" name="schedule_order_slot_duration"
                                                    class="form-control mr-3" id="schedule_order_slot_duration"
                                                    ...
                                                    min="0" required>
                                                <select name="schedule_order_slot_duration_time_format"
                                                    class="custom-select form-control w-90px">
                                                    <option value="min"
                                                        {{ $schedule_order_slot_duration_time_format?->value == 'min' ? 'selected' : '' }}>
                                                        {{ translate('Min') }}</option>
                                                    <option value="hour"
                                                        {{ $schedule_order_slot_duration_time_format?->value == 'hour' ? 'selected' : '' }}>
                                                ...
                                                <div class="modal fade" id="add_update_reason_{{ $reason->id }}"
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <form
                                                                action="{{ route('admin.business-settings.order-cancel-reasons.update') }}"
                                                                method="post">
                                                                <div class="modal-body">
                                                                    ...
                                                                    @php(
    $reason = \App\Models\OrderCancelReason::withoutGlobalScope('translate')->with('translations')->find($reason->id),
)
                                                                    @php($language = \App\Models\BusinessSetting::where('key', 'language')->first())
                                                                    @php($language = $language->value ?? null)
                                                                    @php($defaultLang = str_replace('_', '-', app()->getLocale()))
                                                                    ...
                                                                    <select name="user_type" class="form-control h--45px"
                                                                        ...
                                                                        <option
                                                                            {{ $reason->user_type == 'store' ? 'selected' : '' }}
                                                                            value="store">

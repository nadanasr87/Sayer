            ...
            <div class="row gx-2">
                <div class="col-lg-6">
                    <div class="card mb-3">
                        <div class="card-header card-header-shadow">
                            <h5 class="card-title d-flex align-items-center">
                                <img src="{{ asset('/assets/admin/img/wallet-icon.png') }}" alt=""
                    ...
                    <div class="card mb-3">
                        <div class="card-header card-header-shadow">
                            <h5 class="card-title d-flex align-items-center">
                                <img src="{{ asset('/assets/admin/img/referral.png') }}" alt=""
                                    class="card-header-icon align-self-center mr-1">
                                <span class="pr-2">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group mb-0">
                                        ...
                                        <input id="ref_earning_exchange_rate" type="number" class="form-control"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-0">
                                        ...
                                        <input id="item_purchase_point" type="number" class="form-control"
                                            name="item_purchase_point" step=".01"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-0">
                                        ...
                                        <input id="minimum_transfer_point" type="number" class="form-control"
                                            name="minimun_transfer_point" min="0"
                                ...
                                <div class="col-12">
                                    <div class="form-group mb-0">
                                        ...
                                        <input id="loyalty_point_exchange_rate" type="number" class="form-control"
                                            name="loyalty_point_exchange_rate"

...
@section('content')
    ...
    <div class="content container-fluid">
        ...
        <div class="card">
            ...
            <form id="theme_form" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-30">
                        <div class="__input-tab {{ $landing_integration_type == 'url' ? 'active' : '' }}" id="url">
                            <div class="__bg-F8F9FC-card">
                                <div class="form-group mb-0 pb-2">
                                    ...
                                    <input type="text"
                                        placeholder="{{ translate('messages.Ex: https://epulsecart.com/') }}"
                                        class="form-control h--45px" id="redirect_url" name="redirect_url"
                                        value="{{ $redirect_url }}">
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="col-6 col-md-4 col-xxl-3">
                                        <div class="card theme-card">
                                            <div class="card-body d-flex justify-content-between">
                                                ...
                                                <a class="btn action-btn btn--danger btn-outline-danger border-0 form-alert"
                                                    href="javascript:" data-id="index_page"
                                                    data-message="{{ translate('Want to delete this index_page ?') }}"
                                                    title="{{ translate('messages.delete_index_page') }}"><i
                        ...
                        <div class="__input-tab {{ $landing_integration_type == 'none' ? 'active' : '' }}"
                            id="none">
                            <div class="__bg-F8F9FC-card">

                                @if (isset($config) && $config)
                                    <div class="text-center max-w-595 mx-auto py-4">
                                        <img src="{{ asset('/assets/admin/img/landing-icon-2.png') }}" class="mb-3"
                                            alt="">
                                        <p class="m-0">
            ...
            <form action="{{ route('admin.business-settings.delete-custom-landing-page') }}" method="post"
                id="index_page">
                @csrf @method('delete')
            </form>
                            ...
                            <div class="item">
                                <div class="mb-20">
                                    <div class="text-center">
                                        <img src="{{ asset('/assets/admin/img/read-instructions.png') }}" alt=""
                                            class="mb-20">

                    ...
                    <div class="row">
                        <div class="col-xl-4 col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control text-break" id="method_name"
                                    placeholder="{{ translate('ex:_bkash') }}" name="method_name" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mb-2">
                        <div class="col-xl-4 col-sm-6">
                            ...
                            <div class="form-floating">
                                <textarea class="form-control" name="payment_note" id="payment_note" placeholder="{{ translate('Ex:ABC_Company') }}"
                                    disabled></textarea>
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="rounded p-4 mt-3 mt-4" id="offline_payment_bottom_part">
                        ...
                        <div class="d-flex flex-column gap-3">
                            <textarea name="payment_note" id="payment_note" class="form-control" readonly rows="10" placeholder="Note"></textarea>
                        </div>
                    </div>
                </div>
            </div>

        ...
        <form action="{{ route('admin.business-settings.offline.update') }}" method="POST">
            ...
            <div class="card mt-3">
                <div class="card-header gap-2 flex-wrap">
                    ...
                    <a href="javascript:" class="btn btn--primary add-input-fields-group"><i class="tio-add"></i>
                        {{ translate('Add_New_Field') }} </a>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-xl-4 col-sm-6">
                            <div class="form-group">
                                ...
                                <input id="method_name" type="text" class="form-control"
                            ...
                            <div class="row align-items-end" id="{{ $aRandomNumber }}">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input id="input_name" type="text" name="input_name[]" class="form-control"
                                            placeholder="{{ translate('ex') }}: {{ translate('Bank_Name') }}" required
                                            value="{{ ucwords(str_replace('_', ' ', $item['input_name'])) }} ">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="input_data" class="title_color">{{ translate('Data') }}</label>
                                        <input id="input_data" type="text" name="input_data[]" class="form-control"
                                            placeholder="{{ translate('ex') }}: {{ translate('ABC_bank') }}" required
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="d-flex justify-content-end">
                                            <a href="javascript:"
                                                class="btn action-btn btn--danger btn-outline-danger remove-input-fields-group"
                                                data-id="{{ $aRandomNumber }}" title="Delete">
            ...
            <div class="card mt-3">
                <div class="card-header gap-2 flex-wrap">
                    ...
                    <a href="javascript:" class="btn btn--primary add-customer-input-fields-group"><i class="tio-add"></i>
                        {{ translate('Add_New_Field') }} </a>
                </div>
                <div class="card-body">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="customer_input"
                                            class="title_color">{{ translate('input_field_Name') }}</label>
                                        <input id="customer_input" type="text" name="customer_input[]"
                                            class="form-control"
                                            placeholder="{{ translate('ex') }}: {{ translate('payment_By') }}" required
                                            value="{{ ucwords(str_replace('_', ' ', $item['customer_input'])) }}">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input id="customer_placeholder" type="text" name="customer_placeholder[]"
                                            class="form-control"
                                            ...
                                            <div class="form-check text-start mb-3">
                                                ...
                                                <label class="form-check-label text-dark" for="{{ $cRandomNumber + 1 }}">
                                                    <input type="checkbox" class="form-check-input"
                                                        id="{{ $cRandomNumber + 1 }}" name="is_required[]"
                                                        {{ (isset($item['is_required']) && $item['is_required']) == 1 ? 'checked' : '' }}>
                                                    {{ translate('is_Required') }} ?
                                                </label>
                                            </div>

                                            <a class="btn action-btn btn--danger btn-outline-danger  remove-input-fields-group"
                                                data-id="{{ $cRandomNumber }}" title="Delete">
                                                <i class="tio-delete-outlined"></i>
                                            </a>
                                        </div>
                                    </div>

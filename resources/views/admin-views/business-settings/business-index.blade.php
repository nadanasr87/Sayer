...
@section('content')
    <div class="content container-fluid">
        ...
        <form action="{{ route('admin.business-settings.update-tawseel-setup') }}" method="post"
            ...
            <div class="row g-3">
                <div class="col-lg-12">
                    <h4 class="card-title mb-3 mt-1">
                        ...
                        <span>{{ translate('Company Information in tawseel') }}</span>
                    </h4>
                    <div class="card">
                        <div class="card-body">
                            <div class="row g-3">
                                <div class="col-sm-6 col-md-4 col-xl-3">
                                    <div class="form-group mb-0">
                                        ...
                                        <input id="store_name" type="text" name="responsibleName"
                                            value="{{ $Tawseeldata['responsibleName'] ?? '' }}" class="form-control"
                                ...
                                <div class="col-sm-6 col-md-4 col-xl-3">
                                    <div class="form-group mb-0">
                                        ...
                                        <input id="email" type="email"
                                            value="{{ $Tawseeldata['responsibleEmail'] ?? '' }}" name="responsibleEmail"
                                            class="form-control"
                                ...
                                <div class="col-sm-6 col-md-4 col-xl-3">
                                    <div class="form-group mb-0">
                                        ...
                                        <input type="tel" value="{{ $Tawseeldata['responsibleMobileNumber'] ?? '' }}"
                                            id="phone" name="responsibleMobileNumber" class="form-control"
                            ...
                            <div class="row g-3">
                                <div class="col-sm-6 col-md-4 col-xl-3">
                                    <div class="form-group mb-0">
                                        <label class="form-label" for="store_name">{{ 'technical Name' }}</label>
                                        <input id="store_name" type="text" name="technicalName"
                                            value="{{ $Tawseeldata['technicalName'] ?? '' }}" class="form-control"
                                            placeholder="{{ translate('messages.new_company') }}" required>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-md-4 col-xl-3">
                                    <div class="form-group mb-0">
                                        <label class="form-label" for="email">{{ 'technical Email' }}</label>
                                        <input id="email" type="email"
                                            value="{{ $Tawseeldata['technicalEmail'] ?? '' }}" name="technicalEmail"
                                            class="form-control"
                                            placeholder="{{ translate('messages.Ex_:_ex@example.com') }}" required>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-md-4 col-xl-3">
                                    <div class="form-group mb-0">
                                        <label class="form-label" for="phone">{{ 'technical Mobile Number' }}</label>
                                        <input type="tel" value="{{ $Tawseeldata['technicalMobileNumber'] ?? '' }}"
                                            id="phone" name="technicalMobileNumber" class="form-control"
                                            placeholder="{{ translate('messages.Ex: +3264124565') }}" required>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <label class="__custom-upload-img mr-lg-5">
                                            ...
                                            <div class="text-center">
                                                <img class="img--vertical onerror-image" id="viewer"
                                                    ...
                                                    src="{{ \App\CentralLogics\Helpers::onerror_image_helper($logo, asset('storage/business/') . '/' . $logo, asset('assets/admin/img/upload-img.png'), 'business/') }}"
                                                    alt="logo image" />
                                            </div>
                                        ...
                                        <label class="__custom-upload-img">
                                            ...
                                            <div class="text-center">
                                                <img class="img--110 onerror-image" id="iconViewer"
                                                    data-onerror-image="{{ asset('assets/admin/img/upload-img.png') }}"
                                                    src="{{ \App\CentralLogics\Helpers::onerror_image_helper($icon, asset('storage/business/') . '/' . $icon, asset('assets/admin/img/upload-img.png'), 'business/') }}"
                                                    alt="Fav icon" />
                                            </div>
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    ...
                                    <div class="form-group mb-0">
                                        <label
                                            ...
                                            <span class="pr-1 d-flex align-items-center"><span
                                                    class="line--limit-1">{{ translate('Include_TAX_Amount') }}</span>
                                                <span class="form-label-secondary" data-toggle="tooltip"
                                                    data-placement="right"
                                                    data-original-title="{{ translate('messages.If_enabled,_the_customer_will_see_the_total_product_price,_including_VAT/Tax._If_it’s_disabled,_the_VAT/Tax_will_be_added_separately_with_the_total_cost_of_the_product.') }}">
                                                    <img src="{{ asset('assets/admin/img/info-circle.svg') }}"
                                                        alt="">
                                                </span>
                                            </span>
                                            <input type="checkbox" data-id="tax_included" data-type="toggle"
                                                ...
                                                name="tax_included" id="tax_included"
                                        ...
                                        <div class="resturant-type-group border">
                                            <label class="form-check form--check mr-2 mr-md-4">
                                                <input class="form-check-input" type="radio" value="firebase"
                                                    ...
                                                    {{ $order_notification_type ? ($order_notification_type->value == 'firebase' ? 'checked' : '') : '' }}>
                                                <span class="form-check-label">
                                                    {{ translate('firebase') }}
                                                </span>
                                            </label>
                                            <label class="form-check form--check mr-2 mr-md-4">
                                                <input class="form-check-input" type="radio" value="manual"
                                                    name="order_notification_type"
                                                    {{ $order_notification_type ? ($order_notification_type->value == 'manual' ? 'checked' : '') : '' }}>
                                                <span class="form-check-label">
                                                    {{ translate('manual') }}
                                                </span>
                                            </label>
                                ...
                                <div class="col-sm-6 col-lg-4">
                                    ...
                                    <div class="form-group mb-0">
                                        ...
                                        <input type="number" name="additional_charge" class="form-control"
                                            ...
                                            min="0" step=".01"
                                            {{ isset($additional_charge_status) ? '' : 'readonly' }}>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-lg-4">
                                    ...
                                    <div class="form-group mb-0">
                                        <label
                                            ...
                                            <input type="checkbox" data-id="guest_checkout_status" data-type="toggle"
                                                ...
                                                class="status toggle-switch-input dynamic-checkbox-toggle"
                                                value="1" name="guest_checkout_status" id="guest_checkout_status"

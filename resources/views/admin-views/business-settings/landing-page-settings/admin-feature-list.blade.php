                        ...
                        <div class="card-body">
                            ...
                            @if ($language)
                                <div class="row g-3 lang_form default-form">
                                    ...
                                    <div class="col-sm-6">
                                        <label for="feature_short_description"
                                            class="form-label">{{ translate('Short Description') }}
                                            ({{ translate('messages.default') }})<span class="form-label-secondary"
                                                data-toggle="tooltip" data-placement="right"
                                                data-original-title="{{ translate('Write_the_title_within_240_characters') }}">
                                                <img src="{{ asset('assets/admin/img/info-circle.svg') }}" alt="">
                                            </span></label>
                                        <input id="feature_short_description" type="text" maxlength="240"
                                ...
                                @foreach (json_decode($language) as $lang)
                                    ...
                                    <div class="row g-3 d-none lang_form" id="{{ $lang }}-form">
                                        <div class="col-sm-6">
                                            ...
                                            <input id="feature_title{{ $lang }}" type="text" maxlength="80"
                                                name="feature_title[]"
                                        ...
                                        <div class="col-sm-6">
                                            <label for="feature_short_description{{ $lang }}"
                                                class="form-label">{{ translate('Short Description') }}
                                            ...
                                            <input type="text" id="feature_short_description{{ $lang }}"
                                                maxlength="240" name="feature_short_description[]"
                            ...
                            @else
                                <div class="row g-3">
                                    ...
                                    <div class="col-sm-6">
                                        <label for="feature_short_description"
                                            class="form-label">{{ translate('Short Description') }}<span
                                                class="form-label-secondary" data-toggle="tooltip" data-placement="right"
                                                data-original-title="{{ translate('Write_the_title_within_240_characters') }}">
                                                <img src="{{ asset('assets/admin/img/info-circle.svg') }}"
                                                    alt="">
                                        ...
                                        <input id="feature_short_description" type="text" maxlength="240"
                                            name="feature_short_description[]" class="form-control"
                                            placeholder="{{ translate('Ex_:_Jam-packed_with_outstanding_features…') }}">
                                    </div>
                                </div>
                                <input type="hidden" name="lang[]" value="default">
                                        ...
                                        <div class="col-md-6 d-none lang_form" id="{{ $lang }}-form1">
                                            <div class="row g-3">
                                                <div class="col-12">
                                                    ...
                                                    <input id="title{{ $lang }}" type="text" maxlength="20"
                                                        name="title[]" class="form-control"
                                                        placeholder="{{ translate('Ex_:_Shopping') }}">
                                                </div>
                                                <div class="col-12">
                                                    <label for="sub_title{{ $lang }}"
                                                    ...
                                                    <input id="sub_title{{ $lang }}" type="text"
                                                        maxlength="80" name="sub_title[]" class="form-control"
                                                        placeholder="{{ translate('Ex_:_Best_shopping_experience') }}">
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="row g-3">
                                            <div class="col-12">
                                                ...
                                                <input id="title" type="text" maxlength="50" name="title[]"
                                                    class="form-control" placeholder="{{ translate('Ex_:_Shopping') }}">
                                            </div>
                                            <div class="col-12">
                                                <label for="sub_title"
                                ...
                                <div class="col-md-6">
                                    <label class="form-label d-block mb-2">
                                        {{ translate('messages.Image') }} <span
                                            class="text--primary">{{ translate('(size:_1:1)') }}</span>
                                    </label>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <img src="{{ \App\CentralLogics\Helpers::onerror_image_helper(
                                                    $feature->image ?? '',
                                                    asset('storage/admin_feature') . '/' . $feature->image ?? '',
                                                    asset('/assets/admin/img/upload-3.png'),
                                                    'admin_feature/',
                                                ) }}"
                                                    class="__size-105 onerror-image"
                                                    data-onerror-image="{{ asset('/assets/admin/img/upload-3.png') }}"
                                                    alt="image">
                                            </td>
                                            <td>
                                                <label class="toggle-switch toggle-switch-sm">
                                                    <input type="checkbox" data-id="status-{{ $feature->id }}"
                                                        data-type="toggle"
                                            ...
                                            <td>
                                                <div class="btn--container justify-content-center">
                                                    ...
                                                    <a class="btn action-btn btn--danger btn-outline-danger form-alert"
                                                        href="javascript:" data-id="banner-{{ $feature['id'] }}"
                                                        data-message="{{ translate('Want to delete this banner ?') }}"
                                                        title="{{ translate('messages.delete_banner') }}"><i
                                                            class="tio-delete-outlined"></i>
                                                    </a>
                                                    <form
                                                        action="{{ route('admin.business-settings.feature-delete', [$feature['id']]) }}"

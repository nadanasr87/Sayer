    ...
    <div class="content container-fluid">
        ...
        <div class="tab-content">
            <div class="tab-pane fade show active">
                ...
                @php(
    $download_user_app_links = \App\Models\DataSetting::withoutGlobalScope('translate')->where(['key' => 'download_user_app_links', 'type' => 'flutter_landing_page'])->first(),
)
                @php($download_user_app_links = isset($download_user_app_links->value) ? json_decode($download_user_app_links->value, true) : null)
                <form action="{{ route('admin.business-settings.flutter-landing-page-settings', 'download-app-section') }}"
                                        ...
                                        <div class="col-md-12 lang_form default-form">
                                            <div class="row g-3">
                                                <div class="col-12">
                                                    ...
                                                    <input id="download_user_app_title" type="text" maxlength="40"
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <input id="download_user_app_sub_title" type="text" maxlength="20"
                                                ...
                                                <div class="row g-3">
                                                    <div class="col-12">
                                                        ...
                                                        <input id="download_user_app_title{{ $lang }}"
                                                            type="text" maxlength="40" name="download_user_app_title[]"
                                        ...
                                        <div class="position-relative">
                                            <div class="img">
                                                <img src="{{ \App\CentralLogics\Helpers::onerror_image_helper(
                                                    ...
                                                    alt="" class="vertical-img mw-100 vertical onerror-image">
                                            </div>

    ...
    <div class="content container-fluid">
        ...
        <div class="tab-content">
            <div class="tab-pane fade show active">
                <form action="{{ route('admin.business-settings.react-landing-page-settings', 'fixed-banner') }}"
                    method="POST" enctype="multipart/form-data">
                    @csrf
                    <h5 class="card-title mt-3 mb-3">
                        <span class="card-header-icon mr-2"><i class="tio-settings-outlined"></i></span>
                        <span>{{ translate('promotional_Banner') }}</span>
                    </h5>
                    <div class="card mb-3">
                        <div class="card-body">
                                ...
                                <div class="col-md-7">
                                    <label class="form-label d-block mb-2">
                                        {{ translate('Banner') }} <span
                                            class="text--primary">{{ translate('(size: 2:1)') }}</span>
                                    </label>
                                        ...
                                        <div class="position-relative">
                                            <div class="img">
                                                <img src="{{ \App\CentralLogics\Helpers::onerror_image_helper(
                                                    ...
                                                    asset('storage/promotional_banner') . '/' . $fixed_promotional_banner['value'] ?? '',
                                            ...
                                            @if (isset($fixed_promotional_banner['value']))
                                                <span id="promotional_banner" class="remove_image_button remove-image"
                                                    data-id="promotional_banner" data-title="{{ translate('Warning!') }}"
                ...
                <form action="{{ route('admin.business-settings.react-landing-page-settings', 'fixed-newsletter') }}"
                    method="POST" enctype="multipart/form-data">
                    @csrf
                    <h5 class="card-title mb-3">
                        <span class="card-header-icon mr-2"><i class="tio-settings-outlined"></i></span>
                        <span>{{ translate('Newsletter Section Content ') }}</span>
                    </h5>
                    <div class="card mb-3">
                        <div class="card-body">
                            ...
                            @if ($language)
                                <div class="row g-3 lang_form default-form">
                                    <div class="col-sm-6">
                                        <label for="fixed_newsletter_title" class="form-label">{{ translate('Title') }}
                                        ...
                                        <input id="fixed_newsletter_title" type="text" maxlength="30"
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input id="fixed_newsletter_sub_title" type="text" maxlength="100"
                                    ...
                                    <div class="row g-3 d-none lang_form" id="{{ $lang }}-form">
                                        <div class="col-sm-6">
                                            ...
                                            <input id="fixed_newsletter_title{{ $lang }}" type="text"
                                                maxlength="30" name="fixed_newsletter_title[]" class="form-control"
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <input id="fixed_newsletter_sub_title{{ $lang }}" type="text"
                                                maxlength="100" name="fixed_newsletter_sub_title[]" class="form-control"
                            ...
                            @else
                                <div class="row g-3">
                                    <div class="col-sm-6">
                                        ...
                                        <input id="fixed_newsletter_title" type="text" name="fixed_newsletter_title[]"
                                            class="form-control" placeholder="{{ translate('messages.title_here...') }}">
                                    </div>
                                    <div class="col-sm-6">
                                        <label for="fixed_newsletter_sub_title"
                                            class="form-label">{{ translate('Sub Title') }}</label>
                                        <input id="fixed_newsletter_sub_title" type="text"
                                            name="fixed_newsletter_sub_title[]" class="form-control"
                                            placeholder="{{ translate('messages.sub_title_here...') }}">
                                    </div>
                                </div>
                ...
                <form action="{{ route('admin.business-settings.react-landing-page-settings', 'fixed-footer') }}"
                    method="POST" enctype="multipart/form-data">
                    @csrf
                    <h5 class="card-title mb-3">
                        <span class="card-header-icon mr-2"><i class="tio-settings-outlined"></i></span>
                        <span>{{ translate('Footer_Content') }}</span>
                    </h5>
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row g-3">
                                <div class="col-12">
                                    @if ($language)
                                        <div class="row g-3 lang_form default-form">
                                            <div class="col-12">
                                                <label for="fixed_footer_description"
                                                    class="form-label">{{ translate('short_Description') }}
                                                ...
                                                <input id="fixed_footer_description" type="text" maxlength="120"
                                                    name="fixed_footer_description[]" class="form-control"
                                        ...
                                        @foreach (json_decode($language) as $lang)
                                            ...
                                            <div class="row g-3 d-none lang_form" id="{{ $lang }}-form1">
                                                <div class="col-12">
                                                    <label for="fixed_footer_description{{ $lang }}"
                                                        class="form-label">{{ translate('short_Description') }}
                                                        ({{ strtoupper($lang) }})
                                                        <span class="form-label-secondary" data-toggle="tooltip"
                                                            data-placement="right"
                                                    ...
                                                    <input id="fixed_footer_description{{ $lang }}"
                                                        type="text" maxlength="120" name="fixed_footer_description[]"
                                                        class="form-control"
                                                        value="{{ $fixed_footer_description_translate[$lang]['value'] ?? '' }}"
                                                        placeholder="{{ translate('messages.title_here...') }}">
                                                </div>
                                            </div>
                                            <input type="hidden" name="lang[]" value="{{ $lang }}">
                                    ...
                                    @else
                                        <div class="row g-3">
                                            <div class="col-12">
                                                <label for="fixed_footer_description"
                                                    class="form-label">{{ translate('short_Description') }}</label>
                                                <input id="fixed_footer_description" type="text"
                                                    name="fixed_footer_description[]" class="form-control"
                                                    placeholder="{{ translate('messages.title_here...') }}">
                                            </div>
                                        </div>

    ...
    <div class="content container-fluid">
        ...
        <div class="tab-content">
            <div class="tab-pane fade show active">
                <form action="{{ route('admin.business-settings.admin-landing-page-settings', 'fixed-data') }}"
                    method="POST">
                    @csrf
                    @if ($language)
                        <div class="lang_form" id="default-form">
                            <h5 class="card-title mb-3">
                                ...
                                <span>{{ translate('messages.header_section') }}
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row g-3">
                                        <div class="col-sm-6">
                                            <label for="fixed_header_title" class="form-label">{{ translate('Title') }}<span
                                            ...
                                            <input id="fixed_header_title" type="text" maxlength="50"
                                                name="fixed_header_title[]"
                                                value="{{ $fixed_header_title?->getRawOriginal('value') }}"
                                                class="form-control"
                                                placeholder="{{ translate('Ex_:_Manage_your_daily_life_on_one_platform') }}">
                                        </div>
                                        <div class="col-sm-6">
                                            <label for="fixed_header_sub_title"
                                                class="form-label">{{ translate('Sub Title') }}<span
                                                    class="form-label-secondary" data-toggle="tooltip"
                                                    data-placement="right"
                                                    data-original-title="{{ translate('Write_the_sub_title_within_100_characters') }}">
                                                    <img src="{{ asset('assets/admin/img/info-circle.svg') }}"
                                                        alt="">
                                                </span></label>
                                            <input id="fixed_header_sub_title" type="text" maxlength="100"
                                                name="fixed_header_sub_title[]"
                                                value="{{ $fixed_header_sub_title?->getRawOriginal('value') }}"
                                                class="form-control"
                                                placeholder="{{ translate('Ex_:_More_than_just_a_reliable_eCommerce_platform') }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <h5 class="card-title mb-3 mt-3">
                                <span class="card-header-icon mr-2"><i class="tio-calendar"></i></span>
                                <span>{{ translate('messages.module_list_section') }}
                                    ({{ translate('messages.default') }})</span>
                            </h5>
                            <div class="card">
                                <div class="card-body">
                                    <div class="row g-3">
                                        <div class="col-sm-6">
                                            ...
                                            <input id="fixed_module_title" type="text" maxlength="50"
                                                name="fixed_module_title[]"
                                                value="{{ $fixed_module_title?->getRawOriginal('value') }}"
                                                class="form-control"
                                                placeholder="{{ translate('Ex_:_Your_eCommerce_venture_starts_here') }}">
                                        </div>
                                        <div class="col-sm-6">
                                            <label for="fixed_module_sub_title"
                                                class="form-label">{{ translate('Sub Title') }}<span
                                                    class="form-label-secondary" data-toggle="tooltip"
                                                    data-placement="right"
                                                    data-original-title="{{ translate('Write_the_sub_title_within_100_characters') }}">
                                            ...
                                            <input id="fixed_module_sub_title" type="text" maxlength="100"
                                                name="fixed_module_sub_title[]"
                                                value="{{ $fixed_module_sub_title?->getRawOriginal('value') }}"
                                                class="form-control"
                                                placeholder="{{ translate('Ex_:_Enjoy_all_services_in_one_platform') }}">
                                        </div>
                                    </div>
                            ...
                            <h5 class="card-title mb-3 mt-3">
                                <span class="card-header-icon mr-2"><i class="tio-calendar"></i></span>
                                <span>{{ translate('Referral & Earning') }} ({{ translate('messages.default') }})</span>
                            </h5>
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-sm-6">
                                            ...
                                            <input id="fixed_referal_title" type="text" maxlength="40"
                                                name="fixed_referal_title[]"
                                                value="{{ $fixed_referal_title?->getRawOriginal('value') }}"
                                                class="form-control" placeholder="{{ translate('Ex_:_Earn_Point') }}">
                                        </div>
                                        <div class="col-sm-6">
                                            <label for="fixed_referal_sub_title"
                                                class="form-label">{{ translate('Sub Title') }}<span
                                                    class="form-label-secondary" data-toggle="tooltip"
                                                    data-placement="right"
                                                    data-original-title="{{ translate('Write_the_sub_title_within_80_characters') }}">
                                                    <img src="{{ asset('assets/admin/img/info-circle.svg') }}"
                                                        alt="">
                                                </span></label>
                                            <input id="fixed_referal_sub_title" type="text" maxlength="80"
                                                name="fixed_referal_sub_title[]"
                                                value="{{ $fixed_referal_sub_title?->getRawOriginal('value') }}"
                                                class="form-control"
                                                placeholder="{{ translate('Ex_:_By_referring_your_friend') }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <h5 class="card-title mb-3 mt-3">
                                <span class="card-header-icon mr-2"><i class="tio-calendar"></i></span>
                                <span>{{ translate('newsletter') }} ({{ translate('messages.default') }})</span>
                            </h5>
                            <div class="card">
                                <div class="card-body">
                                    <div class="row g-3">
                                        <div class="col-sm-6">
                                            <label for="fixed_newsletter_title"
                                                class="form-label">{{ translate('Title') }}<span
                                                    class="form-label-secondary" data-toggle="tooltip"
                                                    data-placement="right"
                                                    data-original-title="{{ translate('Write_the_title_within_40_characters') }}">
                                            ...
                                            <input id="fixed_newsletter_title" type="text" maxlength="40"
                                                name="fixed_newsletter_title[]"
                                                value="{{ $fixed_newsletter_title?->getRawOriginal('value') }}"
                                                class="form-control"
                                                placeholder="{{ translate('Ex_:_Sign_Up_to_Our_Newsletter') }}">
                                        </div>
                                        <div class="col-sm-6">
                                            <label for="fixed_newsletter_sub_title"
                                                class="form-label">{{ translate('Sub Title') }}<span
                                                    class="form-label-secondary" data-toggle="tooltip"
                                                    data-placement="right"
                                                    data-original-title="{{ translate('Write_the_sub_title_within_80_characters') }}">
                                            ...
                                            <input id="fixed_newsletter_sub_title" type="text" maxlength="80"
                                                name="fixed_newsletter_sub_title[]"
                                                value="{{ $fixed_newsletter_sub_title?->getRawOriginal('value') }}"
                                                class="form-control"
                                                placeholder="{{ translate('Ex_:_Receive_Latest_News,_Updates_and_Many_Other_News_Every_Week') }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <h5 class="card-title mb-3 mt-3">
                                <span class="card-header-icon mr-2"><i class="tio-calendar"></i></span>
                                <span>{{ translate('Footer_Article') }} ({{ translate('messages.default') }})</span>
                            </h5>
                            <div class="card">
                                <div class="card-body">
                                    <div class="row g-3">
                                        <div class="col-12">
                                            <label for="fixed_footer_article_title"
                                                class="form-label">{{ translate('Title') }}<span
                                                    class="form-label-secondary" data-toggle="tooltip"
                                                    data-placement="right"
                                                    data-original-title="{{ translate('Write_the_title_within_180_characters') }}">
                                                    <img src="{{ asset('assets/admin/img/info-circle.svg') }}"
                                                        alt="">
                                                </span></label>
                                            <input id="fixed_footer_article_title" type="text" maxlength="180"
                                                name="fixed_footer_article_title[]"
                                                value="{{ $fixed_footer_article_title?->getRawOriginal('value') }}"
                                                class="form-control"
                                                placeholder="{{ translate('Ex_:_6amMart_is_a_complete_package!__It`s_time_to_empower_your_multivendor_online_business_with__powerful_features!') }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        @foreach (json_decode($language) as $lang)
                            ...
                            <div class="d-none lang_form" id="{{ $lang }}-form">
                                <h5 class="card-title mb-3">
                                    <span class="card-header-icon mr-2"><i class="tio-calendar"></i></span>
                                    <span>{{ translate('messages.header_section') }} ({{ strtoupper($lang) }})</span>
                                </h5>
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row g-3">
                                            <div class="col-sm-6">
                                                <label for="fixed_header_title{{ $lang }}"
                                                    class="form-label">{{ translate('Title') }}<span
                                                        class="form-label-secondary" data-toggle="tooltip"
                                                        data-placement="right"
                                                        data-original-title="{{ translate('Write_the_title_within_50_characters') }}">
                                                ...
                                                <input id="fixed_header_title{{ $lang }}" type="text"
                                                    maxlength="50" name="fixed_header_title[]"
                                                    value="{{ $fixed_header_title_translate[$lang]['value'] ?? '' }}"
                                                    class="form-control"
                                                    placeholder="{{ translate('Ex_:_Manage_your_daily_life_on_one_platform') }}">
                                            </div>
                                            <div class="col-sm-6">
                                                <label for="fixed_header_sub_title{{ $lang }}"
                                                    class="form-label">{{ translate('Sub Title') }}<span
                                                        class="form-label-secondary" data-toggle="tooltip"
                                                        data-placement="right"
                                                        data-original-title="{{ translate('Write_the_sub_title_within_100_characters') }}">
                                                ...
                                                <input id="fixed_header_sub_title{{ $lang }}" type="text"
                                                    maxlength="100" name="fixed_header_sub_title[]"
                                                    value="{{ $fixed_header_sub_title_translate[$lang]['value'] ?? '' }}"
                                                    class="form-control"
                                                    placeholder="{{ translate('Ex_:_More_than_just_a_reliable_eCommerce_platform') }}">
                                            </div>
                                        </div>
                                ...
                                <h5 class="card-title mb-3 mt-3">
                                    <span class="card-header-icon mr-2"><i class="tio-calendar"></i></span>
                                    <span>{{ translate('messages.module_list_section') }} ({{ strtoupper($lang) }})</span>
                                </h5>
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row g-3">
                                            <div class="col-sm-6">
                                                <label for="fixed_module_title{{ $lang }}"
                                                    class="form-label">{{ translate('Title') }}<span
                                                        class="form-label-secondary" data-toggle="tooltip"
                                                        data-placement="right"
                                                        data-original-title="{{ translate('Write_the_title_within_50_characters') }}">
                                                ...
                                                <input id="fixed_module_title{{ $lang }}" type="text"
                                                    maxlength="50" name="fixed_module_title[]"
                                                    value="{{ $fixed_module_title_translate[$lang]['value'] ?? '' }}"
                                                    class="form-control"
                                                    placeholder="{{ translate('Ex_:_Your_eCommerce_venture_starts_here') }}">
                                            </div>
                                            <div class="col-sm-6">
                                                <label for="fixed_module_sub_title{{ $lang }}"
                                                    class="form-label">{{ translate('Sub Title') }}<span
                                                        class="form-label-secondary" data-toggle="tooltip"
                                                        data-placement="right"
                                                        data-original-title="{{ translate('Write_the_sub_title_within_100_characters') }}">
                                                ...
                                                <input id="fixed_module_sub_title{{ $lang }}" type="text"
                                                    maxlength="100" name="fixed_module_sub_title[]"
                                                    value="{{ $fixed_module_sub_title_translate[$lang]['value'] ?? '' }}"
                                                    class="form-control"
                                                    placeholder="{{ translate('Ex_:_Enjoy_all_services_in_one_platform') }}">
                                            </div>
                                        </div>
                                ...
                                <h5 class="card-title mb-3 mt-3">
                                    <span class="card-header-icon mr-2"><i class="tio-calendar"></i></span>
                                    <span>{{ translate('Referral & Earning') }} ({{ strtoupper($lang) }})</span>
                                </h5>
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row g-3">
                                            <div class="col-sm-6">
                                                <label for="fixed_referal_title{{ $lang }}"
                                                    class="form-label">{{ translate('Title') }}<span
                                                        class="form-label-secondary" data-toggle="tooltip"
                                                        data-placement="right"
                                                        data-original-title="{{ translate('Write_the_title_within_40_characters') }}">
                                                ...
                                                <input id="fixed_referal_title{{ $lang }}" type="text"
                                                    maxlength="40" name="fixed_referal_title[]"
                                                    value="{{ $fixed_referal_title_translate[$lang]['value'] ?? '' }}"
                                                    class="form-control"
                                                    placeholder="{{ translate('Ex_:_Earn_Point') }}">
                                            </div>
                                            <div class="col-sm-6">
                                                <label for="fixed_referal_sub_title{{ $lang }}"
                                                    class="form-label">{{ translate('Sub Title') }}<span
                                                        class="form-label-secondary" data-toggle="tooltip"
                                                        data-placement="right"
                                                        data-original-title="{{ translate('Write_the_sub_title_within_80_characters') }}">
                                                ...
                                                <input id="fixed_referal_sub_title{{ $lang }}" type="text"
                                                    maxlength="80" name="fixed_referal_sub_title[]"
                                                    value="{{ $fixed_referal_sub_title_translate[$lang]['value'] ?? '' }}"
                                                    class="form-control"
                                                    placeholder="{{ translate('Ex_:_By_referring_your_friend') }}">
                                            </div>
                                        </div>
                                ...
                                <h5 class="card-title mb-3 mt-3">
                                    <span class="card-header-icon mr-2"><i class="tio-calendar"></i></span>
                                    <span>{{ translate('newsletter') }} ({{ strtoupper($lang) }})</span>
                                </h5>
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row g-3">
                                            <div class="col-sm-6">
                                                <label for="fixed_newsletter_title{{ $lang }}"
                                                    class="form-label">{{ translate('Title') }}<span
                                                        class="form-label-secondary" data-toggle="tooltip"
                                                        data-placement="right"
                                                        data-original-title="{{ translate('Write_the_title_within_40_characters') }}">
                                                ...
                                                <input id="fixed_newsletter_title{{ $lang }}" type="text"
                                                    maxlength="40" name="fixed_newsletter_title[]"
                                                    value="{{ $fixed_newsletter_title_translate[$lang]['value'] ?? '' }}"
                                                    class="form-control"
                                                    placeholder="{{ translate('Ex_:_Sign_Up_to_Our_Newsletter') }}">
                                            </div>
                                            <div class="col-sm-6">
                                                <label for="fixed_newsletter_sub_title{{ $lang }}"
                                                    class="form-label">{{ translate('Sub Title') }}<span
                                                        class="form-label-secondary" data-toggle="tooltip"
                                                        data-placement="right"
                                                        data-original-title="{{ translate('Write_the_sub_title_within_80_characters') }}">
                                                ...
                                                <input id="fixed_newsletter_sub_title{{ $lang }}" type="text"
                                                    maxlength="80" name="fixed_newsletter_sub_title[]"
                                                    value="{{ $fixed_newsletter_sub_title_translate[$lang]['value'] ?? '' }}"
                                                    class="form-control"
                                                    placeholder="{{ translate('Ex_:_Receive_Latest_News,_Updates_and_Many_Other_News_Every_Week') }}">
                                            </div>
                                        </div>
                                ...
                                <h5 class="card-title mb-3 mt-3">
                                    <span class="card-header-icon mr-2"><i class="tio-calendar"></i></span>
                                    <span>{{ translate('Footer_Article') }} ({{ strtoupper($lang) }})</span>
                                </h5>
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row g-3">
                                            <div class="col-12">
                                                <label for="fixed_footer_article_title{{ $lang }}"
                                                    class="form-label">{{ translate('Title') }}<span
                                                        class="form-label-secondary" data-toggle="tooltip"
                                                        data-placement="right"
                                                        data-original-title="{{ translate('Write_the_title_within_180_characters') }}">
                                                ...
                                                <input id="fixed_footer_article_title{{ $lang }}" type="text"
                                                    maxlength="180" name="fixed_footer_article_title[]"
                                                    value="{{ $fixed_footer_article_title_translate[$lang]['value'] ?? '' }}"
                                                    class="form-control"
                                                    placeholder="{{ translate('Ex_:_6amMart_is_a_complete_package!__It`s_time_to_empower_your_multivendor_online_business_with__powerful_features!') }}">
                                            </div>
                                        </div>
                    ...
                    @else
                        <div>
                                ...
                                <div class="card-body">
                                    <div class="row g-3">
                                        <div class="col-sm-6">
                                            ...
                                            <input id="fixed_header_title" type="text" maxlength="50"
                                                name="fixed_header_title[]" class="form-control"
                                                placeholder="{{ translate('Ex_:_Manage_your_daily_life_on_one_platform') }}">
                                        </div>
                                        <div class="col-sm-6">
                                            <label for="fixed_header_sub_title"
                                                class="form-label">{{ translate('Sub Title') }}<span
                                                    class="form-label-secondary" data-toggle="tooltip"
                                                    data-placement="right"
                                                    data-original-title="{{ translate('Write_the_sub_title_within_50_characters') }}">
                                                    <img src="{{ asset('assets/admin/img/info-circle.svg') }}"
                                                        alt="">
                                                </span></label>
                                            <input id="fixed_header_sub_title" type="text" maxlength="50"
                                                name="fixed_header_sub_title[]" class="form-control"
                                                placeholder="{{ translate('Ex_:_More_than_just_a_reliable_eCommerce_platform') }}">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <h5 class="card-title mb-3 mt-3">
                                <span class="card-header-icon mr-2"><i class="tio-calendar"></i></span>
                                <span>{{ translate('messages.module_list_section') }}</span>
                            </h5>
                            <div class="card">
                                <div class="card-body">
                                    <div class="row g-3">
                                        <div class="col-sm-6">
                                            ...
                                            <input id="fixed_module_title" type="text" maxlength="50"
                                                name="fixed_module_title[]" class="form-control"
                                                placeholder="{{ translate('Ex_:_Your_eCommerce_venture_starts_here') }}">
                                        </div>
                                        <div class="col-sm-6">
                                            <label for="fixed_module_sub_title"
                                            ...
                                            <input type="text" id="fixed_module_sub_title" maxlength="50"
                                                name="fixed_module_sub_title[]" class="form-control"
                                                placeholder="{{ translate('Ex_:_Enjoy_all_services_in_one_platform') }}">
                                        </div>
                                    </div>
                                    <div class="alert alert-warning d-flex mt-4 mb-0">
                            ...
                            <h5 class="card-title mb-3 mt-3">
                                <span class="card-header-icon mr-2"><i class="tio-calendar"></i></span>
                                <span>{{ translate('Referral & Earning') }}</span>
                            </h5>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-sm-6">
                                            ...
                                            <input id="fixed_ref_title" type="text" maxlength="50"
                                                name="fixed_referal_title[]" class="form-control"
                                                placeholder="{{ translate('Ex_:_Earn_Point') }}">
                                        </div>
                                        <div class="col-sm-6">
                                            <label for="fixed_ref_sub_title"
                                                class="form-label">{{ translate('Sub Title') }}<span
                                                    class="form-label-secondary" data-toggle="tooltip"
                                                    data-placement="right"
                                                    data-original-title="{{ translate('Write_the_sub_title_within_50_characters') }}">
                                            ...
                                            <input id="fixed_ref_sub_title" type="text" maxlength="50"
                                                name="fixed_referal_sub_title[]" class="form-control"
                                                placeholder="{{ translate('Ex_:_By_referring_your_friend') }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card-body">
                                    <div class="row g-3">
                                        <div class="col-sm-6">
                                            ...
                                            <input id="fixed_newsletter_title" type="text" maxlength="50"
                                                name="fixed_newsletter_title[]" class="form-control"
                                                placeholder="{{ translate('Ex_:_Sign_Up_to_Our_Newsletter') }}">
                                        </div>
                                        <div class="col-sm-6">
                                            <label for="fixed_newsletter_sub_title"
                                            ...
                                            <input id="fixed_newsletter_sub_title" type="text" maxlength="50"
                                                name="fixed_newsletter_sub_title[]" class="form-control"
                                                placeholder="{{ translate('Ex_:_Receive_Latest_News,_Updates_and_Many_Other_News_Every_Week') }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card-body">
                                    <div class="row g-3">
                                        <div class="col-12">
                                            ...
                                            <input id="fixed_footer_article_title" type="text" maxlength="50"
                                                name="fixed_footer_article_title[]" class="form-control"
                                                placeholder="{{ translate('Ex_:_6amMart_is_a_complete_package!__It`s_time_to_empower_your_multivendor_online_business_with__powerful_features!') }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex justify-content-between align-items-center mb-2">
                                    ...
                                    <label class="toggle-switch toggle-switch-sm m-0">
                                        <input type="checkbox" name="web_app_url_status" id="apple-dm-status"
                                            data-id="apple-dm-status" data-type="status"
                                            ...
                                            {{ isset($fixed_link) && $fixed_link['web_app_url_status'] ? 'checked' : '' }}>
                                        <span class="toggle-switch-label text mb-0">
                                            <span class="toggle-switch-indicator"></span>
                                        </span>
                                    </label>
                                </div>
                                <input id="web_app_url" type="text"
                                    placeholder="{{ translate('Ex: https://epulsecart.com/') }}"
                                    class="form-control h--45px" name="web_app_url"
                                    value="{{ $fixed_link['web_app_url'] ?? '' }}">
                            </div>
                        </div>
                    </div>
                    <div class="btn--container justify-content-end mt-3">
                        ...
                        <button type="submit"
                            class="btn btn--primary mb-2">{{ translate('Save Information') }}</button>
                    </div>
                </form>

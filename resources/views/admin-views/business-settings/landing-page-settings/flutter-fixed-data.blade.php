    ...
    <div class="content container-fluid">
        ...
        <div class="tab-content">
            <div class="tab-pane fade show active">
                <form action="{{ route('admin.business-settings.flutter-landing-page-settings', 'fixed-header') }}"
                                        ...
                                        <div class="col-md-12 lang_form default-form">
                                            <div class="row g-3">
                                                <div class="col-12">
                                                    ...
                                                    <input id="fixed_header_title" type="text" maxlength="20"
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <input id="fixed_header_sub_title" type="text" maxlength="120"
                                                ...
                                                <div class="row g-3">
                                                    <div class="col-12">
                                                        ...
                                                        <input id="fixed_header_title{{ $lang }}" type="text"
                                                            maxlength="20" name="fixed_header_title[]"
                                                    ...
                                                    <div class="col-12">
                                                        ...
                                                        <input type="text"
                                                            id="fixed_header_sub_title{{ $lang }}"
                                                            maxlength="120" name="fixed_header_sub_title[]"
                                        ...
                                        <div class="col-md-12">
                                            <div class="row g-3">
                                                <div class="col-12">
                                                    ...
                                                    <input type="text" id="fixed_header_title" maxlength="50"
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <input type="text" id="fixed_header_sub_title" maxlength="50"
                                        ...
                                        <div class="position-relative">
                                            <div class="img">
                                                <img src="{{ \App\CentralLogics\Helpers::onerror_image_helper(
                                                    ...
                                                    asset('storage/fixed_header_image') . '/' . $fixed_header_image['value'] ?? '',
                                            ...
                                            @if (isset($fixed_header_image['value']))
                                                <span id="fixed_header_image" class="remove_image_button remove-image"
                                                    data-id="fixed_header_image" data-title="{{ translate('Warning!') }}"
                ...
                <form action="{{ route('admin.business-settings.flutter-landing-page-settings', 'fixed-location') }}"
                    method="POST" enctype="multipart/form-data">
                    @csrf
                    <h5 class="card-title mb-3 mt-3">
                        <span class="card-header-icon mr-2"><i class="tio-settings-outlined"></i></span>
                        <span>{{ translate('messages.location_setup') }}</span>
                    </h5>
                    <div class="card">
                        <div class="card-body">
                            @if ($language)
                                <div class="row g-3 lang_form default-form">
                                    <div class="col-sm-12">
                                        <label for="fixed_location_title" class="form-label">{{ translate('Title') }}
                                        ...
                                        <input type="text" id="fixed_location_title" maxlength="30"
                                            name="fixed_location_title[]" class="form-control"
                                ...
                                @foreach (json_decode($language) as $lang)
                                    ...
                                    <div class="row g-3 d-none lang_form" id="{{ $lang }}-form2">
                                        <div class="col-sm-12">
                                            <label for="fixed_location_title{{ $lang }}"
                                                class="form-label">{{ translate('Title') }}
                                                ({{ strtoupper($lang) }})
                                                <span class="form-label-secondary" data-toggle="tooltip"
                                                    data-placement="right"
                                            ...
                                            <input id="fixed_location_title{{ $lang }}" type="text"
                                                maxlength="30" name="fixed_location_title[]" class="form-control"
                                                value="{{ $fixed_location_title_translate[$lang]['value'] ?? '' }}"
                                                placeholder="{{ translate('messages.title_here...') }}">
                                        </div>
                                    </div>
                                    <input type="hidden" name="lang[]" value="{{ $lang }}">
                            ...
                            @else
                                <div class="row g-3">
                                    <div class="col-sm-12">
                                        <label for="fixed_location_title"
                                            class="form-label">{{ translate('Title') }}<span class="form-label-secondary"
                                                data-toggle="tooltip" data-placement="right"
                                                data-original-title="{{ translate('Write_the_title_within_30_characters') }}">
                                                <img src="{{ asset('assets/admin/img/info-circle.svg') }}"
                                                    alt="">
                                            </span></label>
                                        <input id="fixed_location_title" type="text" maxlength="30"
                                            name="fixed_location_title[]" class="form-control"
                                            placeholder="{{ translate('messages.title_here...') }}">
                                    </div>
                                </div>
                ...
                <form action="{{ route('admin.business-settings.flutter-landing-page-settings', 'fixed-module') }}"
                    method="POST" enctype="multipart/form-data">
                    @csrf
                    <h5 class="card-title mb-3 mt-3">
                        <span class="card-header-icon mr-2"><i class="tio-settings-outlined"></i></span>
                        <span>{{ translate('messages.module_setup') }}</span>
                    </h5>
                    <div class="card">
                        <div class="card-body">
                            ...
                            @if ($language)
                                <div class="row g-3 lang_form default-form">
                                    <div class="col-sm-6">
                                        <label for="fixed_module_title" class="form-label">{{ translate('Title') }}
                                            ({{ translate('messages.default') }})<span class="form-label-secondary"
                                                data-toggle="tooltip" data-placement="right"
                                        ...
                                        <input id="fixed_module_title" type="text" maxlength="40"
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input id="fixed_module_sub_title" type="text" maxlength="80"
                                    ...
                                    <div class="row g-3 d-none lang_form" id="{{ $lang }}-form">
                                        <div class="col-sm-6">
                                            ...
                                            <input id="fixed_module_title{{ $lang }}" type="text"
                                                maxlength="40" name="fixed_module_title[]" class="form-control"
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <input id="fixed_module_sub_title{{ $lang }}" type="text"
                                                maxlength="80" name="fixed_module_sub_title[]" class="form-control"
                            ...
                            @else
                                <div class="row g-3">
                                    <div class="col-sm-6">
                                        <label for="fixed_module_title" class="form-label">{{ translate('Title') }}<span

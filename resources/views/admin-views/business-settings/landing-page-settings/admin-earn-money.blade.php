                                        ...
                                        <div class="position-relative">
                                            <div class="img">
                                                <img src="{{ \App\CentralLogics\Helpers::onerror_image_helper(
                                                    ...
                                                    asset('storage/earning') . '/' . $earning_seller_image['value'] ?? '',
                                            ...
                                            @if (isset($earning_seller_image['value']))
                                                <span id="earning_seller_img" class="remove_image_button remove-image"
                                                    data-id="earning_seller_img" data-title="{{ translate('Warning!') }}"
                                        ...
                                        <div class="position-relative">
                                            <div class="img">
                                                ...
                                                <img src="{{ \App\CentralLogics\Helpers::onerror_image_helper(
                                                    ...
                                                    asset('storage/earning/') . '/' . $earning_delivery_image['value'],
                                                    asset('/assets/admin/img/upload-4.png'),
                                                    'earning/',
                                                ) }}"
                                                    data-onerror-image="{{ asset('/assets/admin/img/upload-4.png') }}"

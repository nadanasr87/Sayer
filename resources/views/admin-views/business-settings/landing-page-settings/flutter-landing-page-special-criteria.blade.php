    ...
    <div class="content container-fluid">
        ...
        <div class="tab-content">
            <div class="tab-pane fade show active">
                <form action="{{ route('admin.business-settings.flutter-landing-page-settings', 'special-criteria-list') }}"
                    method="POST" enctype="multipart/form-data">
                    @csrf
                    <h5 class="card-title mb-3 mt-3">
                        <span class="card-header-icon mr-2"><i class="tio-settings-outlined"></i></span>
                        <span>{{ translate('Special_Feature_List_Section ') }}</span>
                    </h5>
                    <div class="card mb-3">
                        <div class="card-body">
                            ...
                            <div class="row g-3">
                                @if ($language)
                                    <div class="col-sm-6 lang_form default-form">
                                        ...
                                        <input id="title" type="text" maxlength="30" name="title[]"
                                    ...
                                    @foreach (json_decode($language) as $lang)
                                        <div class="col-sm-6 d-none lang_form" id="{{ $lang }}-form1">
                                            ...
                                            <input type="text" id="title{{ $lang }}" maxlength="30"
                                ...
                                @else
                                    <div class="col-sm-6">
                                        ...
                                        <input type="text" id="title" maxlength="30" name="title[]"
                                            class="form-control" placeholder="{{ translate('messages.title_here...') }}">
                                    </div>
                                    <input type="hidden" name="lang[]" value="default">
                                @endif
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <label class="toggle-switch toggle-switch-sm">
                                                <input type="checkbox" data-id="status-{{ $criteria->id }}"
                                                    data-type="status"
                                            ...
                                            <form
                                                action="{{ route('admin.business-settings.flutter-criteria-status', [$criteria->id, $criteria->status ? 0 : 1]) }}"
                                        ...
                                        <td>
                                            <div class="btn--container justify-content-center">
                                                <a class="btn action-btn btn--primary btn-outline-primary"
                                                    href="{{ route('admin.business-settings.flutter-criteria-edit', [$criteria['id']]) }}">
                                                    <i class="tio-edit"></i>
                                                </a>
                                                ...
                                                <form
                                                    action="{{ route('admin.business-settings.flutter-criteria-delete', [$criteria['id']]) }}"

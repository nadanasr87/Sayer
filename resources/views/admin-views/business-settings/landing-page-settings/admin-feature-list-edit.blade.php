    ...
    <div class="content container-fluid">
        ...
        <div class="tab-content">
            <div class="tab-pane fade show active">
                <form action="{{ route('admin.business-settings.feature-update', [$feature['id']]) }}" method="POST"
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <input id="sub_title" type="text" maxlength="80" name="sub_title[]"
                                                    value="{{ $feature['sub_title'] }}" class="form-control"
                                        ...
                                        <div class="col-md-6 d-none lang_form" id="{{ $lang }}-form1">
                                            <div class="row g-3">
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <input id="sub_title" type="text" maxlength="80" name="sub_title[]"
                                                        value="{{ $translate[$lang]['sub_title'] ?? '' }}"
                                                        class="form-control"
                                                        placeholder="{{ translate('messages.sub_title_here...') }}">
                                                </div>
                                            </div>
                                        ...
                                        <div class="position-relative">
                                            ...
                                            @if (isset($feature->image))
                                                <span id="feature_image" class="remove_image_button remove-image"
                                                    data-id="feature_image" data-title="{{ translate('Warning!') }}"

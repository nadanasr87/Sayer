    ...
    <div class="content container-fluid">
        ...
        <div class="tab-content">
            <div class="tab-pane fade show active">
                <form action="{{ route('admin.business-settings.criteria-update', [$criteria['id']]) }}" method="POST"
                                ...
                                @if ($language)
                                    <div class="col-sm-6 lang_form default-form">
                                        ...
                                        <input id="title" type="text" maxlength="40" name="title[]"
                                            value="{{ $criteria['title'] ?? '' }}" class="form-control"
                                    ...
                                    @foreach (json_decode($language) as $lang)
                                        ...
                                        <div class="col-sm-6 d-none lang_form" id="{{ $lang }}-form1">
                                            ...
                                            <input id="title{{ $lang }}" type="text" name="title[]"

    ...
    <div class="content container-fluid">
        ...
        <div class="tab-content">
            <div class="tab-pane fade show active">
                ...
                <form action="{{ route('admin.business-settings.react-landing-page-settings', 'download-app-section') }}"
                                        ...
                                        <div class="col-md-12 lang_form default-form">
                                            <div class="row g-3">
                                                <div class="col-12">
                                                    ...
                                                    <input id="download_user_app_title" type="text" maxlength="60"
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <input id="download_user_app_sub_title" type="text" maxlength="180"
                                                ...
                                                <div class="row g-3">
                                                    <div class="col-12">
                                                        ...
                                                        <input id="download_user_app_title{{ $lang }}"
                                                            type="text" maxlength="60" name="download_user_app_title[]"
                                                    ...
                                                    <div class="col-12">
                                                        ...
                                                        <input type="text"
                                                            id="download_user_app_sub_title{{ $lang }}"
                                                            maxlength="180" name="download_user_app_sub_title[]"
                                        ...
                                        <div class="col-md-12">
                                            <div class="row g-3">
                                                <div class="col-12">
                                                    ...
                                                    <input type="text" id="download_user_app_title"
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <input id="download_user_app_sub_title" type="text"

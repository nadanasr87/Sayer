    ...
    <div class="content container-fluid">
        ...
        <div class="tab-content">
            <div class="tab-pane fade show active">
                <form action="{{ route('admin.business-settings.promotional-update', [$banner['id']]) }}" method="POST"
                        ...
                        <div class="card-body">
                            @if ($language)
                                <div class="row g-3 lang_form" id="default-form">
                                    <div class="col-sm-6">
                                        <label for="text" class="form-label">{{ translate('Title') }}
                                        ...
                                        <input id="text" type="text" maxlength="20" name="title[]"
                                            value="{{ $banner?->getRawOriginal('title') }}" class="form-control"
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input id="sub_title" type="text" maxlength="80" name="sub_title[]"
                                            value="{{ $banner?->getRawOriginal('sub_title') }}" class="form-control"
                                    ...
                                    <div class="row g-3 d-none lang_form" id="{{ $lang }}-form">
                                        <div class="col-sm-6">
                                            ...
                                            <input id="title{{ $lang }}" type="text" maxlength="20"
                                                name="title[]" value="{{ $translate[$lang]['title'] ?? '' }}"
                                                class="form-control"
                                                placeholder="{{ translate('messages.title_here...') }}">
                                        </div>
                                        <div class="col-sm-6">
                                            ...
                                            <input id="sub_title{{ $lang }}" type="text" maxlength="80"
                                                name="sub_title[]" value="{{ $translate[$lang]['sub_title'] ?? '' }}"
                                                class="form-control"
                                                placeholder="{{ translate('messages.sub_title_here...') }}">
                                        </div>
                                    </div>
                            ...
                            @else
                                <div class="row g-3">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input id="sub_title" type="text" name="sub_title[]" class="form-control"
                                            placeholder="{{ translate('messages.sub_title_here...') }}">
                                    </div>
                                </div>
                                <input type="hidden" name="lang[]" value="default">
                                    ...
                                    <div class="position-relative">
                                        <label class="upload-img-3 m-0 d-block">
                                            <div class="img">
                                                <img src="{{ \App\CentralLogics\Helpers::onerror_image_helper(
                                                    $banner['image'] ?? '',
                                                    asset('storage/promotional_banner') . '/' . $banner['image'] ?? '',
                                        ...
                                        @if (isset($banner['image']))
                                            <span id="banner_image" class="remove_image_button remove-image"
                                                data-id="banner_image" data-title="{{ translate('Warning!') }}"

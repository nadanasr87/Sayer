            ...
            <div class="modal-body pb-5 pt-0">
                <div class="single-item-slider owl-carousel">
                    ...
                    <div class="item">
                        <div class="max-349 mx-auto mb-20 text-center">
                            <img src="{{ asset('/assets/admin/img/notice-2.png') }}" alt="" class="mb-20">
                            <h5 class="modal-title">{{ translate('If You Want to Change Text Color To Primary Color') }}
                            </h5>
                            <p>
                    ...
                    <div class="item">
                        <div class="max-349 mx-auto mb-20 text-center">
                            ...
                            @if ($react)
                                <div class="btn-wrap">
                                    <a href="https://{{ $react['react_domain'] }}" class="btn btn--primary w-100"
                                        target="_blank">{{ translate('Visit_Now') }}</a>
                                </div>
                            @endif
                        </div>
                    </div>

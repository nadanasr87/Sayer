    ...
    <div class="content container-fluid">
        ...
        <div class="tab-content">
            <div class="tab-pane fade show active">
                ...
                <form action="{{ route('admin.business-settings.react-landing-page-settings', 'testimonial-list') }}"
                    method="POST" enctype="multipart/form-data">
                    @csrf
                                ...
                                <div class="col-md-6">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <textarea id="review" name="review" maxlength="140" placeholder="{{ translate('Very Good Company') }}"

    ...
    <div class="content container-fluid">
        ...
        <div class="tab-content">
            <div class="tab-pane fade show active">
                <form
                    action="{{ route('admin.business-settings.admin-landing-page-settings', 'download-counter-section') }}"
                    ...
                    <h5 class="card-title mb-3 mt-3">
                        <div class="d-flex justify-content-between align-items-center w-100">
                            ...
                            <label class="toggle-switch toggle-switch-sm m-0">
                                <input type="checkbox" name="status" data-id="counter_status" data-type="toggle"
                                    ...
                                    {{ isset($counter) && $counter['status'] ? 'checked' : '' }}>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row g-3">
                                <div class="col-sm-6 col-lg-3">
                                    <label for="app_download_count_numbers"
                                        class="form-label">{{ translate('Total App Download') }}</label>
                                    <input id="app_download_count_numbers" type="number" min="0" max="9999999999"
                                        name="app_download_count_numbers"
                                        value="{{ $counter['app_download_count_numbers'] ?? '' }}"
                                        placeholder="{{ translate('Ex: 500') }}" class="form-control">
                                </div>
                                <div class="col-sm-6 col-lg-3">
                                    <label for="seller_count_numbers"
                                        class="form-label">{{ translate('Total Seller') }}</label>
                                    <input id="seller_count_numbers" type="number" min="0" max="9999999999"
                                        name="seller_count_numbers" value="{{ $counter['seller_count_numbers'] ?? '' }}"
                                        placeholder="{{ translate('Ex: 500') }}" class="form-control">
                                </div>
                                <div class="col-sm-6 col-lg-3">
                                    <label for="deliveryman_count_numbers"
                                        class="form-label">{{ translate('Total Delivery Man') }}</label>
                                    <input id="deliveryman_count_numbers" type="number" min="0" max="9999999999"
                                        name="deliveryman_count_numbers"
                                        value="{{ $counter['deliveryman_count_numbers'] ?? '' }}"
                                        placeholder="{{ translate('Ex: 500') }}" class="form-control">
                                </div>
                                <div class="col-sm-6 col-lg-3">
                                    <label for="customer_count_numbers"
                                        class="form-label">{{ translate('Total Customer') }}</label>
                                    <input id="customer_count_numbers" type="number" min="0" max="9999999999"
                                        name="customer_count_numbers"
                                        value="{{ $counter['customer_count_numbers'] ?? '' }}"
                                        placeholder="{{ translate('Ex: 500') }}" class="form-control">
                                </div>
                            </div>
                ...
                <form action="{{ route('admin.business-settings.admin-landing-page-settings', 'download-app-section') }}"
                    method="POST" enctype="multipart/form-data">
                    @csrf
                    <h5 class="card-title mb-3 mt-3">
                                        ...
                                        <div class="col-md-12 lang_form default-form">
                                            <div class="row g-3">
                                                <div class="col-12">
                                                    ...
                                                    <input id="download_user_app_title" type="text" maxlength="20"
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <input id="download_user_app_sub_title" type="text" maxlength="50"
                                            ...
                                            <div class="col-md-12 d-none lang_form" id="{{ $lang }}-form1">
                                                <div class="row g-3">
                                                    <div class="col-12">
                                                        ...
                                                        <input id="download_user_app_title{{ $lang }}"
                                                    ...
                                                    <div class="col-12">
                                                        ...
                                                        <input id="download_user_app_sub_title{{ $lang }}"
                                        ...
                                        <div class="position-relative">
                                            <div class="img">
                                                <img src="{{ \App\CentralLogics\Helpers::onerror_image_helper(
                                                    ...
                                                    asset('storage/download_user_app_image') . '/' . $download_user_app_image['value'] ?? '',
                                            ...
                                            @if (isset($download_user_app_image['value']))
                                                <span id="download_user_app_image"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="__bg-F8F9FC-card">
                                        <div class="form-group mb-md-0">
                                            <div class="d-flex justify-content-between align-items-center mb-2">
                                                ...
                                                <label class="toggle-switch toggle-switch-sm m-0">
                                                    <input type="checkbox" name="apple_store_url_status"
                                                        id="apple-dm-status" data-id="apple-dm-status" data-type="toggle"
                                            ...
                                            <input id="apple_store_url" type="text"

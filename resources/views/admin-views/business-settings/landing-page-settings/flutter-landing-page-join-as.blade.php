                            ...
                            @if ($language)
                                <div class="row g-3 lang_form default-form">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input id="join_seller_sub_title" type="text" maxlength="60"
                                            name="join_seller_sub_title[]" class="form-control"
                                    ...
                                    <div class="col-sm-6">
                                        <label for="join_seller_button_url"
                                            class="form-label">{{ translate('Button URL') }}<span
                                                class="form-label-secondary" data-toggle="tooltip" data-placement="right"
                                                data-original-title="{{ translate('The_website_page_where_people_will_register_as_sellers.') }}">
                                                <img src="{{ asset('assets/admin/img/info-circle.svg') }}" alt="">
                                            </span></label>
                                        <input id="join_seller_button_url" type="url" name="join_seller_button_url"
                                            class="form-control" value="{{ $join_seller_button_url['value'] ?? '' }}"
                                ...
                                @foreach (json_decode($language) as $lang)
                                    ...
                                    <div class="row g-3 d-none lang_form" id="{{ $lang }}-form">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <input id="join_seller_sub_title{{ $lang }}" type="text"
                                                maxlength="60" name="join_seller_sub_title[]" class="form-control"
                                                value="{{ $join_seller_sub_title_translate[$lang]['value'] ?? '' }}"
                                                placeholder="{{ translate('messages.sub_title_here...') }}">
                                        </div>
                                        <div class="col-sm-6">
                                        ...
                                        <div class="col-sm-6">
                                            <label id="join_seller_button_url"
                                                class="form-label">{{ translate('Button URL') }}<span
                                            ...
                                            <input type="url" id="join_seller_button_url" class="form-control"
                                                value="{{ $join_seller_button_url['value'] ?? '' }}"
                                                placeholder="{{ translate('Ex: https://www.apple.com/app-store/') }}"
                                                readonly>
                                        </div>
                                    </div>
                            ...
                            @else
                                <div class="row g-3">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input type="text" id="join_seller_sub_title" value="join_seller_sub_title"
                                            maxlength="60" name="join_seller_sub_title[]" class="form-control"
                                            placeholder="{{ translate('messages.sub_title_here...') }}">
                                    </div>
                                    <div class="col-sm-6">
                                    ...
                                    <div class="col-sm-6">
                                        <label for="url" class="form-label">{{ translate('Button URL') }}<span
                                                class="form-label-secondary" data-toggle="tooltip" data-placement="right"
                                                data-original-title="{{ translate('The_website_page_where_people_will_register_as_sellers.') }}">
                                                <img src="{{ asset('assets/admin/img/info-circle.svg') }}"
                                                    alt="">
                        ...
                        <div class="card-body">
                            ...
                            @if ($language)
                                <div class="row g-3 lang_form default-form">
                                    ...
                                    <div class="col-sm-6">
                                        <label for="join_delivery_man_button_url"
                                            class="form-label">{{ translate('Button URL') }}<span
                                                class="form-label-secondary" data-toggle="tooltip" data-placement="right"
                                                data-original-title="{{ translate('The_website_page_where_people_will_register_as_deliveryman.') }}">
                                                <img src="{{ asset('assets/admin/img/info-circle.svg') }}"
                                                    alt="">
                                            </span></label>
                                        <input id="join_delivery_man_button_url" type="url"
                                            name="join_delivery_man_button_url" class="form-control"
                                            value="{{ $join_delivery_man_button_url['value'] ?? '' }}"
                                            placeholder="{{ translate('Ex: https://www.apple.com/app-store/') }}">
                                    </div>
                                </div>
                                <input type="hidden" name="lang[]" value="default">
                                @foreach (json_decode($language) as $lang)
                                    ...
                                    <div class="row g-3 d-none lang_form" id="{{ $lang }}-form1">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <input type="text" id="join_delivery_man_sub_title{{ $lang }}"
                                                maxlength="60" name="join_delivery_man_sub_title[]" class="form-control"
                                                value="{{ $join_delivery_man_sub_title_translate[$lang]['value'] ?? '' }}"
                                                placeholder="{{ translate('messages.sub_title_here...') }}">
                                        </div>
                                        <div class="col-sm-6">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <input type="url" id="join_delivery_man_button_url" class="form-control"
                                                value="{{ $join_delivery_man_button_url['value'] ?? '' }}"
                                                placeholder="{{ translate('Ex: https://www.apple.com/app-store/') }}"
                                                readonly>
                                        </div>

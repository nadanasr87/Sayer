    ...
    <div class="content container-fluid">
        ...
        <div class="tab-content">
            <div class="tab-pane fade show active">
                <form action="{{ route('admin.business-settings.react-landing-page-settings', 'business-section') }}"
                                ...
                                <div class="col-md-6">
                                    @if ($language)
                                        <div class="col-md-12 lang_form default-form">
                                            <div class="row g-3">
                                                <div class="col-12">
                                                    <label for="business_title" class="form-label">{{ translate('Title') }}
                                                    ...
                                                    <input type="text" id="business_title" maxlength="30"
                                                        name="business_title[]"
                                                ...
                                                <div class="col-12">
                                                    <label for="business_sub_title"
                                                        class="form-label">{{ translate('Sub Title') }}
                                                        ({{ translate('messages.default') }})
                                                        <span class="form-label-secondary" data-toggle="tooltip"
                                                            data-placement="right"
                                                            data-original-title="{{ translate('Write_the_title_within_35_characters') }}">
                                                            <img src="{{ asset('assets/admin/img/info-circle.svg') }}"
                                                                alt="">
                                                        </span></label>
                                                    <input type="text" id="business_sub_title" maxlength="35"
                                                        name="business_sub_title[]"
                                            ...
                                            <div class="col-md-12 d-none lang_form" id="{{ $lang }}-form1">
                                                <div class="row g-3">
                                                    <div class="col-12">
                                                        ...
                                                        <input type="text" id="business_title{{ $lang }}"
                                                            maxlength="30" name="business_title[]"
                                                            value="{{ $business_title_translate[$lang]['value'] ?? '' }}"
                                                            class="form-control"
                                                            placeholder="{{ translate('messages.title_here...') }}">
                                                    </div>
                                                    <div class="col-12">
                                                        <label for="business_sub_title{{ $lang }}"
                                                            class="form-label">{{ translate('Sub Title') }}
                                                        ...
                                                        <input type="text" id="business_sub_title{{ $lang }}"
                                                            maxlength="35" name="business_sub_title[]"
                                                            value="{{ $business_sub_title_translate[$lang]['value'] ?? '' }}"
                                                            class="form-control"
                                                            placeholder="{{ translate('messages.sub_title_here...') }}">
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="row g-3">
                                                <div class="col-12">
                                                    ...
                                                    <input id="business_title" type="text" name="business_title[]"
                                                        class="form-control"
                                                        placeholder="{{ translate('messages.title_here...') }}">
                                                </div>
                                                <div class="col-12">
                                                    ...
                                                    <input id="business_sub_title" type="text"
                                                        name="business_sub_title[]" class="form-control"
                                                        placeholder="{{ translate('messages.sub_title_here...') }}">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="position-relative">
                                            ...
                                            @if (isset($business_image['value']))
                                                <span id="business_image" class="remove_image_button remove-image"
                                                    data-id="business_image" data-title="{{ translate('Warning!') }}"
                            ...
                            <div class="row g-3 mt-3">
                                <div class="col-12">
                                    <h5 class="card-title mb-5">
                                        <img src="{{ asset('assets/admin/img/seller.png') }}" class="mr-2"
                                            alt="">
                                            ...
                                            <div class="__bg-F8F9FC-card">
                                                <div class="form-group mb-md-0">
                                                    <div class="d-flex justify-content-between align-items-center mb-2">
                                                        <label for="seller_playstore_url"
                                                        ...
                                                        <label class="toggle-switch toggle-switch-sm m-0">
                                                            <input type="checkbox" name="seller_playstore_url_status"
                                                                ...
                                                                value="1"
                                                                {{ isset($download_app_links) && $download_app_links['seller_playstore_url_status'] ? 'checked' : '' }}>
                                                            <span class="toggle-switch-label text mb-0">
                                                                <span class="toggle-switch-indicator"></span>
                                                            </span>
                                                        </label>
                                                    </div>
                                                    <input id="seller_playstore_url" type="text"
                                                        placeholder="{{ translate('Ex: https://play.google.com/store/apps') }}"
                                                        class="form-control h--45px" name="seller_playstore_url"
                                                        value="{{ $download_app_links['seller_playstore_url'] ?? '' }}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-center mb-2">
                                                        ...
                                                        <label class="toggle-switch toggle-switch-sm m-0">
                                                            <input type="checkbox" name="seller_appstore_url_status"
                                                                id="apple-seller-status" data-id="apple-seller-status"
                                                                data-type="toggle"
                                                                ...
                                                                class="status toggle-switch-input dynamic-checkbox-toggle"
                                                                value="1"
                                                                {{ isset($download_app_links) && $download_app_links['seller_appstore_url_status'] ? 'checked' : '' }}>
                                                            <span class="toggle-switch-label text mb-0">
                                                                <span class="toggle-switch-indicator"></span>
                                                            </span>
                                                        </label>
                                                    </div>
                                                    <input id="seller_appstore_url" type="text"
                                                        placeholder="{{ translate('Ex: https://www.apple.com/app-store/') }}"
                                                        class="form-control h--45px" name="seller_appstore_url"
                                                        value="{{ $download_app_links['seller_appstore_url'] ?? '' }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-center mb-2">
                                                        ...
                                                        <label class="toggle-switch toggle-switch-sm m-0">
                                                            <input type="checkbox" name="dm_playstore_url_status"
                                                                ...
                                                                class="status toggle-switch-input dynamic-checkbox-toggle"
                                                                value="1"
                                                                {{ isset($download_app_links) && $download_app_links['dm_playstore_url_status'] ? 'checked' : '' }}>
                                                            <span class="toggle-switch-label text mb-0">
                                                                <span class="toggle-switch-indicator"></span>
                                                            </span>
                                                        </label>
                                                    </div>
                                                    <input id="dm_playstore_url" type="text"
                                                        placeholder="{{ translate('Ex: https://play.google.com/store/apps') }}"
                                                        class="form-control h--45px" name="dm_playstore_url"
                                                        value="{{ $download_app_links['dm_playstore_url'] ?? '' }}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-center mb-2">
                                                        ...
                                                        <label class="toggle-switch toggle-switch-sm m-0">
                                                            <input type="checkbox" name="dm_appstore_url_status"
                                                                id="apple-dm-status" data-id="apple-dm-status"
                                                                data-type="toggle"
                                                                data-image-on="{{ asset('/assets/admin/img/modal/apple-on.png') }}"
                                                                data-image-off="{{ asset('/assets/admin/img/modal/apple-off.png') }}"
                                                                ...
                                                                class="status toggle-switch-input dynamic-checkbox-toggle"
                                                                value="1"
                                                                {{ isset($download_app_links) && $download_app_links['dm_appstore_url_status'] ? 'checked' : '' }}>
                                                            <span class="toggle-switch-label text mb-0">
                                                                <span class="toggle-switch-indicator"></span>
                                                            </span>
                                                        </label>
                                                    </div>
                                                    <input id="dm_appstore_url" type="text"
                                                        placeholder="{{ translate('Ex: https://www.apple.com/app-store/') }}"
                                                        class="form-control h--45px" name="dm_appstore_url"
                                                        value="{{ $download_app_links['dm_appstore_url'] ?? '' }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>

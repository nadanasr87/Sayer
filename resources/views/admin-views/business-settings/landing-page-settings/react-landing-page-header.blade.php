                    ...
                    <h5 class="card-title mb-3 mt-3">
                        <div class="d-flex justify-content-between align-items-center w-100">
                            <span>
                                ...
                                <span>{{ translate('Header Section') }}</span>
                            </span>
                        </div>
                    </h5>
                    <div class="card">
                            ...
                            <div class="row g-4">
                                        ...
                                        @if ($language)
                                            <div class="col-12 lang_form default-form">
                                                <div class="mb-2">
                                                    ...
                                                    <input id="header_title" type="text" maxlength="20"
                                                        name="header_title[]"
                                                ...
                                                <div class="mb-2">
                                                    ...
                                                    <input id="header_sub_title" type="text" maxlength="40"
                                            ...
                                            @foreach (json_decode($language) as $lang)
                                                ...
                                                <div class="col-12 d-none lang_form" id="{{ $lang }}-form">
                                                    <div class="mb-2">
                                                        ...
                                                        <input id="header_title{{ $lang }}" type="text"
                                                            maxlength="20" name="header_title[]"
                                                    ...
                                                    <div class="mb-2">
                                                        ...
                                                        <input id="header_sub_title{{ $lang }}" type="text"
                                                            maxlength="40" name="header_sub_title[]"
                                                    ...
                                                    <div class="mb-2">
                                                        ...
                                                        <input id="header_tag_line{{ $lang }}" type="text"
                                                            maxlength="120" name="header_tag_line[]"
                                        ...
                                        @else
                                            <div class="col-12">
                                                <div class="mb-2">
                                                    ...
                                                    <input id="header_title" type="text" name="header_title[]"
                                                        class="form-control"
                                                        placeholder="{{ translate('messages.title_here...') }}">
                                                </div>
                                                <div class="mb-2">
                                                    ...
                                                    <input id="header_sub_title" type="text" name="header_sub_title[]"
                                                        class="form-control"
                                                        placeholder="{{ translate('messages.sub_title_here...') }}">
                                                </div>
                                                <div class="mb-2">
                                        ...
                                        <div class="position-relative">
                                            ...
                                            @if (isset($header_icon['value']))
                                                <span id="header_icon" class="remove_image_button remove-image"
                                                    data-id="header_icon" data-title="{{ translate('Warning!') }}"
                                ...
                                <div class="col-md-3">
                                    ...
                                    <label class="upload-img-3 m-0">
                                        <div class="position-relative">
                                            <div class="img">
                                                <img src="{{ asset('storage/header_banner') }}/{{ $header_banner['value'] ?? '' }}"
                                                    onerror='this.src="{{ asset('/assets/admin/img/aspect-1.png') }}"'
                                                    class="img__aspect-1 mw-100 min-w-135px" alt="">
                                            </div>

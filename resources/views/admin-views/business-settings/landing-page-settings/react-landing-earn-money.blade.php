                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group mb-md-0">
                                                    <label for="earning_seller_button_url"
                                                        class="form-label text-capitalize">
                                                    ...
                                                    <input id="earning_seller_button_url" type="text"
                                                        placeholder="{{ translate('Ex: https://www.apple.com/app-store/') }}"
                                                        class="form-control h--45px" name="earning_seller_button_url"
                                                        value="{{ $earning_seller_button_url['value'] ?? '' }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group mb-md-0">
                                                    ...
                                                    <input id="earning_dm_button_url" type="text"
                                                        placeholder="{{ translate('Ex: https://www.apple.com/app-store/') }}"
                                                        class="form-control h--45px" name="earning_dm_button_url"
                                                        value="{{ $earning_dm_button_url['value'] ?? '' }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>

    ...
    <div class="content container-fluid">
        ...
        <div class="tab-content">
            <div class="tab-pane fade show active">
                <form action="{{ route('admin.business-settings.admin-landing-page-settings', 'testimonial-title') }}"
                            ...
                            @if ($language)
                                <div class="row g-3 lang_form" id="default-form">
                                    <div class="col-sm-12">
                                        ...
                                        <input id="testimonial_title" type="text" maxlength="40"
                                ...
                                @foreach (json_decode($language) as $lang)
                                    ...
                                    <div class="row g-3 d-none lang_form" id="{{ $lang }}-form">
                                        <div class="col-sm-12">
                                            ...
                                            <input id="testimonial_title{{ $lang }}" type="text" maxlength="40"
                                                name="testimonial_title[]" class="form-control"
                            ...
                            @else
                                <div class="row g-3">
                                    <div class="col-sm-12">
                                        ...
                                        <input type="text" id="testimonial_title" maxlength="40"
                                            name="testimonial_title[]" class="form-control"
                                            placeholder="{{ translate('messages.title_here...') }}">
                                    </div>
                                </div>
                ...
                <form action="{{ route('admin.business-settings.admin-landing-page-settings', 'testimonial-list') }}"
                    method="POST" enctype="multipart/form-data">
                    @csrf
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <div class="row g-3">
                                        <div class="col-md-6">
                                            <label for="name"
                                                class="form-label">{{ translate('Reviewer Name') }}</label>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input id="designation" type="text" name="designation"
                                                class="form-control" placeholder="{{ translate('Ex:  CTO') }}">
                                        </div>
                                        <div class="col-md-12">
                                            <label for="review"
                                            ...
                                            <textarea id="review" name="review" maxlength="250" placeholder="{{ translate('Very Good Company') }}"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <img src="{{ \App\CentralLogics\Helpers::onerror_image_helper(
                                                ...
                                                asset('storage/reviewer_company_image') . '/' . $review->company_image ?? '',
                                                asset('/assets/admin/img/upload-3.png'),
                                        ...
                                        <td>
                                            ...
                                            <form
                                                action="{{ route('admin.business-settings.review-status', [$review->id, $review->status ? 0 : 1]) }}"
                                        ...
                                        <td>
                                            <div class="btn--container justify-content-center">
                                                <a class="btn action-btn btn--primary btn-outline-primary"
                                                    href="{{ route('admin.business-settings.review-edit', [$review['id']]) }}">
                                                    <i class="tio-edit"></i>
                                                </a>
                                                <a class="btn action-btn btn--danger btn-outline-danger form-alert"
                                                    href="javascript:" data-id="review-{{ $review['id'] }}"
                                                    data-message="{{ translate('Want to delete this review ?') }}"><i
                                                        class="tio-delete-outlined"></i>
                                                </a>
                                                <form
                                                    action="{{ route('admin.business-settings.review-delete', [$review['id']]) }}"

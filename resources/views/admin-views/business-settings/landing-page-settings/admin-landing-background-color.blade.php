            ...
            <div class="card-body">
                <form action="{{ route('admin.business-settings.admin-landing-page-settings', 'background-color') }}"
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <label for="header-bg"
                                class="form-label d-block text-center">{{ translate('Primary Color 1') }}</label>
                            <input id="header-bg" name="header-bg" type="color" class="form-control form-control-color"
                                value="{{ $backgroundChange['primary_1_hex'] ?? '#EF7822' }}" required>
                        </div>
                        <div class="col-sm-6">
                            <label for="footer-bg"
                                class="form-label d-block text-center">{{ translate('Primary Color 2') }}</label>
                            <input id="footer-bg" name="footer-bg" type="color" class="form-control form-control-color"
                                value="{{ $backgroundChange['primary_2_hex'] ?? '#333E4F' }}" required>
                        </div>

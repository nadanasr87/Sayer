    ...
    <div class="content container-fluid">
        ...
        <div class="tab-content">
            <div class="tab-pane fade show active">
                <form action="{{ route('admin.business-settings.react-landing-page-settings', 'company-section') }}"
                    ...
                    <h5 class="card-title mb-3 mt-3">
                        <div class="d-flex justify-content-between align-items-center w-100">
                            <span>
                                ...
                                <span>{{ translate('Company Section') }}</span>
                            </span>
                        </div>
                    </h5>
                    <div class="card">
                            ...
                            <div class="row g-4">
                                        ...
                                        @if ($language)
                                            <div class="col-12 lang_form default-form">
                                                <div class="mb-2">
                                                    ...
                                                    <input id="company_title" type="text" maxlength="20"
                                                        name="company_title[]"
                                                ...
                                                <div class="mb-2">
                                                    ...
                                                    <input id="company_sub_title" type="text" maxlength="40"
                                            ...
                                            @foreach (json_decode($language) as $lang)
                                                ...
                                                <div class="col-12 d-none lang_form" id="{{ $lang }}-form">
                                                    <div class="mb-2">
                                                        <label for="company_title{{ $lang }}"
                                                            class="form-label">{{ translate('Title') }}({{ strtoupper($lang) }})
                                                            <span class="form-label-secondary" data-toggle="tooltip"
                                                                data-placement="right"
                                                                data-original-title="{{ translate('Write_the_title_within_20_characters') }}">
                                                                <img src="{{ asset('assets/admin/img/info-circle.svg') }}"
                                                        ...
                                                        <input id="company_title{{ $lang }}" type="text"
                                                            maxlength="20" name="company_title[]"
                                                            value="{{ $company_title_translate[$lang]['value'] ?? '' }}"
                                                            class="form-control"
                                                            placeholder="{{ translate('messages.title_here...') }}">
                                                    </div>
                                                    <div class="mb-2">
                                                        <label for="company_sub_title{{ $lang }}"
                                                        ...
                                                        <input id="company_sub_title{{ $lang }}" type="text"
                                                            maxlength="40" name="company_sub_title[]"
                                                            value="{{ $company_sub_title_translate[$lang]['value'] ?? '' }}"
                                                            class="form-control"
                                                            placeholder="{{ translate('messages.sub_title_here...') }}">
                                                    </div>
                                                    <div class="mb-2">
                                                        <label for="company_description{{ $lang }}"
                                                            class="form-label">
                                                        ...
                                                        <textarea id="company_description{{ $lang }}" maxlength="240" name="company_description[]"
                                                            class="form-control h--90px">{{ $company_description_translate[$lang]['value'] ?? '' }}</textarea>
                                                    </div>
                                                </div>
                                        ...
                                        @else
                                            <div class="col-12">
                                                <div class="mb-2">
                                                    ...
                                                    <input id="company_title" type="text" name="company_title[]"
                                                        class="form-control"
                                                        placeholder="{{ translate('messages.title_here...') }}">
                                                </div>
                                                <div class="mb-2">
                                                    ...
                                                    <input id="company_sub_title" type="text"
                                                        name="company_sub_title[]" class="form-control"
                                                        placeholder="{{ translate('messages.sub_title_here...') }}">
                                                </div>
                                                <div class="mb-2">
                                                    <label for="company_description" class="form-label">
                                ...
                                <div class="col-md-6">
                                    <div class="d-flex justify-content-between align-items-center mb-2">
                                        <h5 class="card-title">
                                            <img src="{{ asset('assets/admin/img/btn-cont.png') }}" class="mr-2"
                                                alt="">
                                            {{ translate('Button Content') }}
                                            <span class="input-label-secondary text--title" data-toggle="tooltip"
                                                data-placement="right"
                                                data-original-title="{{ translate('You_must_provide_a_redirect_URL_when_setting_the_button_name') }}">
                                                <i class="tio-info-outined"></i>
                                            </span>
                                        </h5>
                                    </div>
                                    <div class="__bg-F8F9FC-card">
                                        @if ($language)
                                            <div class="form-group lang_form default-form">
                                                ...
                                                <input id="company_button_name" type="text" maxlength="20"
                                                    name="company_button_name[]"
                                                    value="{{ $company_button_name?->getRawOriginal('value') ?? '' }}"
                                                    placeholder="{{ translate('Ex: Order now') }}"
                                                    class="form-control h--45px company_button_name">
                                            </div>
                                            @foreach (json_decode($language) as $lang)
                                                <?php
                                                ...
                                                <div class="form-group d-none lang_form" id="{{ $lang }}-form1">
                                                    <label for="company_button_name{{ $lang }}"
                                                    ...
                                                    <input id="company_button_name{{ $lang }}" type="text"
                                                        maxlength="20" name="company_button_name[]"
                                                        value="{{ $company_button_name_translate[$lang]['value'] ?? '' }}"
                                                        placeholder="{{ translate('Ex: Order now') }}"
                                                        class="form-control h--45px company_button_name">
                                                </div>
                                            @endforeach
                                        @else
                                            <div class="form-group">
                                                <label for="company_button_name" class="form-label text-capitalize">
                                                    ...
                                                    <span class="input-label-secondary text--title" data-toggle="tooltip"
                                                        data-placement="right" data-original-title="Lorem ipsum">
                                                        <i class="tio-info-outined"></i>
                                                    </span>
                                                </label>
                                                <input id="company_button_name" type="text"
                                                    placeholder="{{ translate('Ex: Order now') }}"
                                                    class="form-control h--45px company_button_name"
                                                    name="company_button_name[]">
                                            </div>
                                        ...
                                        <div class="form-group mb-md-0">
                                            <label for="company_button_url" class="form-label text-capitalize">
                                                ...
                                                <span class="input-label-secondary text--title" data-toggle="tooltip"
                                                    data-placement="right"
                                                    data-original-title="{{ translate('The_button_will_direct_users_to_the_link_contained_within_this_box.') }}">
                                                    <i class="tio-info-outined"></i>
                                                </span>
                                            </label>
                                            <input type="url" id="company_button_url"
                                                placeholder="{{ translate('Ex: https://www.apple.com/app-store/') }}"
                                                class="form-control h--45px" name="company_button_url"
                                                value="{{ $company_button_url['value'] ?? '' }}">
                                        </div>
                                    </div>
                                </div>
                            </div>

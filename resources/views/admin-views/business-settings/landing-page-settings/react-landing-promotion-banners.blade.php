    ...
    <div class="content container-fluid">
        ...
        <div class="tab-content">
            <div class="tab-pane fade show active">
                <form action="{{ route('admin.business-settings.react-landing-page-settings', 'promotion-banner') }}"
                    method="POST" enctype="multipart/form-data">
                    @csrf
                    <h5 class="card-title mb-3 mt-3">
                        <span class="card-header-icon mr-2"><i class="tio-settings-outlined"></i></span>
                        <span>{{ translate('Banner Section') }}</span>
                    </h5>
                    <div class="card mb-3">
                        <div class="card-body">
                                    ...
                                    <div>
                                        <label class="form-label d-block mb-3">
                                            {{ translate('Banner') }} <span
                                                class="text--primary">{{ translate('(size: 2:1)') }}</span><span
                                                class="form-label-secondary" data-toggle="tooltip" data-placement="right"
                                                data-original-title="{{ translate('If_you_want_to_upload_one_banner_then_you_have_to_upload_it_in_2:1_ratio_otherwise_the_ratio_will_be_same_as_before.') }}">
                                        ...
                                        <label class="upload-img-3 d-block max-w-640">
                                            <div class="img">
                                                <img src="{{ asset('/assets/admin/img/upload-4.png') }}"
                                                    data-onerror-image="{{ asset('/assets/admin/img/upload-4.png') }}"
                                                    class="vertical-img w-100 mw-100 onerror-image" alt="">
                                            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <img src="{{ \App\CentralLogics\Helpers::onerror_image_helper(
                                                $banner['img'] ?? '',
                                                asset('storage/promotional_banner') . '/' . $banner['img'] ?? '',
                                                asset('/assets/admin/img/upload-3.png'),
                                                'promotional_banner/',
                                            ) }}"
                                                data-onerror-image="{{ asset('/assets/admin/img/upload-3.png') }}"
                                                class="__size-105 mw-100 onerror-image" alt="">
                                        </td>
                                        <td>
                                            <div class="btn--container justify-content-center">
                                                <a class="btn action-btn btn--danger btn-outline-danger form-alert"
                                                    href="javascript:" data-id="promotion-{{ $key }}"
                                            ...
                                            <form
                                                action="{{ route('admin.business-settings.react-landing-page-settings-delete', ['tab' => 'promotion_banner', 'key' => $key]) }}"

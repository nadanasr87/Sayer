    ...
    <div class="content container-fluid">
        ...
        <div class="tab-content">
            <div class="tab-pane fade show active">
                <form action="{{ route('admin.business-settings.admin-landing-page-settings', 'contact-us-section') }}"
                                    ...
                                    @if ($language)
                                        <div class="col-md-12 lang_form default-form">
                                            <div class="row g-3">
                                                <div class="col-12">
                                                    ...
                                                    <input id="contact_us_title" type="text" maxlength="20"
                                                        name="contact_us_title[]"
                                                        value="{{ $contact_us_title?->getRawOriginal('value') }}"
                                                        class="form-control"
                                                        placeholder="{{ translate('Ex_:_Contact_Us') }}">
                                                </div>
                                                <div class="col-12">
                                                    <label for="contact_us_sub_title"
                                                    ...
                                                    <input id="contact_us_sub_title" type="text" maxlength="80"
                                                        name="contact_us_sub_title[]"
                                                        value="{{ $contact_us_sub_title?->getRawOriginal('value') }}"
                                                        class="form-control"
                                                        placeholder="{{ translate('Ex_:_Any_questions_or_remarks_?_Just_write_us_a_message!') }}">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        @foreach (json_decode($language) as $lang)
                                            ...
                                            <div class="col-md-12 d-none lang_form" id="{{ $lang }}-form1">
                                                <div class="row g-3">
                                                    <div class="col-12">
                                                        <label for="contact_us_title{{ $lang }}"
                                                            class="form-label">{{ translate('Title') }}
                                                            ({{ strtoupper($lang) }})
                                                        ...
                                                        <input id="contact_us_title{{ $lang }}" type="text"
                                                            maxlength="20" name="contact_us_title[]"
                                                            value="{{ $contact_us_title_translate[$lang]['value'] ?? '' }}"
                                                            class="form-control"
                                                            placeholder="{{ translate('Ex_:_Contact_Us') }}">
                                                    </div>
                                                    <div class="col-12">
                                                        <label for="contact_us_sub_title{{ $lang }}"
                                                            class="form-label">{{ translate('Sub Title') }}
                                                        ...
                                                        <input id="contact_us_sub_title{{ $lang }}" type="text"
                                                            maxlength="80" name="contact_us_sub_title[]"
                                                            value="{{ $contact_us_sub_title_translate[$lang]['value'] ?? '' }}"
                                                            class="form-control"
                                                            placeholder="{{ translate('Ex_:_Any_questions_or_remarks_?_Just_write_us_a_message!') }}">
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="row g-3">
                                                <div class="col-12">
                                                    ...
                                                    <input id="contact_us_title" type="text" maxlength="20"
                                                        name="contact_us_title[]" class="form-control"
                                                        placeholder="{{ translate('Ex_:_Contact_Us') }}">
                                                </div>
                                                <div class="col-12">
                                                    <label for="contact_us_sub_title"
                                                    ...
                                                    <input id="contact_us_sub_title" type="text" maxlength="80"
                                                        name="contact_us_sub_title[]" class="form-control"
                                                        placeholder="{{ translate('Ex_:_Any_questions_or_remarks_?_Just_write_us_a_message!') }}">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="position-relative">
                                            <div class="img">
                                                <img src="{{ \App\CentralLogics\Helpers::onerror_image_helper(
                                                    ...
                                                    asset('storage/contact_us_image') . '/' . $contact_us_image['value'] ?? '',
                                                    asset('assets/admin/img/upload-4.png'),
                                                    'contact_us_image/',
                                                ) }}"
                                                    class="vertical-img mw-100 onerror-image" alt="contact_us_image"
                                            ...
                                            @if (isset($contact_us_image['value']))
                                                <span id="contact_image" class="remove_image_button remove-image"
                                                    data-id="contact_image" data-title="{{ translate('Warning!') }}"
                    ...
                    <h5 class="card-title mb-3 mt-3">
                        <span class="card-header-icon mr-2"><i class="tio-poi"></i></span>

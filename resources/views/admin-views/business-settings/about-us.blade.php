                ...
                <form action="{{ route('admin.business-settings.about-us') }}" method="post" id="about_us-form">
                    ...
                    <div class="lang_form" id="default-form">
                        <div class="form-group">
                            <label
                                for="about_title">{{ translate('messages.about_title') }}({{ translate('messages.Default') }})</label>
                        ...
                        <div class="form-group">
                            <label
                                for="about_us">{{ translate('messages.about_us_description') }}({{ translate('messages.Default') }})</label>
                    ...
                    @if ($language)
                        @forelse(json_decode($language) as $lang)
                            ...
                            <div class="d-none lang_form" id="{{ $lang }}-form">
                                <div class="form-group">
                                    <label
                                        for="about_title">{{ translate('messages.about_title') }}({{ $lang }})</label>
                                    <input type="text" id="about_title" name="about_title[]" class="form-control"
                                ...
                                <div class="form-group">
                                    <label
                                        for="about_us{{ $lang }}">{{ translate('messages.about_us_description') }}({{ $lang }})</label>

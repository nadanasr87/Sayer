                    ...
                    <ul class="nav nav-tabs nav--tabs border-0 gap-2">
                        <li class="nav-item mr-2 mr-md-4">
                            <a href="{{ route('admin.business-settings.third-party.mail-config') }}"
                                class="nav-link pb-2 px-0 pb-sm-3 active">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.business-settings.third-party.test') }}"
                                class="nav-link pb-2 px-0 pb-sm-3">
                            ...
                            <div class="form-group text-center d-flex flex-wrap align-items-center">
                                <label
                                    ...
                                    <input id="mail-config-disable" type="checkbox" data-id="mail-config-disable"
                                        ...
                                        {{ isset($data) && isset($data['status']) && $data['status'] == 1 ? 'checked' : '' }}>
                                ...
                                <div class="row g-3">
                                    <div class="col-sm-12">
                                        <div class="form-group mb-0">
                                            <label for="name"
                                                class="form-label">{{ translate('messages.mailer_name') }}</label><br>
                                            <input id="name" type="text"
                                                placeholder="{{ translate('messages.Ex:') }} Alex" class="form-control"
                                                name="name"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group mb-0">
                                            <label for="host"
                                                class="form-label">{{ translate('messages.host') }}</label><br>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group mb-0">
                                            <label for="driver"
                                                class="form-label">{{ translate('messages.driver') }}</label><br>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group mb-0">
                                            <label for="port"
                                                class="form-label">{{ translate('messages.port') }}</label><br>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group mb-0">
                                            <label for="username"
                                                class="form-label">{{ translate('messages.username') }}</label><br>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group mb-0">
                                            <label for="email"
                                                class="form-label">{{ translate('messages.email_id') }}</label><br>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group mb-0">
                                            <label for="encryption"
                                                class="form-label">{{ translate('messages.encryption') }}</label><br>
                                            <input id="encryption" type="text"
                                                placeholder="{{ translate('messages.Ex:') }} tls" class="form-control"
                                                name="encryption"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group mb-0">
                                            <label for="password"
                                                class="form-label">{{ translate('messages.password') }}</label><br>
                ...
                <div class="modal-body pt-0">
                    <div class="text-center mb-20">
                        ...
                        <h5 class="modal-title">
                            {{ translate('Congratulations! Your SMTP mail has been setup successfully!') }}</h5>
                        <p class="txt">
                    ...
                    <div class="btn--container justify-content-center">
                        <a href="{{ route('admin.business-settings.third-party.test') }}"
                            ...
                            <img src="{{ asset('/assets/admin/img/paper-plane.png') }}" alt="">
    ...
    <div class="modal fade" id="update-data-modal">
        <div class="modal-dialog status-warning-modal">
            <div class="modal-content">
                ...
                <div class="modal-body pt-0">
                    <div class="text-center mb-20">
                        <img src="{{ asset('/assets/admin/img/mail-config/save-data.png') }}" alt=""
                            class="mb-20">
                ...
                <div class="modal-body pb-5 pt-0">
                    <div class="single-item-slider owl-carousel">
                        <div class="item">
                            <div class="mb-20">
                                <div class="text-center">
                                    <img src="{{ asset('/assets/admin/img/mail-config/slide-1.png') }}" alt=""
                                        class="mb-20">
                        ...
                        <div class="item">
                            <div class="mb-20">
                                <div class="text-center">
                                    <img src="{{ asset('/assets/admin/img/mail-config/slide-2.png') }}" alt=""
                                        class="mb-20">
                        ...
                        <div class="item">
                            <div class="mb-20">
                                <div class="text-center">
                                    <img src="{{ asset('/assets/admin/img/mail-config/slide-3.png') }}" alt=""
                                        class="mb-20">
                        ...
                        <div class="item">
                            <div class="mw-353px mb-20 mx-auto">
                                <div class="text-center">
                                    <img src="{{ asset('/assets/admin/img/mail-config/slide-4.png') }}" alt=""
                                        class="mb-20">

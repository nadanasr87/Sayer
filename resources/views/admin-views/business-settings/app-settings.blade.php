                        ...
                        <div class="col-md-6">
                            ...
                            <div class="__bg-F8F9FC-card">
                                <div class="form-group">
                                    ...
                                    <input id="app_minimum_version_android" type="number"
                                        placeholder="{{ translate('messages.app_minimum_version') }}" class="form-control"
                                        step="0.001" name="app_minimum_version_android"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="__bg-F8F9FC-card">
                                <div class="form-group">
                                    ...
                                    <input id="app_minimum_version_ios" type="number"
                                        placeholder="{{ translate('messages.app_minimum_version') }}" class="form-control"
                                        step="0.001" name="app_minimum_version_ios"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="__bg-F8F9FC-card">
                                <div class="form-group">
                                    ...
                                    <input id="app_minimum_version_android_store" type="number"
                                        placeholder="{{ translate('messages.app_minimum_version') }}"
                                        class="form-control h--45px" name="app_minimum_version_android_store"
                                        step="0.001" min="0"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="__bg-F8F9FC-card">
                                <div class="form-group">
                                    ...
                                    <input id="app_minimum_version_ios_store" type="number"
                                        placeholder="{{ translate('messages.app_minimum_version') }}"
                                        class="form-control h--45px" name="app_minimum_version_ios_store" step="0.001"
                                        min="0"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="__bg-F8F9FC-card">
                                <div class="form-group">
                                    ...
                                    <input type="number" id="app_minimum_version_android_deliveryman"
                                        placeholder="{{ translate('messages.app_minimum_version') }}"
                                        class="form-control h--45px" name="app_minimum_version_android_deliveryman"
                                        step="0.001" min="0"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="__bg-F8F9FC-card">
                                <div class="form-group">
                                    ...
                                    <input id="app_minimum_version_ios_deliveryman" type="number"
                                        placeholder="{{ translate('messages.app_minimum_version') }}"
                                        class="form-control h--45px" name="app_minimum_version_ios_deliveryman"
                                        step="0.001" min="0"

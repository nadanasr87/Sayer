                ...
                <div class="d-flex flex-wrap justify-content-between w-100 row-gap-1">
                    <ul class="nav nav-tabs nav--tabs border-0 gap-2">
                        <li class="nav-item mr-2 mr-md-4">
                            <a href="{{ route('admin.business-settings.fcm-index') }}" class="nav-link pb-2 px-0 pb-sm-3"
                                data-slide="1">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.business-settings.fcm-config') }}"
                    ...
                    <div class="tab-pane fade show active" id="firebase">
                        <form
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="push_notification_key" name="push_notification_key" class="form-control"
                                    placeholder="{{ translate('Ex: AAAAaBcDeFgHiJkLmNoPqRsTuVwXyZ0123456789') }}" required>{{ env('APP_MODE') != 'demo' ? $key->value ?? '' : '' }}</textarea>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <label class="input-label"
                                            for="projectId">{{ translate('FCM Project ID') }}</label>
                                        <div class="d-flex">
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    <div class="form-group">
                                        <label class="input-label"
                                            for="authDomain">{{ translate('messages.auth_domain') }}</label>
                                        <div class="d-flex">
                                            <input id="authDomain" type="text"
                                                value="{{ $fcm_credentials['authDomain'] ?? '' }}" name="authDomain"
                                                class="form-control"
                                                placeholder="{{ translate('Ex: my-awesome-app.firebase.com') }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-sm-6">
                                    <div class="form-group">
                                        <label class="input-label"
                                            for="storageBucket">{{ translate('messages.storage_bucket') }}</label>
                                        <div class="d-flex">
                                            <input id="storageBucket" type="text"
                                                value="{{ $fcm_credentials['storageBucket'] ?? '' }}" name="storageBucket"
                                                class="form-control"
                                                placeholder="{{ translate('Ex: my-awesome-app.apps.com') }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-sm-6">
                                    <div class="form-group">
                                        <label class="input-label"
                                            for="messagingSenderId">{{ translate('messages.messaging_sender_id') }}</label>
                                        <div class="d-flex">
                                            <input id="messagingSenderId" type="text"
                                                value="{{ $fcm_credentials['messagingSenderId'] ?? '' }}"
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    <div class="form-group">
                                        <label class="input-label"
                                            for="appId">{{ translate('messages.app_id') }}</label>
                                        <div class="d-flex">
                                            <input id="appId" type="text"
                                                value="{{ $fcm_credentials['appId'] ?? '' }}" name="appId"
                                                class="form-control" placeholder="{{ translate('Ex: 9876543210') }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-sm-6">
                                    <div class="form-group">
                                        <label class="input-label"
                                            for="measurementId">{{ translate('messages.measurement_id') }}</label>
                                        <div class="d-flex">
                                            <input id="measurementId" type="text"
                                                value="{{ $fcm_credentials['measurementId'] ?? '' }}" name="measurementId"
                                                class="form-control" placeholder="{{ translate('Ex: F-12345678') }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="modal-body pb-5 pt-0">
                        <div class="single-item-slider owl-carousel">
                            <div class="item">
                                <div class="mb-20">
                                    <div class="text-center">
                                        <img src="{{ asset('/assets/admin/img/firebase/slide-1.png') }}" alt=""
                                            class="mb-20">
                            ...
                            <div class="item">
                                <div class="mb-20">
                                    <div class="text-center">
                                        <img src="{{ asset('/assets/admin/img/firebase/slide-2.png') }}" alt=""
                                            class="mb-20">
                            ...
                            <div class="item">
                                <div class="mb-20">
                                    <div class="text-center">
                                        <img src="{{ asset('/assets/admin/img/firebase/slide-3.png') }}" alt=""
                                            class="mb-20">

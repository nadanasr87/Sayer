            ...
            <div class="card-body">
                ...
                <div class="mt-2">
                    ...
                    <form
                        ...
                        @csrf
                        <label
                            class="toggle-switch h--45px toggle-switch-sm d-flex justify-content-between border rounded px-3 py-0 form-control mb-4">
                            ...
                            <input type="checkbox" data-id="recaptcha_status" data-type="toggle"
                                ...
                                data-title-on="{{ translate('Important!') }}" data-title-off="{{ translate('Warning!') }}"
                                ...
                                class="status toggle-switch-input dynamic-checkbox-toggle" name="status"
                                id="recaptcha_status" value="1"
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="site_key"
                                        class="form-label">{{ translate('messages.Site Key') }}</label><br>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="site_key"
                                        class="form-label">{{ translate('messages.Secret Key') }}</label><br>
                        ...
                        <ul class="list-gap-5">
                            <li>{{ translate('messages.Go to the Credentials page') }}
                                ({{ translate('messages.Click') }} <a href="https://www.google.com/recaptcha/admin/create"
                            ...
                            <li>{{ translate('messages.Copy') }} <b>{{ translate('Site') }}
                                    {{ translate('Key') }}</b> {{ translate('messages.and') }}
                                <b>{{ translate('Secret') }}
                                    {{ translate('Key') }}</b>,

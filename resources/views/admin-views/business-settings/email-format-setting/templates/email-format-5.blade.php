...
<table class="email-template-table-style">
    <tr>
        <td class="email-template-table-td-style">
            ...
            src="{{ \App\CentralLogics\Helpers::onerror_image_helper(
                ...
                asset('storage/email_template').'/'.data_get($data, 'icon' , null) ,
    ...
    <tr>
        <td class="email-template-table-td-style-2">
            ...
            <img class="email-template-img onerror-image" data-onerror-image="{{ asset('storage/business/' . $store_logo) }}"

            src="{{ \App\CentralLogics\Helpers::onerror_image_helper(
                data_get($data, 'logo' , null),
                asset('storage/email_template').'/'.data_get($data, 'logo' , null),
                asset('storage/business/' . $store_logo),
                'email_template/'
            ) }}"

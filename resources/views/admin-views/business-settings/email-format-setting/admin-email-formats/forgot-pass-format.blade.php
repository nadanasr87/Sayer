            ...
            <div class="tab-pane fade show active">
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <div
                            ...
                            <h5 class="text-capitalize m-0 text--primary pl-2">
                                ...
                                <span class="form-label-secondary" data-toggle="tooltip" data-placement="right"
                                    data-original-title="{{ translate('If_a_user_clicks_‘Forgot_Password’_during_login,_an_automated_email_will_be_sent_to_the_admin.') }}">
                        ...
                        <form
                            action="{{ route('admin.business-settings.email-status', ['admin', 'forgot-password', $mail_status == '1' ? 0 : 1]) }}"
                ...
                <form action="{{ route('admin.business-settings.email-setup', ['admin', 'forget-password']) }}"

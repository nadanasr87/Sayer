    ...
    <div class="content container-fluid">
        ...
        <div class="tab-content">
            <div class="tab-pane fade show active">
                    ...
                    <div class="card-body">
                        <div
                            ...
                            <h5 class="text-capitalize m-0 text--primary pl-2">
                                ...
                                <span class="form-label-secondary text--primary" data-toggle="tooltip"
                                    data-placement="right"
                                    data-original-title="{{ translate('If_a_store_requests_to_join_campaign_an_automated_email_will_be_sent_to_the_admin.') }}">
                                    <img src="{{ asset('assets/admin/img/info-circle.svg') }}" alt="">
                                </span>
                            </h5>
                            <label class="toggle-switch toggle-switch-sm">
                                <input type="checkbox" class="status toggle-switch-input dynamic-checkbox"
                                    data-id="mail-status" data-type="status"
                        ...
                        <form
                            action="{{ route('admin.business-settings.email-status', ['admin', 'campaign-request', $mail_status == '1' ? 0 : 1]) }}"
                            method="get" id="mail-status_form">
                        </form>
                    </div>
                </div>
                ...
                <form action="{{ route('admin.business-settings.email-setup', ['admin', 'campaign-request']) }}"
                            ...
                            <div class="email-format-wrapper">
                                <div class="left-content">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            @include(
                                                'admin-views.business-settings.email-format-setting.templates.email-format-' .
                                                    $template)
                                        </div>
                                    </div>
                                </div>
                                <div class="right-content">
                                    <div class="d-flex flex-wrap justify-content-between __gap-15px mt-2 mb-5">
                                        ...
                                        <div class="d-flex justify-content-end">
                                            <div class="text--primary-2 py-1 d-flex flex-wrap align-items-center py-1"
                                                type="button" data-toggle="modal" data-target="#instructions">
                                    ...
                                    <div>
                                        ...
                                        <label class="custom-file">
                                            <input type="file" name="logo" id="mail-logo" class="custom-file-input"
                                    ...
                                    <div>
                                        <h5 class="card-title mb-3">
                                            <img src="{{ asset('assets/admin/img/pointer.png') }}" class="mr-2"
                                                alt="">
                                        ...
                                        @if ($language)
                                            <div class="__bg-F8F9FC-card default-form lang_form" id="default-form">
                                                <div class="form-group">
                                                    <label
                                                        class="form-label">{{ translate('Main Title') }}({{ translate('messages.default') }})</label>
                                                    <input type="text" name="title[]"
                                                        value="{{ $data?->getRawOriginal('title') }}" data-id="mail-title"
                                                        placeholder="Order has been placed successfully !"
                                                        class="form-control">
                                                </div>
                                            ...
                                            @foreach (json_decode($language) as $lang)
                                                ...
                                                ?>
                                                <div class="__bg-F8F9FC-card d-none lang_form"
                                                    id="{{ $lang }}-form">
                                                    <div class="form-group">
                                                        <label
                                                            class="form-label">{{ translate('Main Title') }}({{ strtoupper($lang) }})</label>
                                                        <input type="text" name="title[]"
                                                            placeholder="Order has been placed successfully !"
                                                            class="form-control"
                                                ...
                                                <div class="col-sm-6">
                                                    @if ($language)
                                                        <div class="form-group m-0 lang_form default-form">
                                                            ...
                                                            <input type="text" data-id="mail-button"
                                                                name="button_name[]"
                                                        ...
                                                        @foreach (json_decode($language) as $lang)
                                                            ...
                                                            ?>
                                                            <div class="form-group m-0 d-none lang_form"
                                                                id="{{ $lang }}-form1">
                                                                <label class="form-label text-capitalize">
                                                                ...
                                                                <input type="text" name="button_name[]"
                                                                    placeholder="{{ translate('Ex: Order now') }}"
                                                                    class="form-control h--45px"
                                                                    value="{{ $translate[$lang]['button_name'] ?? '' }}">
                                                            </div>
                                                        @endforeach
                                                    @else
                                                        <div class="form-group m-0">
                                                            ...
                                                            <input type="text"
                                                                placeholder="{{ translate('Ex: Order now') }}"
                                                                class="form-control h--45px" name="button_name[]"
                                                                value="">
                                                        </div>
                                                    @endif
                                                </div>
                                                <div class="col-sm-6">
                                                    <div class="form-group m-0">
                                                        <label class="form-label">
                                                            ...
                                                            <span class="input-label-secondary text--title"
                                                                data-toggle="tooltip" data-placement="right"
                                                                data-original-title="{{ translate('Link_to_your_preferred_destination_that_will_work_when_someone_clicks_on_the_Button_Name._Add_the_link_where_the_button_will_redirect_users.') }}">
                                                                <i class="tio-info-outined"></i>
                                                            </span>
                                                        </label>
                                                        <input type="text" name="button_url"
                                                            placeholder="{{ translate('Please_contact_us_for_any_queries;_we’re_always_happy_to_help.') }}"class="form-control"
                                    ...
                                    <div>
                                        ...
                                        <label class="custom-file">
                                            <input type="file" name="image" id="mail-banner"
                                        ...
                                        <div class="__bg-F8F9FC-card">
                                            @if ($language)
                                                <div class="form-group lang_form default-form">
                                                    ...
                                                    <input type="text" data-id="mail-footer" name="footer_text[]"
                                                        placeholder="{{ translate('Please_contact_us_for_any_queries;_we’re_always_happy_to_help.') }}"class="form-control"
                                                        value="{{ $data?->getRawOriginal('footer_text') }}">
                                                </div>
                                                @foreach (json_decode($language) as $lang)
                                                    <?php
                                                    if ($data && count($data['translations'])) {
                                                    ...
                                                    <div class="form-group d-none lang_form"
                                                        ...
                                                        <input type="text" name="footer_text[]"
                                                            placeholder="{{ translate('Please_contact_us_for_any_queries;_we’re_always_happy_to_help.') }}"class="form-control"
                                                            value="{{ $translate[$lang]['footer_text'] ?? '' }}">
                                                    </div>
                                                @endforeach
                                            @else
                                                <div class="form-group">
                                                    ...
                                                    <input type="text"
                                                        placeholder="{{ translate('Please_contact_us_for_any_queries;_we’re_always_happy_to_help.') }}"
                                            ...
                                            <div class="form-group mb-0">
                                                @if ($language)
                                                    <div class="form-group lang_form default-form">
                                                        ...
                                                        <input type="text" data-id="mail-copyright"
                                                            name="copyright_text[]"
                                                            placeholder="{{ translate('Ex:_Copyright_2023_6amMart._All_right_reserved') }}"
                                                            class="form-control"
                                                            value="{{ $data?->getRawOriginal('copyright_text') }}">
                                                    </div>
                                                    @foreach (json_decode($language) as $lang)
                                                        <?php
                                                        $translate = [];
                                                        ...
                                                        <div class="form-group d-none lang_form"
                                                            ...
                                                            <input type="text" name="copyright_text[]"
                                                                placeholder="{{ translate('Ex:_Copyright_2023_6amMart._All_right_reserved') }}"
                                                                class="form-control"
                                                                value="{{ $translate[$lang]['copyright_text'] ?? '' }}">
                                                        </div>
                                                    @endforeach
                                                @else
                                                    <div class="form-group">

            ...
            <div class="tab-pane fade show active">
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <div
                            ...
                            <h5 class="text-capitalize m-0 text--primary pl-2">
                                ...
                                <span class="form-label-secondary text--primary" data-toggle="tooltip"
                                    ...
                                    data-original-title="{{ translate('If_a_store_requests_for_a_withdrawal,_admin_will_receive_an_automated_email.') }}">
                        ...
                        <form
                            action="{{ route('admin.business-settings.email-status', ['admin', 'withdraw-request', $mail_status == '1' ? 0 : 1]) }}"
                ...
                <form action="{{ route('admin.business-settings.email-setup', ['admin', 'withdraw-request']) }}"

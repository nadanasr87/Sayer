            ...
            <div class="tab-pane fade show active">
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <div
                            ...
                            <h5 class="text-capitalize m-0 text--primary pl-2">
                                ...
                                <span class="form-label-secondary text--primary" data-toggle="tooltip"
                                    ...
                                    data-original-title="{{ translate('If_Store/Admin_wants,_they_can_suspend_a_Deliveryman’s_account._If_a_Store_or_Admin_suspends_a_Deliveryman’s_account,_he_will_receive_an_automated_email.') }}">
                        ...
                        <form
                            action="{{ route('admin.business-settings.email-status', ['dm', 'suspend', $mail_status == '1' ? 0 : 1]) }}"
                ...
                <form action="{{ route('admin.business-settings.email-setup', ['dm', 'suspend']) }}" method="POST"

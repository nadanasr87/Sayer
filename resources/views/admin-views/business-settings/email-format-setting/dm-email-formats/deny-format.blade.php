            ...
            <div class="tab-pane fade show active">
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <div
                            ...
                            <h5 class="text-capitalize m-0 text--primary pl-2">
                                ...
                                <span class="form-label-secondary text--primary" data-toggle="tooltip"
                                    ...
                                    data-original-title="{{ translate('If_Admin_rejects_a_Deliveryman’s_self-registration,_the_Deliveryman_will_get_an_automatic_rejection_mail.') }}">
                        ...
                        <form
                            action="{{ route('admin.business-settings.email-status', ['dm', 'deny', $mail_status == '1' ? 0 : 1]) }}"
                ...
                <form action="{{ route('admin.business-settings.email-setup', ['dm', 'deny']) }}" method="POST"

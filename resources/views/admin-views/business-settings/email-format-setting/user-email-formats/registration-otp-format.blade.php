            ...
            <div class="tab-pane fade show active">
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <div
                            ...
                            <h5 class="text-capitalize m-0 text--primary pl-2">
                                ...
                                <span class="form-label-secondary text--primary" data-toggle="tooltip"
                                    ...
                                    data-original-title="{{ translate('Customers_will_receive_an_automated_email_with_an_OTP_to_confirm_their_registration.') }}">
                        ...
                        <form
                            action="{{ route('admin.business-settings.email-status', ['user', 'registration-otp', $mail_status == '1' ? 0 : 1]) }}"
                ...
                <form action="{{ route('admin.business-settings.email-setup', ['user', 'registration-otp']) }}"

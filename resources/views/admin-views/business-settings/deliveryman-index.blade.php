                                ...
                                <div class="col-sm-6 col-lg-4">
                                    ...
                                    <div class="form-group mb-0">
                                        ...
                                        <label
                                            ...
                                            <input type="checkbox" data-id="dm_self_registration1" data-type="toggle"
                                    ...
                                    <div class="form-group mb-0">
                                        <label class="form-label text-capitalize" for="dm_maximum_orders">
                                            <div class="d-flex align-items-center">
                                                <span
                                                    class="line--limit-1 flex-grow">{{ translate('Maximum Assigned Order Limit') }}
                                            ...
                                            <span class="pr-1 d-flex align-items-center switch--label">
                                                ...
                                                <span class="form-label-secondary text-danger d-flex"
                                                    ...
                                                    data-original-title="{{ translate('messages.If_enabled,_deliverymen_will_see_an_option_to_take_pictures_of_the_delivered_products_when_he_swipes_the_delivery_confirmation_slide.') }}"><img
                                                        src="{{ asset('/assets/admin/img/info-circle.svg') }}"
                                                        alt="{{ translate('messages.dm_picture_upload_status') }}"> *
                                                </span>
                                            </span>
                                            <input type="checkbox" data-id="dm_picture_upload_status" data-type="toggle"
                                                data-image-on="{{ asset('/assets/admin/img/modal/dm-self-reg-on.png') }}"
                                                data-image-off="{{ asset('/assets/admin/img/modal/dm-self-reg-off.png') }}"
                                ...
                                <div class="col-sm-6 col-lg-4">
                                    ...
                                    <div class="form-label mb-0">
                                        ...
                                        <input type="number" name="dm_max_cash_in_hand" class="form-control"
                                            ...
                                            value="{{ $dm_max_cash_in_hand ? $dm_max_cash_in_hand->value : '' }}"
                                ...
                                <div class="col-sm-6 col-lg-4">
                                    ...
                                    <div class="form-label mb-0">
                                        ...
                                        <input type="number" name="min_amount_to_pay_dm" class="form-control"
                                            ...
                                            value="{{ $min_amount_to_pay_dm ? $min_amount_to_pay_dm->value : '' }}"
                                            {{ $cash_in_hand_overflow == 1 ? 'required' : 'readonly' }}>
                                    </div>
                                </div>

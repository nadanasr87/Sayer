        ...
        <div class="row g-3">
                            ...
                            <div class="card">
                                <div class="card-header card-header-shadow">
                                    <h5 class="card-title align-items-center">
                                        <img src="{{ asset('/assets/admin/img') }}/{{ $socialLoginService['login_medium'] }}.png"
                                            class="mr-1 w-20" alt="">
                                    ...
                                    <label class="toggle-switch toggle-switch-sm p-0">
                                        <span class="d-flex align-items-center switch--label">
                                            <span class="form-label-secondary text-danger d-flex" data-toggle="tooltip"
                                                data-placement="right" data-original-title="Lorem ipsum dolor set amet"><img
                                                    src="{{ asset('assets/admin/img/info-circle.svg') }}"
                                                    alt="Veg/non-veg toggle"> * </span>
                                        </span>
                                        <input id="{{ $socialLoginService['login_medium'] }}_status"
                                            data-id="{{ $socialLoginService['login_medium'] }}_status" data-type="toggle"
                                            ...
                                            class="status toggle-switch-input dynamic-checkbox-toggle" type="checkbox"
                                            name="status" value="1"
                                ...
                                <div class="card-body">
                                    <div class="d-flex justify-content-end">
                                        <div class="text--primary-2 d-flex flex-wrap align-items-center" type="button"
                                            ...
                                            <strong
                                                class="mr-2 text--underline">{{ translate('Credential Setup') }}</strong>
                                            <div class="blinkings">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="position-relative">
                                            <span class="btn-right-fixed copy-to-clipboard"
                                                data-id="#id_{{ $socialLoginService['login_medium'] }}"><i
                                                    class="tio-copy"></i></span>
            ...
            @if (isset($appleLoginServices))
                @foreach ($appleLoginServices as $appleLoginService)
                    <div class="col-md-6">
                        <div class="card">
                            <form action="{{ route('admin.apple-login.update', [$appleLoginService['login_medium']]) }}"
                                method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="card-header card-header-shadow">
                                    <h5 class="card-title align-items-center">
                                        <img src="{{ asset('/assets/admin/img/apple.png') }}" class="mr-1 w--20"
                                            alt="">
                                    ...
                                    <label class="toggle-switch toggle-switch-sm p-0">
                                        ...
                                        <input id="{{ $appleLoginService['login_medium'] }}_status"
                                            data-id="{{ $appleLoginService['login_medium'] }}_status" data-type="toggle"
                                ...
                                <div class="card-body text-{{ Session::get('direction') === 'rtl' ? 'right' : 'left' }}">
                                    ...
                                    <div class="form-group">
                                        <label class="form-label">{{ translate('messages.service_file') }}
                                            {{ $appleLoginService['service_file'] ? translate('(Already Exists)') : '' }}</label>
                                        <input type="file" accept=".p8" class="form-control" name="service_file"
                                            value="{{ 'storagele-login/' . $appleLoginService['service_file'] }}">
                                    </div>
                                    <div class="btn--container justify-content-end">
                                        <button type="reset"
                                            class="btn btn--reset mb-2">{{ translate('Reset') }}</button>
                ...
                <div class="modal-body pb-0">
                    ...
                    <ol>
                        ...
                        <li>{{ translate('messages.click') }} <b>{{ translate('messages.create_credentials') }}</b> >
                            <b>{{ translate('messages.auth_client_id') }}</b>.
                        </li>
                ...
                <div class="modal-body pb-0"><b></b>
                    ...
                    <ol>
                        ...
                        <li>{{ translate('messages.from_register_tab_press') }}
                            ...
                            <small>({{ translate('messages.if_needed') }})</small>
                        </li>
                        ...
                        <li>{{ translate('messages.make_sure_to_check') }}
                            ...
                            <small>({{ translate('messages.must_on') }})</small>
                        </li>
                        <li>{{ translate('messages.provide') }}
                            ...
                            <b>{{ translate('messages.save_changes') }}</b>
                        </li>
                ...
                <div class="modal-body pb-0"><b></b>
                    ...
                    <ol>
                        <li>{{ translate('Go to Apple Developer page') }} (<a
                                ...
                                target="_blank">{{ translate('messages.click_here') }}</a>)</li>
                        <li>{{ translate('Here in top left corner you can see the') }} <b>{{ translate('Team ID') }}</b>
                            {{ translate('[Apple_Developer_Account_Name - Team_ID]') }}</li>
                        ...
                        <li>{{ translate('Put a description and also identifier (identifier that used for app) and this is the') }}
                            <b>{{ translate('Client ID') }}</b>
                        </li>
                        <li>{{ translate('Click Continue and Download the file in device named AuthKey_ID.p8 (Store it safely and it is used for push notification)') }}
                        </li>
                        ...
                        <li>{{ translate('Download the file in device named') }}
                            ...
                            {{ translate('[This is the Service Key ID file and also after AuthKey_ that is the Key ID]') }}
                        </li>
                    </ol>
                </div>
                <div class="modal-footer justify-content-center border-0">

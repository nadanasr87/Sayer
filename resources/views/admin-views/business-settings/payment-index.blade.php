            ...
            <div class="d-flex flex-wrap justify-content-end align-items-center flex-grow-1">
                <div class="blinkings trx_top active">
                    ...
                    <div class="business-notes">
                        <h6><img src="{{ asset('/assets/admin/img/notes.png') }}" alt=""> {{ translate('Note') }}
                        </h6>
                        <div>
            ...
            <div class="card-body">
                <div class="row g-4">
                    <div class="col-md-4">
                        ...
                        <form
                            action="{{ route('admin.business-settings.third-party.payment-method-update', ['cash_on_delivery']) }}"
                                ...
                                <span class="pr-1 d-flex align-items-center switch--label">
                                    ...
                                    <span class="form-label-secondary text-danger d-flex" data-toggle="tooltip"
                                        ...
                                        data-original-title="{{ translate('If_enabled_Customers_will_be_able_to_select_COD_as_a_payment_method_during_checkout') }}"><img
                                            src="{{ asset('assets/admin/img/info-circle.svg') }}" alt="Veg/non-veg toggle">
                                        * </span>
                                </span>
                                <input type="hidden" name="toggle_type" value="cash_on_delivery">
                                <input type="checkbox" id="cash_on_delivery_status" data-id="cash_on_delivery_status"
                                    data-type="status"
                    ...
                    <div class="col-md-4">
                        ...
                        <form
                            action="{{ route('admin.business-settings.third-party.payment-method-update', ['digital_payment']) }}"
                            ...
                            <label
                                ...
                                <input type="checkbox" id="digital_payment_status" data-id="digital_payment_status"
                                    data-type="status"
                                    data-image-on="{{ asset('/assets/admin/img/modal/digital-payment-on.png') }}"
                                    data-image-off="{{ asset('/assets/admin/img/modal/digital-payment-off.png') }}"
                    ...
                    <div class="col-md-4">
                        ...
                        <form
                            action="{{ route('admin.business-settings.third-party.payment-method-update', ['offline_payment_status']) }}"
                            ...
                            <label
                                ...
                                <span class="pr-1 d-flex align-items-center switch--label">
                                    ...
                                    <span class="form-label-secondary text-danger d-flex" data-toggle="tooltip"
                                        data-placement="right"
                                        data-original-title="{{ translate('If_enabled_Customers_will_be_able_to_select_offline_payment_as_a_payment_method_during_checkout') }}"><img
                                            src="{{ asset('assets/admin/img/info-circle.svg') }}" alt="Veg/non-veg toggle">
                                        * </span>
                                </span>
                                <input type="hidden" name="toggle_type" value="offline_payment_status">
                                <input type="checkbox" id="offline_payment_status" data-id="offline_payment_status"
                                    data-type="status"
                                    data-image-on="{{ asset('/assets/admin/img/modal/digital-payment-on.png') }}"
                                    data-image-off="{{ asset('/assets/admin/img/modal/digital-payment-off.png') }}"
        ...
        <div class="row digital_payment_methods  {{ $is_published }} mt-3 g-3">
            @foreach ($data_values as $payment_key => $payment)
                <div class="col-md-6 mb-4">
                    <div class="card">
                        <form
                            action="{{ env('APP_MODE') != 'demo' ? route('admin.business-settings.third-party.payment-method-update') : 'javascript:' }}"
                            ...
                            <div class="card-body">
                                <div class="payment--gateway-img">
                                    <img id="{{ $payment->key_name }}-image-preview" class="__height-80 onerror-image"
                                        ...
                                        @if ($additional_data != null) src="{{ \App\CentralLogics\Helpers::onerror_image_helper(
                                            $additional_data?->gateway_image,
                                            asset('storage/payment_modules/gateway_image') . '/' . $additional_data?->gateway_image,
                                            asset('/assets/admin/img/payment/placeholder.png'),
                                            'payment_modules/gateway_image/',
                                        ) }}"

                                @else
                                src="{{ asset('/assets/admin/img/payment/placeholder.png') }}" @endif
                                        alt="public">
                                </div>
                                    ...
                                    @if (!in_array($key, $skip))
                                        <div class="form-floating mb-2">
                                            <label for="{{ $payment_key }}-{{ $key }}"
                                                ...
                                                *</label>
                                            <input id="{{ $payment_key }}-{{ $key }}" type="text"
                                ...
                                @if ($payment['key_name'] == 'paystack')
                                    <div class="form-floating mb-2">
                                        <label for="Callback_Url"
                                            class="form-label">{{ translate('Callback Url') }}</label>
                                        <input id="Callback_Url" type="text" class="form-control"
                                ...
                                <div class="form-floating mb-2">
                                    ...
                                    <input type="text" class="form-control" name="gateway_title"
                                        id="payment_gateway_title-{{ $payment_key }}"
                                ...
                                <div class="form-floating mb-2">
                                    ...
                                    <input type="file" class="form-control" name="gateway_image"
                                        id="{{ $payment->key_name }}-image" accept=".jpg, .png, .jpeg|image/*">
                                </div>

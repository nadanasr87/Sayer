                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-lg-4">
                                                <div class="form-group">
                                                        ...
                                                        @if ($lang == 'en')
                                                            <label
                                                                ...
                                                                <input type="checkbox" data-id="pending_status"
                                                                    ...
                                                                    name="pending_status"
                                                                    data-textarea-name="pending_messages" value="1"
                                                                    id="pending_status"
                                                    ...
                                                    <textarea name="pending_message[]" placeholder="{{ translate('Write your message') }}"
                                            ...
                                            <div class="col-md-6 col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="confirm_message[]" placeholder="{{ translate('Write your message') }}"
                                            ...
                                            @if ($mod_type != 'parcel')
                                                ...
                                                <div class="col-md-6 col-lg-4">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="processing_message[]" placeholder="{{ translate('Write your message') }}"
                                                ...
                                                <div class="col-md-6 col-lg-4">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="order_handover_message[]" placeholder="{{ translate('Write your message') }}"
                                                            class="form-control order_handover_message"
                                            ...
                                            <div class="col-md-6 col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="out_for_delivery_message[]" placeholder="{{ translate('Write your message') }}"
                                                        class="form-control out_for_delivery_message"
                                            ...
                                            <div class="col-md-6 col-lg-4">
                                                <div class="form-group">
                                                    <div class="d-flex flex-wrap justify-content-between mb-2">
                                                        ...
                                                        @if ($lang == 'en')
                                                            <label
                                                                ...
                                                                <input type="checkbox" data-id="delivered_status"
                                                                    data-type="toggle"
                                                                    data-image-on="{{ asset('/assets/admin/img/modal/pending-order-on.png') }}"
                                                                    data-image-off="{{ asset('/assets/admin/img/modal/pending-order-off.png') }}"
                                                                    ...
                                                                    data-textarea-name="delivered_message" value="1"
                                                                    id="delivered_status"
                                                                    {{ $data ? ($data['status'] == 1 ? 'checked' : '') : '' }}>
                                                                <span class="toggle-switch-label">
                                                                    <span class="toggle-switch-indicator"></span>
                                                    ...
                                                    <textarea name="delivered_message[]" placeholder="{{ translate('Write your message') }}"
                                                        class="form-control delivered_message"
                                            ...
                                            <div class="col-md-6 col-lg-4">
                                                <div class="form-group">
                                                    <div class="d-flex flex-wrap justify-content-between mb-2">
                                                        ...
                                                        @if ($lang == 'en')
                                                            <label
                                                                ...
                                                                <input type="checkbox" data-id="delivery_boy_assign"
                                                                    data-type="toggle"
                                                                    data-image-on="{{ asset('/assets/admin/img/modal/pending-order-on.png') }}"
                                                                    data-image-off="{{ asset('/assets/admin/img/modal/pending-order-off.png') }}"
                                                                    ...
                                                                    name="delivery_boy_assign_status" value="1"
                                                    ...
                                                    <textarea name="delivery_boy_assign_message[]" placeholder="{{ translate('Write your message') }}"
                                                        class="form-control delivery_boy_assign_message"
                                            ...
                                            <div class="col-md-6 col-lg-4">
                                                <div class="form-group">
                                                    <div class="d-flex flex-wrap justify-content-between mb-2">
                                                        ...
                                                        @if ($lang == 'en')
                                                            <label
                                                                ...
                                                                <input type="checkbox" data-id="delivery_boy_delivered"
                                                                    data-type="toggle"
                                                                    data-image-on="{{ asset('/assets/admin/img/modal/pending-order-on.png') }}"
                                                                    data-image-off="{{ asset('/assets/admin/img/modal/pending-order-off.png') }}"
                                                    ...
                                                    <textarea name="delivery_boy_delivered_message[]" placeholder="{{ translate('Write your message') }}"
                                                        class="form-control delivery_boy_delivered_message"
                                            ...
                                            <div class="col-md-6 col-lg-4">
                                                <div class="form-group">
                                                        ...
                                                        @if ($lang == 'en')
                                                            <label
                                                                ...
                                                                <input type="checkbox" name="order_cancled_message_status"
                                                                    data-id="order_cancled_message" data-type="toggle"
                                                                    data-image-on="{{ asset('/assets/admin/img/modal/pending-order-on.png') }}"
                                                                    data-image-off="{{ asset('/assets/admin/img/modal/pending-order-off.png') }}"
                                                    ...
                                                    <textarea name="order_cancled_message[]" placeholder="{{ translate('Write your message') }}"
                                                        class="form-control order_cancled_message"
                                            ...
                                            @if ($mod_type != 'parcel')
                                                ...
                                                <div class="col-md-6 col-lg-4">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="order_refunded_message[]" placeholder="{{ translate('Write your message') }}"
                                                            class="form-control order_refunded_message"
                                                ...
                                                <div class="col-md-6 col-lg-4">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="refund_request_canceled[]" placeholder="{{ translate('Write your message') }}"
                                                            class="form-control refund_request_canceled"
                                            ...
                                            <div class="col-md-6 col-lg-4">
                                                <div class="form-group">
                                                        ...
                                                        @if ($lang == 'en')
                                                            <label
                                                                ...
                                                                <input type="checkbox"
                                                                    ...
                                                                    value="1" id="offline_order_accept_message"
                                                                    {{ $data ? ($data['status'] == 1 ? 'checked' : '') : '' }}>
                                                                <span class="toggle-switch-label">
                                                                    <span class="toggle-switch-indicator"></span>
                                                                </span>
                                                    ...
                                                    <textarea name="offline_order_accept_message[]" placeholder="{{ translate('Write your message') }}"
                                                        class="form-control offline_order_accept_message"
                                                        @if ($lang == 'en') {{ $data ? ($data['status'] == 1 ? 'required' : '') : '' }} @endif>{!! isset($translate_12) && isset($translate_12[$lang])
                                                            ? $translate_12[$lang]['message']
                                                            : ($data
                                                                ? $data['message']
                                                                : '') !!}</textarea>
                                                </div>
                                            ...
                                            <div class="col-md-6 col-lg-4">
                                                <div class="form-group">
                                                        ...
                                                        @if ($lang == 'en')
                                                            <label
                                                                ...
                                                                <input type="checkbox"
                                                                    ...
                                                                    value="1" id="offline_order_deny_message"
                                                                    {{ $data ? ($data['status'] == 1 ? 'checked' : '') : '' }}>
                                                                <span class="toggle-switch-label">
                                                                    <span class="toggle-switch-indicator"></span>
                                                                </span>
                                                    ...
                                                    <textarea name="offline_order_deny_message[]" placeholder="{{ translate('Write your message') }}"
                                                        class="form-control offline_order_deny_message"
                                                        @if ($lang == 'en') {{ $data ? ($data['status'] == 1 ? 'required' : '') : '' }} @endif>{!! isset($translate_13) && isset($translate_13[$lang])
                                                            ? $translate_13[$lang]['message']
                                                            : ($data
                                                                ? $data['message']
                                                                : '') !!}</textarea>
                                                </div>
                    ...
                    <div class="modal-body pb-5 pt-0">
                        <div class="single-item-slider owl-carousel">
                            <div class="item">
                                <div class="mb-20">
                                    <div class="text-center">
                                        <img src="{{ asset('/assets/admin/img/email-templates/3.png') }}" alt=""
                                            class="mb-20">
                            ...
                            <div class="item">
                                <div class="mb-20">
                                    <div class="text-center">
                                        <img src="{{ asset('/assets/admin/img/firebase/slide-4.png') }}" alt=""
                                            class="mb-20">
                                        <h5 class="modal-title">

                                ...
                                <div class="col-6 mt-5">
                                    ...
                                    <div class="form-group mb-0">
                                        <label
                                            ...
                                            <input type="checkbox" data-id="websocket" data-type="toggle"
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="form-group mb-0">
                                        ...
                                        <input type="text" id="websocket_url" name="websocket_url"
                                            value="{{ $websocket_url->value ?? '' }}" class="form-control"
                                            placeholder="{{ translate('messages.Ex_:_ws://178.128.117.0') }}" required>
                                    </div>
                                </div>
                                <div class="col-6">
                                    ...
                                    <div class="form-group mb-0">
                                        ...
                                        <input id="websocket_port" type="number"
                                            value="{{ $websocket_port->value ?? '' }}" name="websocket_port"

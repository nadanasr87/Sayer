                    ...
                    <div class="card">
                        <div class="card-body">
                            @if ($disbursement_type == 'automated')
                                <div class="mb-3 text-right">
                                    <button type="button" class="btn btn--primary" data-toggle="modal"
                                        data-target="#myModal">{{ translate('messages.Check_Dependencies') }}</button>
                                </div>
                            @endif
                            <div class="row g-3 mb-2">
                                ...
                                <div
                                    class="col-6 automated_disbursement_section {{ $disbursement_type == 'manual' ? 'd-none' : '' }}">
                                    ...
                                    <div class="form-group lang_form default-form">
                                        ...
                                        <input id="system_php_path" type="text"
                                            placeholder="{{ translate('Ex:_/usr/bin/php') }}" class="form-control h--45px"
                                            min="1" name="system_php_path" value="{{ $system_php_path }}" required>
                                    </div>
                                </div>
                                <div
                                    class="col-12 automated_disbursement_section {{ $disbursement_type == 'manual' ? 'd-none' : '' }} ">
                                    <div class="row g-3">
                                        <div class="col-6">
                                            ...
                                            <div class="__bg-F8F9FC-card">
                                                <div class="row">
                                                    ...
                                                    <div class='{{ $store_disbursement_time_period == 'weekly' ? 'col-6' : 'col-12' }}'
                                                    ...
                                                    <div class='col-6 {{ $store_disbursement_time_period == 'weekly' ? '' : 'd-none' }}'
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="__bg-F8F9FC-card">
                                                <div class="row">
                                                    <div class='{{ $dm_disbursement_time_period == 'weekly' ? 'col-6' : 'col-12' }}'
                                                    ...
                                                    <div class='col-6 {{ $dm_disbursement_time_period == 'weekly' ? '' : 'd-none' }}'
                                                        ...
                                                        <div class="form-group lang_form default-form">
                                                            ...
                                                            <select name="dm_disbursement_week_start"
                                                                id="dm_disbursement_week_start" class="form-control"
                                                                required>
                                                                <option value="saturday"
                                                ...
                                                <div class="form-group lang_form default-form">
                                                    ...
                                                    <input id="dm_disbursement_waiting_time" type="number"
                                                        ...
                                                        class="form-control h--45px" name="dm_disbursement_waiting_time"

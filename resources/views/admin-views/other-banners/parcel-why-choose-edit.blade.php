                                        ...
                                        <div class="row lang_form default-form">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" maxlength="100" name="short_description[]"
                                                        value="{{ $banner?->getRawOriginal('short_description') ?? '' }}"
                                                        class="form-control"
                                                        placeholder="{{ translate('messages.short_description_here...') }}">
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row d-none lang_form" id="{{ $lang }}-form1">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" maxlength="100" name="short_description[]"
                                                            value="{{ $translate[$lang]['short_description'] ?? '' }}"class="form-control"
                                                            placeholder="{{ translate('messages.short_description_here...') }}">
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <label class="upload-img-3 m-0">
                                            <div class="img">
                                                <img src="{{ \App\CentralLogics\Helpers::onerror_image_helper(
                                                    $banner['image'] ?? '',
                                                    asset('storage/why_choose') . '/' . $banner['image'] ?? '',

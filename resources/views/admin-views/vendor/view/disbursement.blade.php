                            ...
                            "type": "css-animation"
                                ...
                                <div id="usersExportDropdown"
                                    ...
                                    <a id="export-excel" class="dropdown-item"
                                        href="{{ route('admin.store.disbursement-export', ['id' => $store->id, 'type' => 'excel']) }}">
                                    ...
                                    <a id="export-csv" class="dropdown-item"
                                        href="{{ route('admin.store.disbursement-export', ['id' => $store->id, 'type' => 'csv']) }}">
                                        <img class="avatar avatar-xss avatar-4by3 mr-2"
                                ...
                                <tbody>
                                    @foreach ($disbursements as $key => $store)
                                        <tr>
                                            <td>
                                                <span
                                                    class="font-weight-bold">{{ $key + $disbursements->firstItem() }}</span>
                                            </td>
                                            <td>
                                                    ...
                                                    <div class="modal-content">
                                                        <div class="modal-header pb-4">
                                                            ...
                                                            <div class="w-100 text-center">
                                                                <h2 class="mb-2">{{ translate('Payment_Information') }}
                                                                </h2>
                                                                <div>
                                                                    <span
                                                                ...
                                                                <div class="mt-2">
                                                                    ...
                                                                    <span
                                                                        class="badge badge-soft-primary">{{ $store->status }}</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="modal-body">
                                                            <div class="card shadow--card-2">
                                                                <div class="card-body">
                                                                    <div
                                                                        class="d-flex flex-wrap payment-info-modal-info p-xl-4">
                                                                        <div class="item">
                                                                            <h5>{{ translate('Restaurant_Information') }}
                                                                            </h5>
                                                                            <ul class="item-list">
                                                                        ...
                                                                        <div class="item w-100">
                                                                            ...
                                                                            <ul class="item-list">
                                                                                <li class="d-flex flex-wrap">
                                                                                    <span
                                                                                        class="name">{{ translate('payment_method') }}</span><strong>{{ $store->withdraw_method->method_name }}</strong>
                                                                                </li>
                                                                                <li class="d-flex flex-wrap">
                                                                                    <span

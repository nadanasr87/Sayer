                        ...
                        <div class="card-body">
                            <div class="d-flex flex-wrap flex-sm-nowrap __gap-12px">
                                <label class="__custom-upload-img mr-lg-5">
                                    ...
                                    <div class="text-center">
                                        <img class="img--110 min-height-170px min-width-170px onerror-image" id="viewer"
                                            ...
                                            src="{{ asset('assets/admin/img/upload-img.png') }}" alt="logo image" />
                                    </div>
                                ...
                                <label class="__custom-upload-img">
                                    ...
                                    <div class="text-center">
                                        <img class="img--vertical min-height-170px min-width-170px onerror-image"
                                            id="coverImageViewer"
                                            data-onerror-image="{{ asset('assets/admin/img/upload-img.png') }}"
                                            src="{{ asset('assets/admin/img/upload-img.png') }}" alt="Fav icon" />
                                    </div>

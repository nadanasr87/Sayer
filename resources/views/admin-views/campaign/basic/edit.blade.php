                            ...
                            <div class="d-none lang_form" id="{{ $lang }}-form">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title[]" id="{{ $lang }}_title"
                                        class="form-control" placeholder="{{ translate('messages.new_campaign') }}"
                        ...
                        <div id="default-form">
                            <div class="form-group">
                                ...
                                <input type="text" name="title[]" class="form-control"
                                    placeholder="{{ translate('messages.new_campaign') }}"
                                    value="{{ $campaign['title'] }}" maxlength="100">
                            </div>
                    ...
                    <div class="row g-3">
                        <div class="col-lg-6">
                                ...
                                <div class="col-sm-12">
                                    <div>
                                        ...
                                        <select name="module_id" class="form-control js-select2-custom"
                                            data-placeholder="{{ translate('messages.select_module') }}" id="module_select"
                                            disabled>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div>
                                        <label class="input-label text-capitalize"
                                            for="title">{{ translate('messages.daily_start_time') }}</label>
                                ...
                                <div class="col-sm-6">
                                    <label class="input-label text-capitalize"
                                        for="title">{{ translate('messages.daily_end_time') }}</label>
                            ...
                            <div class="form-group mb-0 h-100 d-flex flex-column">
                                ...
                                <div class="text-center py-3 my-auto">
                                    <img class="initial--4 onerror-image" id="viewer"
                                        src="{{ \App\CentralLogics\Helpers::onerror_image_helper($campaign->image, asset('storage/campaign/') . '/' . $campaign->image, asset('assets/admin/img/900x400/img1.jpg'), 'campaign/') }}"

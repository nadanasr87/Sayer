                ...
                <div class="row align-items-md-center gx-md-5">
                    <div class="col-md-4 mb-3 mb-md-0">
                        <img class="rounded initial--5 onerror-image"
                            src="{{ \App\CentralLogics\Helpers::onerror_image_helper($campaign->image, asset('storage/campaign/') . '/' . $campaign->image, asset('assets/admin/img/160x160/img2.jpg'), 'campaign/') }}"
                        ...
                        <form action="{{ route('admin.campaign.addstore', $campaign->id) }}" id="store-add-form"
                            ...
                            <div class="d-flex flex-wrap g-2">
                                <div class="flex-grow-1">
                                    @php(
    $allstores = App\Models\Store::Active()->where('module_id', $campaign->module_id)->get(),
)
                            ...
                            <tr>
                                ...
                                <td>
                                    <img width="45" class="img--circle onerror-image"
                                        ...
                                        src="{{ \App\CentralLogics\Helpers::onerror_image_helper($store['logo'], asset('storage/store/') . '/' . $store['logo'], asset('assets/admin/img/160x160/img1.jpg'), 'store/') }}">
                                </td>
                                <td>

            ...
            <div class="card-body">
                <div class="row align-items-md-center">
                    <div class="col-md-6 col-lg-4 mb-3 mb-md-0">
                        <img class="rounded img--ratio-3 onerror-image"
                            ...
                            @if ($campaign->store)
                                <div class="w-100 my-2">
                                    <a href="{{ route('admin.store.view', $campaign->store_id) }}"
                                        ...
                                        <img class="img--70 circle onerror-image"
                                            data-onerror-image="{{ asset('assets/admin/img/160x160/img1.jpg') }}"
                                            src="{{ \App\CentralLogics\Helpers::onerror_image_helper($campaign->store->logo, asset('storage/store/') . '/' . $campaign->store->logo, asset('assets/admin/img/160x160/img1.jpg'), 'store/') }}"

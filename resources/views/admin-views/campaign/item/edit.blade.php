...
@section('content')
    <div class="content container-fluid">
        ...
        <!-- End Page Header -->
        <form method="post" id="campaign_form" enctype="multipart/form-data">
            <div class="row g-2">
                @csrf
                                ...
                                <div class="lang_form" id="default-form">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title[]" id="default_title" class="form-control"
                                            ...
                                            value="{{ $campaign?->getRawOriginal('title') }}">
                                    </div>
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <div id="image-viewer-section" class="text-center py-3 my-auto">
                                <img class="img--120 onerror-image" id="viewer"
                                    src="{{ \App\CentralLogics\Helpers::onerror_image_helper($campaign->image, asset('storage/campaign/') . '/' . $campaign->image, asset('assets/admin/img/100x100/2.png'), 'campaign/') }}"
                                    alt="campaign image"
                            ...
                            <div class="row g-2">
                                ...
                                <div class="col-sm-6 col-lg-3" id="maximum_cart_quantity">
                                    <div class="form-group mb-0">
                                        ...
                                        <input type="number" class="form-control" name="maximum_cart_quantity"
                                            value="{{ $campaign->maximum_cart_quantity }}" min="0"
                                            id="cart_quantity">
                                    </div>
                                </div>
...
<script>
    ...
    function add_more_customer_choice_option(i, name) {
        ...
        $('#customer_choice_options').append(
            ...
            '" placeholder="Choice Title" readonly></div><div class="col-sm-9"><input type="text" class="form-control combination_update" name="choice_options_' +
            i +

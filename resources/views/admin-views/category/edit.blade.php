                            ...
                            @else
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" class="form-control"
                                        ...
                                        value="{{ $category['name'] }}" maxlength="191">
                                </div>
                                <input type="hidden" name="lang[]" value="{{ $lang }}">
                            @endif
                                ...
                                <div class="h-100 d-flex flex-column">
                                    ...
                                    <div class="text-center py-3 my-auto">
                                        <img class="img--100 onerror-image" id="viewer"
                                            src="{{ \App\CentralLogics\Helpers::onerror_image_helper($category['image'], asset('storage/category/') . '/' . $category['image'], asset('assets/admin/img/900x400/img1.jpg'), 'category/') }}"

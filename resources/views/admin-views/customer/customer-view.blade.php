            ...
            <div class="row align-items-center">
                ...
                <div class="col-sm-auto">
                    <a class="btn btn-icon btn-sm btn-soft-secondary rounded-circle mr-1"
                        ...
                        data-placement="top" title="{{ translate('Previous_customer') }}">
                            ...
                            <div class="customer--information-single media align-items-center" href="javascript:">
                                <div class="avatar avatar-circle">
                                    <img class="avatar-img onerror-image"
                                        ...
                                        src="{{ \App\CentralLogics\Helpers::onerror_image_helper($customer->image, asset('storage/profile/') . '/' . $customer->image, asset('assets/admin/img/160x160/img1.jpg'), 'profile/') }}"
                                        alt="Image Description">
                                </div>

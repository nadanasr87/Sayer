                        ...
                        <div class="lang_form" id="default-form">
                            <div class="form-group">
                                ...
                                <input type="text" name="unit[]" id="default_title" class="form-control"
                                    placeholder="{{ translate('messages.unit_name') }}"
                                    value="{{ $unit?->getRawOriginal('unit') }}" maxlength="191">
                            </div>
                            ...
                            <div class="d-none lang_form" id="{{ $lang }}-form">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="unit[]" id="{{ $lang }}_title"
                                        class="form-control" placeholder="{{ translate('messages.unit_name') }}"
                                        value="{{ $translate[$lang]['unit'] ?? '' }}" maxlength="191">
                                </div>
                        ...
                        <div id="default-form">
                            <div class="form-group">
                                ...
                                <input type="text" name="unit[]" class="form-control"
                                    placeholder="{{ translate('messages.unit_name') }}" value="{{ $unit['unit'] }}"

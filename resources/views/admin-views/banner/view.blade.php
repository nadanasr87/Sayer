                    ...
                    <div class="col-md-auto mb-3 mb-md-0">
                        <div class="d-flex align-items-center">
                            <img class="avatar avatar-xxl avatar-4by3 mr-4 onerror-image"
                                src="{{ \App\CentralLogics\Helpers::onerror_image_helper($banner->image, asset('storage/banner/') . '/' . $banner->image, asset('assets/admin/img/160x160/img2.jpg'), 'banner/') }}"
                                    ...
                                    <th colspan="3">
                                        <form action="{{ route('admin.banner.addstore', $banner->id) }}"
                                            ...
                                            <div class="row">
                                                ...
                                                <button type="submit"
                                                    class="btn btn--primary col-md-5">{{ translate('messages.add_store') }}</button>
                                        ...
                                        <td>
                                            <div class="inline--1">
                                                <img class="img--60 img--circle onerror-image"
                                                    ...
                                                    src="{{ \App\CentralLogics\Helpers::onerror_image_helper($dm['logo'], asset('storage/store/') . '/' . $dm['logo'], asset('assets/admin/img/160x160/img1.jpg'), 'store/') }}">
                                            </div>
                                        </td>
                                        <td>

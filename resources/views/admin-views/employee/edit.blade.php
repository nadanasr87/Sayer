                            ...
                            <div class="row g-3">
                                <div class="col-sm-6">
                                    <label class="input-label qcont"
                                        for="name">{{ translate('messages.first_name') }}</label>
                                ...
                                <div class="col-sm-6">
                                    <label class="input-label qcont"
                                        for="name">{{ translate('messages.last_name') }}</label>
                            ...
                            <label class="h-100 d-flex flex-column">
                                <div class="text-center py-3 my-auto">
                                    <img class="img--100 onerror-image" id="viewer"
                                        ...
                                        src="{{ \App\CentralLogics\Helpers::onerror_image_helper($employee['image'], asset('storage/admin/') . '/' . $employee['image'], asset('assets/admin/img/admin.png'), 'admin/') }}"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="js-form-message form-group mb-0">
                                <label class="input-label" for="signupSrPassword">{{ translate('messages.password') }}<span

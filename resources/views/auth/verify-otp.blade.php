            ...
            <div class="auth-wrapper-left">
                <div class="auth-left-cont">
                    ...
                    <img class="onerror-image" data-onerror-image="{{ asset('/assets/admin/img/favicon.png') }}"
                        src="{{ \App\CentralLogics\Helpers::onerror_image_helper($store_logo, asset('storage/business/') . '/' . $store_logo, asset('/assets/admin/img/favicon.png'), 'business/') }}"
                        alt="public/img">
            ...
            <div class="auth-wrapper-right">
                ...
                <div class="otp-card">
                    <div class="text-center">
                        ...
                        <div class="mb-2">
                            {{ translate('a_5_digit_verification_code_has_been') }} <br> {{ translate('sent_to') }}
                            <strong>{{ substr($admin->phone, 0, 3) . str_repeat('X', strlen($admin->phone) - 5) . substr($admin->phone, -2) }}</strong>
                        </div>
                        ...
                        <div class="mt-4">
                            <form action="{{ route('verify-otp') }}" method="POST" class="otp-form">
                                ...
                                <button type="submit"
                                    class="btn btn-lg btn-block btn--primary">{{ translate('Verify') }}</button>
                            </form>
                        </div>
                        <div class="d-flex justify-content-between">
                            <span>{{ translate('Didn`t receive the code?') }}</span>
                            <button class="text--primary resend otp_resend" disabled
                                id="otp-button">{{ translate('Resend_it') }}
                            </button>
                        </div>
                    </div>
                </div>

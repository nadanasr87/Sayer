                        ...
                        <div class="card-body d-flex flex-column pt-0">
                            <div class="text-center my-auto py-4 py-xl-5">
                                <img class="store-banner onerror-image" id="viewer"
                                    ...
                                    src="{{ \App\CentralLogics\Helpers::onerror_image_helper($shop->logo, asset('storage/store/') . '/' . $shop->logo, asset('assets/admin/img/image-place-holder.png'), 'store/') }}"
                        ...
                        <div class="card-body d-flex flex-column pt-0">
                            <div class="text-center my-auto py-4 py-xl-5">
                                <img class="store-banner onerror-image" id="coverImageViewer"
                                    ...
                                    src="{{ \App\CentralLogics\Helpers::onerror_image_helper($shop->cover_photo, asset('storager/') . '/' . $shop->cover_photo, asset('assets/admin/img/restaurant_cover.jpg'), 'store/cover/') }}"
                                    alt="Product thumbnail" />
                            </div>
                            <div class="custom-file">

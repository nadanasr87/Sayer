                ...
                @if ($shop->cover_photo)
                    <div>
                        <img class="my-restaurant-img onerror-image"
                            src="{{ \App\CentralLogics\Helpers::onerror_image_helper($shop->cover_photo, asset('storage/store/cover/') . '/' . $shop->cover_photo, asset('assets/admin/img/900x400/img1.jpg'), 'store/cover/') }}"
                ...
                <div class="my-resturant--card">
                    ...
                    @if ($shop->image == 'def.png')
                        <div class="my-resturant--avatar">
                            <img class="border onerror-image" src="{{ asset('assets/back-end') }}/img/shop.png"
                                data-onerror-image="{{ asset('assets/admin/img/160x160/img1.jpg') }}" alt="User Pic">
                        </div>
                    @else
                        <div class="my-resturant--avatar onerror-image">
                            <img src="{{ \App\CentralLogics\Helpers::onerror_image_helper($shop->logo, asset('storage '/' . $shop->logo, asset('assets/admin/img/160x160/img1.jpg'), 'store/') }}"
                                class="border" data-onerror-image="{{ asset('assets/admin/img/160x160/img1.jpg') }}"
                                alt="">
                        </div>
                    @endif
        ...
        <div class="card border-0 mt-2">
            <div class="card-header">
                <h5 class="card-title toggle-switch toggle-switch-sm d-flex justify-content-between">
                    ...
                    <span>{{ translate('Announcement') }}</span><span class="input-label-secondary" data-toggle="tooltip"

                                ...
                                <div id="default-form">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title[]" id="title" class="form-control"
                                            placeholder="{{ translate('messages.new_coupon') }}"
                                            value="{{ $coupon['title'] }}" maxlength="100" required>
                                    </div>
                                    <input type="hidden" name="lang[]" value="default">
                                </div>
                            @endif
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <div class="form-group">
                                ...
                                <input id="coupon_code" type="text" name="code" class="form-control"
                                    value="{{ $coupon['code'] }}" placeholder="{{ \Illuminate\Support\Str::random(8) }}"
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <div class="form-group">
                                ...
                                <input type="number" name="limit" id="coupon_limit" value="{{ $coupon['limit'] }}"
                                    class="form-control" max="100" placeholder="{{ translate('messages.Ex :') }} 10">
                            </div>
                        </div>
                        <div class="col-sm-6 col-lg-3">
                            <div class="form-group">
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <div class="form-group">
                                ...
                                <select name="discount_type" id="discount_type" class="form-control"
                                    {{ $coupon['coupon_type'] == 'free_delivery' ? 'disabled' : '' }}>
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <div class="form-group">
                                ...
                                <input type="number" id="discount" min="1" max="999999999999.99"
                                    ...
                                    {{ $coupon['coupon_type'] == 'free_delivery' ? 'readonly' : '' }}>
                            </div>
                        </div>
                        <div class="col-sm-6 col-lg-3">
                            <div class="form-group">
                                ...
                                <input type="number" min="0" max="999999999999.99" step="0.01"
                                    ...
                                    class="form-control" {{ $coupon['coupon_type'] == 'free_delivery' ? 'readonly' : '' }}>
                            </div>
                        </div>
                        <div class="col-sm-6 col-lg-3">
                            <div class="form-group">
                                ...
                                <input id="min_purchase" type="number" name="min_purchase" step="0.01"

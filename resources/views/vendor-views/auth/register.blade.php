                        ...
                        <div class="row row-margin-top">
                                ...
                                <div class="lang_form row" id="default-form">
                                    ...
                                    <div class="col-md-6 col-lg-6 col-sm-12">
                                        <div class="form-group mb-0">
                                            ...
                                            <textarea type="text" id="address" name="address[]" placeholder="{{ translate('messages.store') }}"
                                                class="form-control __form-control"></textarea>
                                        </div>
                                    </div>
                                </div>
                                @foreach (json_decode($language) as $lang)
                                    <div class="d-none lang_form row" id="{{ $lang }}-form">
                                        <div class="col-md-6 col-lg-6 col-sm-12">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-lg-6 col-sm-12">
                                            <div class="form-group mb-0">
                                                ...
                                                <textarea type="text" id="address{{ $lang }}" name="address[]"
                                                    placeholder="{{ translate('messages.store') }}" class="form-control __form-control"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                @endforeach
                            ...
                            <div class="row row-margin-top">
                                <div class="col-md-6 col-lg-6 col-sm-12 float-end">
                                    <div class="form-group">
                                        ...
                                        <label for="name"
                                            class="input-label pt-2">{{ translate('messages.upload_cover_photo') }} <span
                            ...
                            <div class="row row-margin-top">
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="form-group">
                                        <label for="module_id"
                                            class="input-label">{{ translate('messages.module') }}</label>

                                    ...
                                    @foreach ($product->images as $key => $photo)
                                        <div class="col-xl-2 col-lg-3 col-md-4 col-sm-4 col-6 spartan_item_wrapper"
                                            ...
                                            <img class="img--square onerror-image"
                                                src="{{ \App\CentralLogics\Helpers::onerror_image_helper($photo, asset('storage/product/') . '/' . $photo, asset('assets/admin/img/400x400/img2.jpg'), 'product/') }}"
                            ...
                            <div class="mt-3">
                                ...
                                <div class="text-center d-block" id="image-viewer-section" class="pt-2">
                                    <img class="img--100 onerror-image" id="viewer"
                                        src="{{ \App\CentralLogics\Helpers::onerror_image_helper($product['image'], asset('storage . '/' . $product['image'], asset('assets/admin/img/400x400/img2.jpg'), 'product/') }}"
                                        data-onerror-image ="{{ asset('/assets/admin/img/400x400/img2.jpg') }}"
                                        alt="product image" />
                                </div>
                                ...
                                <div class="col-sm-6 col-lg-4">
                                    <div class="form-group mb-0">
                                        ...
                                        <select name="category_id" id="category-id"
                                            ...
                                            data-url="{{ url('/') }}/store-panel/item/get-categories?parent_id="
                                ...
                                <div class="col-sm-6 col-lg-4">
                                    <div class="form-group mb-0">
                                        ...
                                        <input type="number" value="{{ $product->price }}" min="0"
                                            max="999999999999" name="price" class="form-control" step="0.01"

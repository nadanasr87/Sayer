                        ...
                        <div class="card-body">
                            <div class="row g-3">
                                <div class="col-sm-6 col-md-4">
                                    ...
                                    <input type="text" id="f_name" value="{{ $delivery_man['f_name'] }}"
                                ...
                                <div class="col-sm-6 col-md-4">
                                    ...
                                    <input type="text" id="l_name" value="{{ $delivery_man['l_name'] }}"
                                ...
                                <div class="col-sm-6 col-md-4">
                                    <div class="form-group mb-0">
                                        ...
                                        <input type="email" id="email" value="{{ $delivery_man['email'] }}"
                                ...
                                <div class="col-sm-6 col-md-4">
                                    <label class="input-label"
                                        for="identity_type">{{ translate('messages.identity_type') }}</label>
                                ...
                                <div class="col-sm-6 col-md-4">
                                    <label class="input-label"
                                        for="identity_number">{{ translate('messages.identity_number') }}</label>
                                        ...
                                        <div>
                                            <img class="img--120"
                                                src="{{ \App\CentralLogics\Helpers::onerror_image_helper(
                                                    $img,
                                                    asset('storage/delivery-man') . '/' . $img,
                    ...
                    <div class="card h-100">
                        <div class="card-header">
                            <h5 class="form-label m-0">{{ translate('messages.deliveryman_image') }}
                                <small class="text-danger">* ( {{ translate('messages.ratio') }} {{ translate('1:1') }}
                                    )</small>
                            </h5>
                        </div>
                        <div class="card-body d-flex flex-column">
                            <div class="my-auto">
                                <div class="text-center pt-3">
                                    <img class="img--120" id="viewer"
                                        src="{{ \App\CentralLogics\Helpers::onerror_image_helper(
                                            $delivery_man['image'],
                                            asset('storagean') . '/' . $delivery_man['image'],
                                            asset('/assets/admin/img/160x160/img1.jpg'),
                                            'delivery-man/',
                                        ) }}"

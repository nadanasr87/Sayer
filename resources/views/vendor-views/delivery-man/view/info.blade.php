        ...
        <div class="card mb-3 mb-lg-5">
            <div class="card-header py-2">
                <div class="search--button-wrapper">
                    ...
                    <a href="javascript:" data-url="{{ route('vendor.delivery-man.status', [$dm['id'], $dm->status ? 0 : 1]) }}"
                            ...
                            <tr>
                                ...
                                <td>
                                    @foreach (json_decode($review['attachment'], true) as $attachment)
                                        <img width="100" class="onerror-image"
                                            data-onerror-image="{{ asset('assets/admin/img/160x160/img2.jpg') }}"
                                            src="{{ \App\CentralLogics\Helpers::onerror_image_helper($attachment, asset('storage$attachment, asset('assets/admin/img/160x160/img2.jpg'), $attachment . '/') }}"
                                            alt="image">
                                    @endforeach
                                </td>
                                <td>

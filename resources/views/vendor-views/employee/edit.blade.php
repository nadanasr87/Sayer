                                ...
                                <div class="card-body d-flex flex-column">
                                    ...
                                    <div class="text-center mb-auto">
                                        <img class="store-banner onerror-image" id="viewer"
                                            ...
                                            src="{{ \App\CentralLogics\Helpers::onerror_image_helper($e['image'], asset('storage/vendor') . '/' . $e['image'], asset('assets/admin/img/160x160/img1.jpg'), 'vendor/') }}"
...
@push('script_2')
    <script>
        ...
        $('#reset_btn').click(function() {
            $('#viewer').attr('src', '{{ asset('storage}/{{ $e['image'] }}');
        })
    </script>
@endpush

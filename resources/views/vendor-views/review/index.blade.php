                                    ...
                                    @if ($review->item)
                                        <a class="media align-items-center"
                                            ...
                                            <img class="avatar avatar-lg mr-3 onerror-image"
                                                ...
                                                src="{{ \App\CentralLogics\Helpers::onerror_image_helper($review->item['image'], asset('storage/product/') . '/' . $review->item['image'], asset('assets/admin/img/160x160/img2.jpg'), 'product/') }}"

                                                    ...
                                                    <div class="media media--sm">
                                                        <div class="avatar avatar-xl mr-3">
                                                            <img class="img-fluid onerror-image"
                                                                src="{{ \App\CentralLogics\Helpers::onerror_image_helper($detail->campaign['image'], asset('storage) . '/' . $detail->campaign['image'], asset('assets/admin/img/160x160/img2.jpg'), 'campaign/') }}"
                                                                data-onerror-image="{{ asset('assets/admin/img/160x160/img2.jpg') }}"
                                                                alt="Image Description">
                                                        </div>
                                                        <div class="media-body">
                                ...
                                <div class="media align-items-center customer--information-single" href="javascript:">
                                    <div class="avatar avatar-circle">
                                        <img class="avatar-img onerror-image"
                                            ...
                                            src="{{ \App\CentralLogics\Helpers::onerror_image_helper($order->delivery_man->image, asset('storagean/') . '/' . $order->delivery_man->image, asset('assets/admin/img/160x160/img1.jpg'), 'delivery-man/') }}"
                                            alt="Image Description">
                                    </div>
                                    <div class="media-body">
                                        <span
                                ...
                                @foreach ($data as $key => $img)
                                    <div class="col-3">
                                        <img class="img__aspect-1 rounded border w-100 onerror-image" data-toggle="modal"
                                            data-target="#imagemodal{{ $key }}"
                                            data-onerror-image="{{ asset('assets/admin/img/160x160/img2.jpg') }}"
                                            src="{{ \App\CentralLogics\Helpers::onerror_image_helper($img, asset('storage'/' . $img, asset('assets/admin/img/160x160/img2.jpg'), 'order/') }}"
                                            alt="image">
                                    </div>
                                    <div class="modal fade" id="imagemodal{{ $key }}" tabindex="-1"
                        ...
                        <div class="card-body">
                            ...
                            <div class="media align-items-center customer--information-single" href="javascript:">
                                <div class="avatar avatar-circle">
                                    <img class="avatar-img onerror-image "
                                        data-onerror-image="{{ asset('assets/admin/img/160x160/img1.jpg') }}"
                                        src="{{ \App\CentralLogics\Helpers::onerror_image_helper($order->customer->image, asset('storage . '/' . $order->customer->image, asset('assets/admin/img/160x160/img1.jpg'), 'profile/') }}"
                                        alt="Image Description">
                                </div>
                                <div class="media-body">
                                    <span
                                    ...
                                    @foreach ($proof as $key => $photo)
                                        <div class="spartan_item_wrapper min-w-100px max-w-100px">
                                            <img class="img--square"
                                                src="{{ asset("storageto") }}" alt="order image">
                    ...
                    <form action="{{ route('vendor.order.update-order-amount') }}" method="POST" class="row">
                        ...
                        <div class="form-group col-12">
                            ...
                            <input id="order_amount" type="number" class="form-control" name="order_amount"
                                min="0"
                                value="{{ round($order['order_amount'] - $order['total_tax_amount'] - $order['additional_charge'] - $order['delivery_charge'] + $order['store_discount_amount'], 6) }}"
                                step=".01">
                        </div>

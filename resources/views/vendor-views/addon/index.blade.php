                        ...
                        <form action="{{ route('vendor.addon.store') }}" method="post">
                            ...
                            @if ($language)
                                ...
                                <div class="form-group lang_form" id="default-form">
                                    <label class="input-label" for="name">{{ translate('messages.name') }}
                                ...
                                @foreach (json_decode($language) as $lang)
                                    <div class="form-group d-none lang_form" id="{{ $lang }}-form">
                                        <label class="input-label"
                                            for="name{{ $lang }}">{{ translate('messages.name') }}
                                            ({{ strtoupper($lang) }})</label>
                                        <input type="text" id="name{{ $lang }}" name="name[]"
                                            class="form-control" placeholder="{{ translate('messages.new_addon') }}"
                                            maxlength="191">
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <input id="price" type="number" min="0" max="999999999999.99" name="price"
                                    step="0.01" class="form-control" placeholder="100.00" value="{{ old('price') }}"
                                    required>
                            </div>
                                        ...
                                        <td>
                                            <div class="btn--container">
                                                <a class="btn action-btn btn--primary btn-outline-primary"
                                                    ...
                                                    title="{{ translate('messages.edit_addon') }}"><i
                                                        class="tio-edit"></i></a>

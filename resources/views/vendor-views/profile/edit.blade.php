                ...
                <form action="{{ route('seller.profile.update') }}" method="post" enctype="multipart/form-data"
                    ...
                    <div class="card mb-3 mb-lg-5" id="generalDiv">
                        ...
                        <label class="avatar avatar-xxl avatar-circle avatar-border-lg avatar-uploader profile-cover-avatar"
                            for="avatarUploader">
                            <img id="viewer" data-onerror-image="{{ asset('assets/back-end/img/160x160/img1.jpg') }}"
                                class="avatar-img onerror-image"
                                src="{{ \App\CentralLogics\Helpers::onerror_image_helper($data->image, asset('storage/seller/') . '/' . $data->image, asset('assets/back-end/img/160x160/img1.jpg'), 'seller/') }}"
                                alt="Image">
                        </label>
                        <!-- End Avatar -->
                    </div>

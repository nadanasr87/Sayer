...
@section('content')
    ...
    <!-- Progress -->
    <div class="pb-2">
        <div class="progress cursor-pointer" role="progressbar" aria-label="6amMart Software Installation" aria-valuenow="90"
                ...
                <div class="bg-light p-4 rounded mb-4">
                    <div class="px-xl-2 pb-sm-3">
                        <div class="row gy-4">
                            <div class="col-md-12">
                                <div class="from-group">
                                    <label for="first-name" class="d-flex align-items-center gap-2 mb-2">Business
                                        Name</label>
                                    <input type="text" id="first-name" class="form-control" name="business_name" required
                                        placeholder="Ex: 6amMart">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="from-group">
                                    <label for="first-name" class="d-flex align-items-center gap-2 mb-2">
                                        First Name</label>
                                    <input type="text" id="first-name" class="form-control" name="f_name" required
                                        placeholder="Ex: John">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="from-group">
                                    <label for="last-name" class="d-flex align-items-center gap-2 mb-2">
                                        Last Name</label>
                                    <input type="text" id="last-name" class="form-control" name="l_name" required
                                        placeholder="Ex: Doe">
                                </div>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="from-group">
                                    <label for="password" class="d-flex align-items-center gap-2 mb-2">Password</label>
                                    <div class="input-inner-end-ele position-relative">
                                        <input type="password" autocomplete="new-password" id="password"
                                            name="password" required class="form-control" placeholder="Ex: 8+ character"
                                            minlength="8">
                                ...
                                <div class="from-group">
                                    ...
                                    <div class="input-inner-end-ele position-relative">
                                        <input type="password" autocomplete="new-password" id="confirm_password"
                                            name="confirm_password" class="form-control" placeholder="Ex: 8+ character"
                                            required>
                                        <div class="togglePassword">
                                            <img src="{{ asset('assets/installation') }}/assets/img/svg-icons/eye.svg"
                                                alt="" class="svg eye">

...
@section('content')
    ...
    <!-- Progress -->
    <div class="pb-2">
        <div class="progress cursor-pointer" role="progressbar" aria-label="6amMart Software Installation" aria-valuenow="20"
            ...
            <div class="d-flex justify-content-end mb-2">
                <a href="https://docs.6amtech.com/docs-six-am-mart/intro" class="d-flex align-items-center gap-1"
                    ...
                    <span data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="custom-tooltip"
                        ...
                        <img src="{{ asset('assets/installation') }}/assets/img/svg-icons/info.svg" class="svg"
                            alt="">
                    </span>
                </a>
            </div>

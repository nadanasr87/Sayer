...
@section('content')
    ...
    <!-- Progress -->
    <div class="pb-2">
        <div class="progress cursor-pointer" role="progressbar" aria-label="6amMart Software Installation" aria-valuenow="40"
    ...
    <div class="card mt-4">
        <div class="p-4 mb-md-3 mx-xl-4 px-md-5">
            ...
            <p class="mb-4">Provide your <strong>username of epulsecart</strong> & the purchase code </p>
                                ...
                                <div class="from-group">
                                    <label for="username" class="d-flex align-items-center gap-2 mb-2">
                                        ...
                                        <span class="cursor-pointer" data-bs-toggle="tooltip" data-bs-placement="top"
                                            ...
                                            data-bs-title="The username of your epulsecart account">

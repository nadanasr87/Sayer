                    ...
                    <li class="nav-item d-none d-sm-inline-block mr-4">
                        ...
                        <div class="hs-unfold">
                            <a class="js-hs-unfold-invoker btn btn-icon btn-soft-secondary rounded-circle"
                                ...
                                @php(
    $message = \App\Models\Conversation::whereUser(\App\CentralLogics\Helpers::get_loggedin_user()->id)->where('unread_message_count', '>', '0')->count(),
)
                                @if ($message != 0)
                                ...
                                <div class="cmn--media right-dropdown-icon d-flex align-items-center">
                                    ...
                                    <div class="avatar avatar-sm avatar-circle">
                                        <img class="avatar-img  onerror-image"
                                            ...
                                            src="{{ \App\CentralLogics\Helpers::onerror_image_helper(\App\CentralLogics\Helpers::get_loggedin_user()->image, asset('storage/vendor/') . '/' . \App\CentralLogics\Helpers::get_loggedin_user()->image, asset('assets/admin/img/160x160/img1.jpg'), 'vendor/') }}"
...
@if ($Payable_Balance == 1 && $cash_in_hand_overflow && $wallet?->balance < 0 && $val <= abs($wallet?->collected_cash))
    <div class="alert __alert-2 alert-warning m-0 py-1 px-2" role="alert">
        <img class="rounded mr-1" width="25" src="{{ asset('/assets/admin/img/header_warning.png') }}"
            alt="">
        <div class="cont">

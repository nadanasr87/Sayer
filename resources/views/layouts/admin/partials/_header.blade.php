                ...
                <ul class="navbar-nav align-items-center flex-row flex-grow-1 __navbar-nav">
                            ...
                            <div class="__nav-module-body">
                                <ul>
                                    ...
                                    @if (\App\CentralLogics\Helpers::module_permission_check('zone'))
                                        ...
                                        <li>
                                            <a href="{{ route('admin.business-settings.city.home') }}"
                                                class="next-tour">
                                                <img src="{{ asset('/assets/admin/img/navbar-setting-icon/location.svg') }}"
                                                    alt="">
                                                <span>{{ translate('city Setup') }}</span>
                                            </a>
                                        </li>
                                    @endif
                    ...
                    <li class="nav-item __nav-item">
                        <a href="javascript:void(0)" class="__nav-link module--nav-icon" id="tourb-0">
                            @if ($mod)
                                <img src="{{ \App\CentralLogics\Helpers::onerror_image_helper($mod->icon, asset('storage/module/') . '/' . $mod->icon, asset('/assets/admin/img/new-img/module-icon.svg'), 'module/') }}"
                                    class="onerror-image"
                                ...
                                <div class="__nav-module-body">
                                    <div class="__nav-module-items">
                                        @foreach ($modules as $module)
                                            <a href="javascript:" data-module-id="{{ $module->id }}"
                                                ...
                                                <div class="img w--70px ">
                                                    <img src="{{ \App\CentralLogics\Helpers::onerror_image_helper($module?->icon, asset('storage/module/') . '/' . $module?->icon, asset('assets/admin/img/new-img/module/e-shop.svg'), 'module/') }}"

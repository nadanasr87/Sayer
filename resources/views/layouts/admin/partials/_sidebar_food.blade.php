        ...
        <div class="navbar-vertical-container">
            ...
            <div class="navbar-vertical-content bg--005555" id="navbar-vertical-content">
                ...
                <ul class="navbar-nav navbar-nav-lg nav-tabs">
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                ...
                                <li class="nav-item {{ Request::is('admin/campaign/item/*') ? 'active' : '' }}">
                                    <a class="nav-link " href="{{ route('admin.campaign.list', 'item') }}"
                                        title="{{ translate('messages.food_campaigns') }}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                    ...
                    <li class="nav-item">
                        <small class="nav-subtitle"
                            title="{{ translate('messages.item_section') }}">{{ translate('messages.food_management') }}</small>
                        <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                    </li>
                                ...
                                @if (\App\CentralLogics\Helpers::get_mail_status('product_approval'))
                                    <li
                                        ...
                                        <a class="nav-link " href="{{ route('admin.item.approval_list') }}"
                                            ...
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span
                                                class="text-truncate">{{ translate('messages.New_Food_Request') }}</span>
                                        </a>
                                    </li>
                                @endif
        ...
        return $query->where('status', null);
                        ...
                        <li class="navbar-item {{ Request::is('admin/store/recommended-store') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                                ...
                                <span
                                    class="text-truncate text-capitalize">{{ translate('Recommended_Restaurants') }}</span>
                            </a>
                        </li>
                        <li

            ...
            <div class="navbar-brand-wrapper justify-content-between">
                ...
                <a class="navbar-brand" href="{{ route('admin.transactions.store.withdraw_list') }}" aria-label="Front">
                    <img class="navbar-brand-logo initial--36 onerror-image onerror-image"
                        ...
                        src="{{ \App\CentralLogics\Helpers::onerror_image_helper($store_logo, asset('storage/business/') . '/' . $store_logo, asset('assets/admin/img/160x160/img1.jpg'), 'business/') }}"
                        alt="Logo">
                    <img class="navbar-brand-logo-mini initial--36 onerror-image onerror-image"
                        data-onerror-image="{{ asset('assets/admin/img/160x160/img2.jpg') }}"
                        src="{{ \App\CentralLogics\Helpers::onerror_image_helper($store_logo, asset('storage/business/') . '/' . $store_logo, asset('assets/admin/img/160x160/img2.jpg'), 'business/') }}"
                        alt="Logo">
                </a>
                <!-- End Logo -->
            ...
            <div class="navbar-vertical-content bg--005555" id="navbar-vertical-content">
                ...
                <ul class="navbar-nav navbar-nav-lg nav-tabs">
                    ...
                    @if (\App\CentralLogics\Helpers::module_permission_check('account'))
                        ...
                        <li
                            class="navbar-vertical-aside-has-menu {{ Request::is('admin/transactions/deliveryman-earnings') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                                href="{{ route('admin.transactions.earningList') }}"
                                title="{{ translate('messages.withdraw_able_balance') }}">
                        ...
                        <li
                            class="navbar-vertical-aside-has-menu {{ Request::is('admin/transactions/stc-deliveryman-payouts') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                                href="{{ route('admin.transactions.stcDeliverymanPayouts') }}"
                                title="{{ translate('messages.withdraw_able_balance') }}">
                                <i class="tio-money nav-icon"></i>
                                <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                    {{ translate('messages.stc_payouts') }}
                                </span>
                            </a>
                        </li>
                    @endif
                                ...
                                <div class="cmn--media right-dropdown-icon d-flex align-items-center">
                                    <div class="avatar avatar-sm avatar-circle">
                                        <img class="avatar-img onerror-image"
                                            ...
                                            src="{{ \App\CentralLogics\Helpers::onerror_image_helper(auth('admin')->user()->image, asset('storage/admin/') . '/' . auth('admin')->user()->image, asset('assets/admin/img/160x160/img1.jpg'), 'admin/') }}"
